...
var qn = ((t) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(t, { get: (e, r) => (typeof require < "u" ? require : e)[r] }) : t)(function(t) {
...
var Wt = (t, e) => {
  for (var r in e) Fn(t, r, { get: e[r], enumerable: true });
}, Df = (t, e, r, n) => {
  if (e && typeof e == "object" || typeof e == "function") for (let o of kf(e)) !Pf.call(t, o) && o !== r && Fn(t, o, { get: () => e[o], enumerable: !(n = Ef(e, o)) || n.enumerable });
  return t;
};
var er = (t) => Df(Fn({}, "__esModule", { value: true }), t);
var Tr, kt, Pt, Of, Ra, Kn = V(() => {
  "use strict";
  Tr = /* @__PURE__ */ new Map(), kt = [], Pt = (t, e, r) => {
    if (e && typeof e.init == "function" && typeof e.createInferenceSessionHandler == "function") {
      let n = Tr.get(t);
      if (n === void 0) Tr.set(t, { backend: e, priority: r });
      else {
      ...
      if (r >= 0) {
        let o = kt.indexOf(t);
        o !== -1 && kt.splice(o, 1);
        for (let i = 0; i < kt.length; i++) if (Tr.get(kt[i]).priority <= r) {
          kt.splice(i, 0, t);
          return;
        }
        kt.push(t);
    ...
    let e = t.executionProviders || [], r = e.map((d) => typeof d == "string" ? d : d.name), n = r.length === 0 ? kt : r, o, i = [], a = /* @__PURE__ */ new Set();
    for (let d of n) {
      let c = await Of(d);
    ...
    let u = e.filter((d) => a.has(typeof d == "string" ? d : d.name));
...
var La, Oe, jn = V(() => {
  "use strict";
  Va();
  La = "warning", Oe = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: Na }, set logLevel(t) {
    if (t !== void 0) {
...
var Ga, Ha, Fa = V(() => {
  ...
  Ga = (t, e) => {
    ...
    if (n != null) {
      ...
      let a = e?.format !== void 0 ? e.format : "RGB", u = e?.norm, d, c;
      ...
      a === "RGBA" ? (m = 0, g = p, y = p * 2, b = p * 3) : a === "RGB" ? (m = 0, g = p, y = p * 2) : a === "RBG" && (m = 0, y = p, g = p * 2);
    ...
    if (r != null) {
      let o, i, a;
      e?.tensorLayout !== void 0 && e.tensorLayout === "NHWC" ? (o = t.dims[2], i = t.dims[1], a = t.dims[3]) : (o = t.dims[3], i = t.dims[2], a = t.dims[1]);
      ...
      let m = i * o;
      if (e !== void 0 && (e.format !== void 0 && a === 4 && e.format !== "RGBA" || a === 3 && e.format !== "RGB" && e.format !== "BGR")) throw new Error("Tensor format doesn't match input tensor dims");
...
var Zn, qa, Ka, ja, Za, Qa, Ya = V(() => {
  ...
  Zn = (t, e) => {
    ...
    let { height: r, width: n } = e, o = e.norm ?? { mean: 255, bias: 0 }, i, a;
    ...
    for (let A = 0; A < c; A++, g += m, b += m, y += m, _ += m) p[S++] = (t[g] + a[0]) / i[0], p[x++] = (t[y] + a[1]) / i[1], p[$++] = (t[b] + a[2]) / i[2], T !== -1 && _ !== -1 && (p[T++] = (t[_] + a[3]) / i[3]);
    return d === "RGBA" ? new ze("float32", p, [1, 4, r, n]) : new ze("float32", p, [1, 3, r, n]);
  }, qa = async (t, e) => {
    let r = typeof HTMLImageElement < "u" && t instanceof HTMLImageElement, n = typeof ImageData < "u" && t instanceof ImageData, o = typeof ImageBitmap < "u" && t instanceof ImageBitmap, i = typeof t == "string", a, u = e ?? {}, d = () => {
    ...
    if (r) {
      ...
      if (m != null) {
        ...
        m.drawImage(t, 0, 0), a = m.getImageData(0, 0, y, g).data;
      } else throw new Error("Can not access image data");
    } else if (n) {
      let p, m;
      if (e !== void 0 && e.resizedWidth !== void 0 && e.resizedHeight !== void 0 ? (p = e.resizedHeight, m = e.resizedWidth) : (p = t.height, m = t.width), e !== void 0 && (u = e), u.format = "RGBA", u.height = p, u.width = m, e !== void 0) {
        ...
        let y = c(g);
        if (y != null) y.putImageData(t, 0, 0), a = y.getImageData(0, 0, m, p).data;
        else throw new Error("Can not access image data");
      } else a = t.data;
    } else if (o) {
      ...
      if (m != null) {
        let g = t.height, y = t.width;
        return m.drawImage(t, 0, 0, y, g), a = m.getImageData(0, 0, y, g).data, u.height = g, u.width = y, Zn(a, u);
      } else throw new Error("Can not access image data");
    } else {
      if (i) return new Promise((p, m) => {
        ...
        b.crossOrigin = "Anonymous", b.src = t, b.onload = () => {
          ...
          u.height = g.height, u.width = g.width, p(Zn(_.data, u));
        };
      });
      throw new Error("Input data provided is not supported - aborted tensor creation");
    }
    if (a !== void 0) return Zn(a, u);
    throw new Error("Input data provided is not supported - aborted tensor creation");
  }, Ka = (t, e) => {
    let { width: r, height: n, download: o, dispose: i } = e, a = [1, n, r, 4];
    return new ze({ location: "texture", type: "float32", texture: t, dims: a, download: o, dispose: i });
  }, ja = (t, e) => {
    let { dataType: r, dims: n, download: o, dispose: i } = e;
    return new ze({ location: "gpu-buffer", type: r ?? "float32", gpuBuffer: t, dims: n, download: o, dispose: i });
  }, Za = (t, e) => {
    let { dataType: r, dims: n, download: o, dispose: i } = e;
    return new ze({ location: "ml-tensor", type: r ?? "float32", mlTensor: t, dims: n, download: o, dispose: i });
  }, Qa = (t, e, r) => new ze({ location: "cpu-pinned", type: t, data: e, dims: r ?? [e.length] });
});
var Dt, tr, Xa, Ja, es = V(() => {
  "use strict";
  Dt = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), tr = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), Xa = false, Ja = () => {
    if (!Xa) {
      Xa = true;
      ...
      t && (Dt.set("int64", BigInt64Array), tr.set(BigInt64Array, "int64")), e && (Dt.set("uint64", BigUint64Array), tr.set(BigUint64Array, "uint64")), n ? (Dt.set("float16", r), tr.set(r, "float16")) : Dt.set("float16", Uint16Array);
    }
  };
});
var ts, rs, ns = V(() => {
  ...
  ts = (t) => {
    ...
    switch (t.location) {
      case "cpu":
        return new ze(t.type, t.data, e);
      case "cpu-pinned":
        return new ze({ location: "cpu-pinned", data: t.data, type: t.type, dims: e });
      case "texture":
        return new ze({ location: "texture", texture: t.texture, type: t.type, dims: e });
      case "gpu-buffer":
        return new ze({ location: "gpu-buffer", gpuBuffer: t.gpuBuffer, type: t.type, dims: e });
      case "ml-tensor":
        return new ze({ location: "ml-tensor", mlTensor: t.mlTensor, type: t.type, dims: e });
      default:
...
var Cr, os, Ve, Re, _t, wt, Yn = V(() => {
  ...
  Cr = (t, e) => {
    ...
    (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || os("BEGIN", t);
  }, Re = (t) => {
    (typeof Oe.trace > "u" ? !Oe.wasm.trace : !Oe.trace) || os("END", t);
  }, _t = (t) => {
...
var Ar, is = V(() => {
  ...
  Ar = class t {
      ...
      if (typeof r == "object") {
        ...
        if (Array.isArray(r)) {
          ...
          for (let m of this.outputNames) if (p.indexOf(m) !== -1) {
            let g = r[m];
            (g === null || g instanceof je) && (c = true, a = false, o[m] = g);
          }
          if (c) {
            if (typeof n == "object" && n !== null) i = n;
            else if (typeof n < "u") throw new TypeError("'options' must be an object.");
    ...
    static async create(e, r, n, o) {
      ...
      let i, a = {};
      if (typeof e == "string") {
        if (i = e, typeof r == "object" && r !== null) a = r;
      ...
      let [u, d] = await Ra(a), c = await u.createInferenceSessionHandler(i, d);
...
var Xn = {};
Wt(Xn, { InferenceSession: () => Bf, TRACE: () => Cr, TRACE_EVENT_BEGIN: () => _t, TRACE_EVENT_END: () => wt, TRACE_FUNC_BEGIN: () => Ve, TRACE_FUNC_END: () => Re, Tensor: () => je, env: () => _e, registerBackend: () => Pt });
var Le = V(() => {
  "use strict";
  Ua();
  Wa();
...
var ps, ms, zf, hs = V(() => {
  ...
  vt();
  kr();
  ps = "ort-wasm-proxy-worker", ms = globalThis.self?.name === ps;
  ms && (self.onmessage = (t) => {
    ...
    try {
      switch (e) {
        ...
        case "run": {
          ...
          Mr(n, o, i, a, new Array(a.length).fill(null), u).then((d) => {
            d.some((c) => c[3] !== "cpu") ? postMessage({ type: e, err: "Proxy does not support non-cpu tensor location." }) : postMessage({ type: e, out: d }, Ur([...i, ...d]));
          }, (d) => {
  ...
  zf = ms ? null : (t) => new Worker(t ?? We, { type: "module", name: ps });
});
var bs = {};
Wt(bs, { default: () => Mf });
async function gs(t = {}) {
  var e = t, r = !!globalThis.window, n = !!globalThis.WorkerGlobalScope, o = n && self.name?.startsWith("em-pthread");
  e.mountExternalData = (s, l) => {
    s.startsWith("./") && (s = s.substring(2)), (e.ad || (e.ad = /* @__PURE__ */ new Map())).set(s, l);
  }, e.unmountExternalData = () => {
    delete e.ad, delete e.Yd, delete e.Xd, delete e.be;
  ...
  let i = (s) => async (...l) => {
    try {
      ...
      let h = e.$c = { Nd: l[0], errors: [] }, f = await s(...l);
      if (e.$c !== h) throw Error("Session mismatch");
      e.hd?.flush();
      let v = h.errors;
      if (0 < v.length) {
        let C = await Promise.all(v);
...
`));
  ...
  e.jsepInit = (s, l) => {
    if (s === "webgpu") {
      [e.hd, e.Dd, e.Hd, e.jd, e.Gd, e.bc, e.Id, e.Kd, e.Ed, e.Fd, e.Jd] = l;
      let h = e.hd;
      e.jsepRegisterBuffer = (f, v, C, P) => h.registerBuffer(f, v, C, P), e.jsepGetBuffer = (f) => h.getBuffer(f), e.jsepCreateDownloader = (f, v, C) => h.createDownloader(f, v, C), e.jsepOnCreateSession = (f) => {
        h.onCreateSession(f);
      }, e.jsepOnReleaseSession = (f) => {
        h.onReleaseSession(f);
      }, e.jsepOnRunStart = (f) => h.onRunStart(f), e.Ld = (f, v) => {
        h.upload(f, v);
      };
    } else if (s === "webnn") {
      let h = l[0];
      [e.Vd, e.vd, e.webnnEnsureTensor, e.wd, e.webnnDownloadTensor, e.Ud, e.webnnEnableTraceEvent] = l.slice(1), e.webnnReleaseTensorId = e.vd, e.webnnUploadTensor = e.wd, e.webnnRegisterMLContext = e.Ud, e.webnnOnRunStart = (f) => h.onRunStart(f), e.webnnOnRunEnd = h.onRunEnd.bind(h), e.webnnOnReleaseSession = (f) => {
        h.onReleaseSession(f);
      }, e.webnnCreateMLTensorDownloader = (f, v) => h.createMLTensorDownloader(f, v), e.webnnRegisterMLTensor = (f, v, C, P) => h.registerMLTensor(f, v, C, P), e.webnnCreateMLContext = (f) => h.createMLContext(f), e.webnnRegisterGraphInput = h.registerGraphInput.bind(h), e.webnnIsGraphInput = h.isGraphInput.bind(h), e.webnnRegisterGraphOutput = h.registerGraphOutput.bind(h), e.webnnIsGraphOutput = h.isGraphOutput.bind(h), e.webnnCreateTemporaryTensor = h.createTemporaryTensor.bind(h), e.webnnIsGraphInputOutputTypeSupported = h.isGraphInputOutputTypeSupported.bind(h);
    }
  };
  let a = () => {
    let s = (l) => (...h) => {
      let f = et;
      return h = l(...h), et != f ? new Promise((v, C) => {
        Dn = { resolve: v, reject: C };
      }) : h;
    };
    (() => {
      for (let l of ["_OrtAppendExecutionProvider", "_OrtCreateSession", "_OrtRun", "_OrtRunWithBinding", "_OrtBindInput"]) e[l] = s(e[l]);
    })(), i !== void 0 && (e._OrtRun = i(e._OrtRun), e._OrtRunWithBinding = i(e._OrtRunWithBinding)), a = void 0;
  };
  e.asyncInit = () => {
    a?.();
  };
  ...
  if (r || n) {
    ...
    n && (d = (s) => {
      ...
      if (O(s)) return new Promise((h, f) => {
        var v = new XMLHttpRequest();
        v.open("GET", s, true), v.responseType = "arraybuffer", v.onload = () => {
          v.status == 200 || v.status == 0 && v.response ? h(v.response) : f(v.status);
  ...
  var g, y, b, _, S, x, $ = console.log.bind(console), T = console.error.bind(console), I = $, A = T, E = false, O = (s) => s.startsWith("file://");
  function w() {
  ...
  if (o) {
    let s = function(l) {
      try {
        ...
        if (f === "load") {
          let v = [];
          self.onmessage = (C) => v.push(C), x = () => {
            postMessage({ Vc: "loaded" });
            for (let C of v) s(C);
            self.onmessage = s;
          };
          for (let C of h.Ad) e[C] && !e[C].proxy || (e[C] = (...P) => {
            postMessage({ Vc: "callHandler", yd: C, args: P });
          }, C == "print" && (I = e[C]), C == "printErr" && (A = e[C]));
          ht = h.Rd, Me(), y = h.Sd, be(), Sr();
        } else if (f === "run") {
          (function(v) {
            var C = (w(), L)[v + 52 >>> 2 >>> 0];
            v = (w(), L)[v + 56 >>> 2 >>> 0], qi(C, C - v), ue(C);
          })(h.Uc), Rn(h.Uc, 0, 0, 1, 0, 0), qo(), En(h.Uc), U || (Vi(), U = true);
          try {
            bp(h.Pd, h.ed);
          } catch (v) {
            if (v != "unwind") throw v;
          }
        } else h.target !== "setimmediate" && (f === "checkMailbox" ? U && br() : f && (A(`worker: received unknown command ${f}`), A(h)));
      } catch (v) {
        throw Li(), v;
      }
    };
    ...
    return e.instantiateWasm ? new Promise((f) => {
      ...
      return (async function(P, z) {
        try {
          ...
          return await WebAssembly.instantiate(H, z);
        } catch (K) {
          A(`failed to asynchronously prepare wasm: ${K}`), M(K);
        }
      })(v, f);
    })(h), s(l.instance, l.module));
  }
  class ke {
    name = "ExitStatus";
    constructor(l) {
  ...
  }, De = [], ge = 0, Te = null, qe = (s) => {
    ft.length == 0 && (jo(), Ko(ft[0]));
    var l = ft.pop();
    if (!l) return 6;
    Qt.push(l), Ct[s.Uc] = l, l.Uc = s.Uc;
    var h = { Vc: "run", Pd: s.Od, ed: s.ed, Uc: s.Uc };
    return l.postMessage(h, s.md), 0;
  }, Ne = 0, xe = (s, l, ...h) => {
    var f, v = 16 * h.length, C = de(), P = Nn(v), z = P >>> 3;
    for (f of h) typeof f == "bigint" ? ((w(), Z)[z++ >>> 0] = 1n, (w(), Z)[z++ >>> 0] = f) : ((w(), Z)[z++ >>> 0] = 0n, (w(), Y)[z++ >>> 0] = f);
    return s = Wi(s, 0, v, P, l), ue(C), s;
  };
  function pr(s) {
    if (o) return xe(0, 1, s);
    if (b = s, !(0 < Ne)) {
      for (var l of Qt) $e(l);
      for (l of ft) $e(l);
      ft = [], Qt = [], Ct = {}, E = true;
  ...
  function Go(s) {
    if (o) return xe(1, 0, s);
    $n(s);
  }
  var $n = (s) => {
    if (b = s, o) throw Go(s), "unwind";
    pr(s);
  }, ft = [], Qt = [], Ho = [], Ct = {}, Fo = (s) => {
    var l = s.Uc;
    delete Ct[l], ft.push(s), Qt.splice(Qt.indexOf(s), 1), s.Uc = 0, Gi(l);
  };
  function qo() {
    Ho.forEach((s) => s());
  }
  var Ko = (s) => new Promise((l) => {
    s.onmessage = (v) => {
      var C = v.data;
      if (v = C.Vc, C.bd && C.bd != xr()) {
        var P = Ct[C.bd];
        P ? P.postMessage(C, C.md) : A(`Internal error! Worker sent a message "${v}" to target pthread ${C.bd}, but that thread no longer exists!`);
      } else v === "checkMailbox" ? br() : v === "spawnThread" ? qe(C) : v === "cleanupThread" ? gr(() => {
        Fo(Ct[C.Qd]);
      }) : v === "loaded" ? (s.loaded = true, l(s)) : C.target === "setimmediate" ? s.postMessage(C) : v === "uncaughtException" ? s.onerror(C.error) : v === "callHandler" ? e[C.yd](...C.args) : v && A(`worker sent an unknown command ${v}`);
    }, s.onerror = (v) => {
      throw A(`worker sent an error! ${v.filename}:${v.lineno}: ${v.message}`), v;
    };
    var h, f = [];
    for (h of []) e.propertyIsEnumerable(h) && f.push(h);
    s.postMessage({ Vc: "load", Ad: f, Rd: ht, Sd: y });
  });
  function jo() {
    var s = new Worker((() => {
      let l = URL;
  ...
  var ht, bp = (s, l) => {
    Ne = 0, s = Ln(s, l), 0 < Ne ? b = s : Un(s);
  }, mr = [], fr = 0;
  function yp(s) {
    var l = new xn(s >>>= 0);
    return (w(), N)[l.Wc + 12 >>> 0] == 0 && (Zo(l, true), fr--), Qo(l, false), mr.push(l), Zi(s);
  }
  var Vt = 0, _p = () => {
    le(0, 0);
    var s = mr.pop();
  ...
  function Zo(s, l) {
    l = l ? 1 : 0, (w(), N)[s.Wc + 12 >>> 0] = l;
  }
  function Qo(s, l) {
    l = l ? 1 : 0, (w(), N)[s.Wc + 13 >>> 0] = l;
  }
  class xn {
    constructor(l) {
      this.gd = l, this.Wc = l - 24;
    }
  }
  var Sn = (s) => {
    var l = Vt;
    ...
    var h = new xn(l);
    (w(), L)[h.Wc + 16 >>> 2 >>> 0] = l;
    var f = (w(), L)[h.Wc + 4 >>> 2 >>> 0];
    if (!f) return Jt(0), l;
    for (var v of s) {
      if (v === 0 || v === f) break;
      if (ji(v, f, h.Wc + 16)) return Jt(v), l;
    }
    return Jt(f), l;
  };
  function wp() {
  ...
  function $p(s, l, h, f) {
    return Sn([s >>> 0, l >>> 0, h >>> 0, f >>> 0]);
  }
  var xp = () => {
    var s = mr.pop();
    s || M("no exception to throw");
    var l = s.gd;
    throw (w(), N)[s.Wc + 13 >>> 0] == 0 && (mr.push(s), Qo(s, true), Zo(s, false), fr++), Vn(l), Vt = l;
  };
  function Sp(s, l, h) {
    var f = new xn(s >>>= 0);
    throw l >>>= 0, h >>>= 0, (w(), L)[f.Wc + 16 >>> 2 >>> 0] = 0, (w(), L)[f.Wc + 4 >>> 2 >>> 0] = l, (w(), L)[f.Wc + 8 >>> 2 >>> 0] = h, Vn(s), fr++, Vt = s;
  }
  var Tp = () => fr;
  function Yo(s, l, h, f) {
    return o ? xe(2, 1, s, l, h, f) : Xo(s, l, h, f);
  }
  function Xo(s, l, h, f) {
    if (s >>>= 0, l >>>= 0, h >>>= 0, f >>>= 0, !globalThis.SharedArrayBuffer) return 6;
    var v = [];
    return o && v.length === 0 ? Yo(s, l, h, f) : (s = { Od: h, Uc: s, ed: f, md: v }, o ? (s.Vc = "spawnThread", postMessage(s, v), 0) : qe(s));
  }
  function Ip(s) {
    throw Vt ||= s >>> 0, Vt;
  }
  var Jo = globalThis.TextDecoder && new TextDecoder(), ei = (s, l, h, f) => {
    if (h = l + h, f) return h;
    for (; s[l] && !(l >= h); ) ++l;
    return l;
  }, ti = (s, l = 0, h, f) => {
    if (16 < (h = ei(s, l >>>= 0, h, f)) - l && s.buffer && Jo) return Jo.decode(s.buffer instanceof ArrayBuffer ? s.subarray(l, h) : s.slice(l, h));
    for (f = ""; l < h; ) {
      var v = s[l++];
      if (128 & v) {
        var C = 63 & s[l++];
        if ((224 & v) == 192) f += String.fromCharCode((31 & v) << 6 | C);
        else {
          var P = 63 & s[l++];
          65536 > (v = (240 & v) == 224 ? (15 & v) << 12 | C << 6 | P : (7 & v) << 18 | C << 12 | P << 6 | 63 & s[l++]) ? f += String.fromCharCode(v) : (v -= 65536, f += String.fromCharCode(55296 | v >> 10, 56320 | 1023 & v));
        }
      } else f += String.fromCharCode(v);
    }
    return f;
  }, Ee = (s, l, h) => (s >>>= 0) ? ti((w(), F), s, l, h) : "";
  function ri(s, l, h) {
    return o ? xe(3, 1, s, l, h) : 0;
  }
  function ni(s, l) {
    if (o) return xe(4, 1, s, l);
  }
  function oi(s, l) {
    if (o) return xe(5, 1, s, l);
  }
  function ii(s, l, h) {
    if (o) return xe(6, 1, s, l, h);
  }
  function ai(s, l, h) {
    return o ? xe(7, 1, s, l, h) : 0;
  }
  function si(s, l) {
    if (o) return xe(8, 1, s, l);
  }
  function ui(s, l, h) {
    if (o) return xe(9, 1, s, l, h);
  }
  function di(s, l, h, f) {
    if (o) return xe(10, 1, s, l, h, f);
  }
  function li(s, l, h, f) {
    if (o) return xe(11, 1, s, l, h, f);
  }
  function ci(s, l, h, f) {
    if (o) return xe(12, 1, s, l, h, f);
  }
  function pi(s) {
    if (o) return xe(13, 1, s);
  }
  function mi(s, l) {
    if (o) return xe(14, 1, s, l);
  }
  function fi(s, l, h) {
    if (o) return xe(15, 1, s, l, h);
  }
  var Cp = () => M(""), Je = (s) => {
    s >>>= 0;
    for (var l = ""; ; ) {
  ...
  function lt(s, l, h = {}) {
    return (function(f, v, C = {}) {
      var P = v.name;
      if (!f) throw new Lt(`type "${P}" must have a positive integer typeid pointer`);
      if (In.hasOwnProperty(f)) {
        if (C.Bd) return;
        throw new Lt(`Cannot register type '${P}' twice`);
      }
      In[f] = v, Tn.hasOwnProperty(f) && (v = Tn[f], delete Tn[f], v.forEach((z) => z()));
    })(s, l, h);
  }
  var hi = (s, l, h) => {
    switch (l) {
      case 1:
        return h ? (f) => (w(), N)[f >>> 0] : (f) => (w(), F)[f >>> 0];
      case 2:
        return h ? (f) => (w(), q)[f >>> 1 >>> 0] : (f) => (w(), X)[f >>> 1 >>> 0];
      case 4:
        return h ? (f) => (w(), B)[f >>> 2 >>> 0] : (f) => (w(), L)[f >>> 2 >>> 0];
      case 8:
        return h ? (f) => (w(), Z)[f >>> 3 >>> 0] : (f) => (w(), ne)[f >>> 3 >>> 0];
      default:
        throw new TypeError(`invalid integer width (${l}): ${s}`);
    }
  };
  function Ep(s, l, h, f, v) {
    s >>>= 0, h >>>= 0, l = Je(l >>> 0);
    let C = (P) => P;
    if (f = f === 0n) {
      let P = 8 * h;
      C = (z) => BigInt.asUintN(P, z), v = C(v);
    }
    lt(s, { name: l, Rc: C, Yc: (P, z) => (typeof z == "number" && (z = BigInt(z)), z), Xc: hi(l, h, !f), Zc: null });
  }
  function kp(s, l, h, f) {
    lt(s >>>= 0, { name: l = Je(l >>> 0), Rc: function(v) {
      return !!v;
    }, Yc: function(v, C) {
      return C ? h : f;
    }, Xc: function(v) {
      return this.Rc((w(), F)[v >>> 0]);
    }, Zc: null });
  }
  var gi = [], At = [0, 1, , 1, null, 1, true, 1, false, 1];
  function Cn(s) {
    9 < (s >>>= 0) && --At[s + 1] === 0 && (At[s] = void 0, gi.push(s));
  }
  var He = (s) => {
    if (!s) throw new Lt(`Cannot use deleted val. handle = ${s}`);
    return At[s];
  }, Ke = (s) => {
    switch (s) {
      case void 0:
      ...
      case false:
        return 8;
      default:
        let l = gi.pop() || At.length;
        return At[l] = s, At[l + 1] = 1, l;
    }
  };
  function An(s) {
    return this.Rc((w(), L)[s >>> 2 >>> 0]);
  }
  var Pp = { name: "emscripten::val", Rc: (s) => {
    var l = He(s);
    return Cn(s), l;
  }, Yc: (s, l) => Ke(l), Xc: An, Zc: null };
  function Dp(s) {
    return lt(s >>> 0, Pp);
  }
  var Op = (s, l) => {
    switch (l) {
      case 4:
        return function(h) {
          return this.Rc((w(), Q)[h >>> 2 >>> 0]);
        };
      case 8:
        return function(h) {
          return this.Rc((w(), Y)[h >>> 3 >>> 0]);
        };
      default:
  ...
  function Bp(s, l, h) {
    h >>>= 0, lt(s >>>= 0, { name: l = Je(l >>> 0), Rc: (f) => f, Yc: (f, v) => v, Xc: Op(l, h), Zc: null });
  }
  function zp(s, l, h, f, v) {
    s >>>= 0, h >>>= 0, l = Je(l >>> 0);
    let C = (z) => z;
    if (f === 0) {
      var P = 32 - 8 * h;
    ...
    lt(s, { name: l, Rc: C, Yc: (z, H) => H, Xc: hi(l, h, f !== 0), Zc: null });
  }
  function Mp(s, l, h) {
    function f(C) {
      var P = (w(), L)[C >>> 2 >>> 0];
      return C = (w(), L)[C + 4 >>> 2 >>> 0], new v((w(), N).buffer, C, P);
    }
    ...
    lt(s >>>= 0, { name: h = Je(h >>> 0), Rc: f, Xc: f }, { Bd: true });
  }
  var gt = (s, l, h) => {
    var f = (w(), F);
    if (l >>>= 0, 0 < h) {
  ...
  function Rp(s, l) {
    lt(s >>>= 0, { name: l = Je(l >>> 0), Rc(h) {
      var f = (w(), L)[h >>> 2 >>> 0];
      return f = Ee(h + 4, f, true), tt(h), f;
    }, Yc(h, f) {
      f instanceof ArrayBuffer && (f = new Uint8Array(f));
      var v = typeof f == "string";
      if (!(v || ArrayBuffer.isView(f) && f.BYTES_PER_ELEMENT == 1)) throw new Lt("Cannot pass non-string to std::string");
      var C = v ? hr(f) : f.length, P = Xt(4 + C + 1), z = P + 4;
      return (w(), L)[P >>> 2 >>> 0] = C, v ? gt(f, z, C + 1) : (w(), F).set(f, z >>> 0), h !== null && h.push(tt, P), P;
    }, Xc: An, Zc(h) {
      tt(h);
    } });
  }
  var bi = globalThis.TextDecoder ? new TextDecoder("utf-16le") : void 0, Up = (s, l, h) => {
    if (s >>>= 1, 16 < (l = ei((w(), X), s, l / 2, h)) - s && bi) return bi.decode((w(), X).slice(s, l));
    for (h = ""; s < l; ++s) {
      var f = (w(), X)[s >>> 0];
    ...
    return (w(), q)[l >>> 1 >>> 0] = 0, l - f;
  }, Vp = (s) => 2 * s.length, Lp = (s, l, h) => {
    var f = "";
    s >>>= 2;
    for (var v = 0; !(v >= l / 4); v++) {
      var C = (w(), L)[s + v >>> 0];
    ...
    for (var v = 0; v < s.length; ++v) {
      var C = s.codePointAt(v);
      if (65535 < C && v++, (w(), B)[l >>> 2 >>> 0] = C, (l += 4) + 4 > h) break;
    }
    return (w(), B)[l >>> 2 >>> 0] = 0, l - f;
  }, Gp = (s) => {
    for (var l = 0, h = 0; h < s.length; ++h) 65535 < s.codePointAt(h) && h++, l += 4;
    return l;
  };
  function Hp(s, l, h) {
    if (s >>>= 0, l >>>= 0, h = Je(h >>>= 0), l === 2) var f = Up, v = Np, C = Vp;
    else f = Lp, v = Wp, C = Gp;
    lt(s, { name: h, Rc: (P) => {
      var z = (w(), L)[P >>> 2 >>> 0];
      return z = f(P + 4, z * l, true), tt(P), z;
    }, Yc: (P, z) => {
      if (typeof z != "string") throw new Lt(`Cannot pass non-string to C++ string type ${h}`);
      var H = C(z), K = Xt(4 + H + l);
      return (w(), L)[K >>> 2 >>> 0] = H / l, v(z, K + 4, H + l), P !== null && P.push(tt, K), K;
    }, Xc: An, Zc(P) {
      tt(P);
    } });
  }
  function Fp(s, l) {
    lt(s >>>= 0, { Cd: true, name: l = Je(l >>> 0), Rc: () => {
    }, Yc: () => {
    } });
  }
  function qp(s) {
    Rn(s >>> 0, !n, 1, !r, 131072, false), qo();
  }
  var gr = (s) => {
    if (!E) try {
      if (s(), !(0 < Ne)) try {
        ...
        l instanceof ke || l == "unwind" || c(0, l);
      }
    } catch (l) {
      l instanceof ke || l == "unwind" || c(0, l);
    }
  }, Kp = !Atomics.waitAsync || globalThis.navigator?.userAgent && 91 > Number((navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) || [])[2]);
  function En(s) {
    s >>>= 0, Kp || (Atomics.waitAsync((w(), B), s >>> 2, s).value.then(br), s += 128, Atomics.store((w(), B), s >>> 2, 1));
  }
  var br = () => gr(() => {
    var s = xr();
    s && (En(s), Fi());
  ...
  function jp(s, l) {
    (s >>>= 0) == l >>> 0 ? setTimeout(br) : o ? postMessage({ bd: s, Vc: "checkMailbox" }) : (s = Ct[s]) && s.postMessage({ Vc: "checkMailbox" });
  }
  var kn = [];
  function Zp(s, l, h, f, v) {
    for (l >>>= 0, v >>>= 0, kn.length = 0, h = v >>> 3, f = v + f >>> 3; h < f; ) {
      var C;
      C = (w(), Z)[h++ >>> 0] ? (w(), Z)[h++ >>> 0] : (w(), Y)[h++ >>> 0], kn.push(C);
    }
    return (l ? Wn[l] : Vm[s])(...kn);
  }
  var Qp = () => {
    Ne = 0;
  };
  function Yp(s) {
    s >>>= 0, o ? postMessage({ Vc: "cleanupThread", Qd: s }) : Fo(Ct[s]);
  }
  function Xp(s) {
  }
  var yr = (s) => {
  ...
  function Jp(s) {
    var l = (...h) => {
      ...
      try {
        ...
        E || (_r.pop(), et && bt === 1 && _r.length === 0 && (bt = 0, Ne += 1, yr(Ba), typeof Fibers < "u" && Fibers.de()));
      }
    };
    return wi.set(s, l), l;
  }
  var bt = 0, et = null, yi = 0, _r = [], Pn = /* @__PURE__ */ new Map(), _i = /* @__PURE__ */ new Map(), wi = /* @__PURE__ */ new Map(), em = 0, Dn = null, tm = [], vi = (s) => (function(l) {
    if (!E) {
      if (bt === 0) {
        var h = false, f = false;
        l((v = 0) => {
          if (!E && (yi = v, h = true, f)) {
            bt = 2, yr(() => za(et)), typeof MainLoop < "u" && MainLoop.xd && MainLoop.resume(), v = false;
            try {
              var C = (function() {
                var H = (w(), B)[et + 8 >>> 2 >>> 0];
                return H = _i.get(H), H = wi.get(H), --Ne, H();
              })();
            } catch (H) {
              C = H, v = true;
            }
            ...
            if (!et) {
              var z = Dn;
              z && (Dn = null, (v ? z.reject : z.resolve)(C), P = true);
            }
            if (v && !P) throw C;
          }
        }), f = true, h || (bt = 1, et = (function() {
          var v = Xt(65548), C = v + 12;
          if ((w(), L)[v >>> 2 >>> 0] = C, (w(), L)[v + 4 >>> 2 >>> 0] = C + 65536, C = _r[0], !Pn.has(C)) {
            var P = em++;
            Pn.set(C, P), _i.set(P, C);
          }
          return C = Pn.get(C), (w(), B)[v + 8 >>> 2 >>> 0] = C, v;
        })(), typeof MainLoop < "u" && MainLoop.xd && MainLoop.pause(), yr(() => Oa(et)));
      } else bt === 2 ? (bt = 0, yr(Ma), tt(et), et = null, tm.forEach(gr)) : M(`invalid state: ${bt}`);
      return yi;
    }
  })((l) => {
    s().then(l);
  ...
  var On = [], nm = (s) => {
    ...
    for (var h = Array(s), f = 0; f < s; ++f) {
      var v = f, C = (w(), L)[l + 4 * f >>> 2 >>> 0], P = In[C];
      if (P === void 0) throw s = `parameter ${f}`, C = Ni(C), l = Je(C), tt(C), new Lt(`${s} has unknown type ${l}`);
      h[v] = P;
    }
    return h;
  }, im = (s, l, h) => {
    var f = [];
    return s = s(f, h), f.length && ((w(), L)[l >>> 2 >>> 0] = Ke(f)), s;
  }, am = {}, wr = (s) => {
    var l = am[s];
    return l === void 0 ? Je(s) : l;
  };
  function sm(s, l, h) {
    var [f, ...v] = om(s, l >>> 0);
    l = f.Yc.bind(f);
    var C = v.map((H) => H.Xc.bind(H));
    s--;
    var P = { toValue: He };
    switch (s = C.map((H, K) => {
      var ae = `argFromPtr${K}`;
      return P[ae] = H, `${ae}(args${K ? "+" + 8 * K : ""})`;
    }), h) {
      case 0:
        var z = "toValue(handle)";
        break;
      case 2:
        z = "new (toValue(handle))";
        break;
      case 3:
        z = "";
        break;
      case 1:
        P.getStringOrSymbol = wr, z = "toValue(handle)[getStringOrSymbol(methodName)]";
    }
    return z += `(${s})`, f.Cd || (P.toReturnWire = l, P.emval_returnValue = im, z = `return emval_returnValue(toReturnWire, destructorsRef, ${z})`), z = `return function (handle, methodName, destructorsRef, args) {
  ${z}
  }`, h = new Function(Object.keys(P), z)(...Object.values(P)), z = `methodCaller<(${v.map((H) => H.name)}) => ${f.name}>`, nm(Object.defineProperty(h, "name", { value: z }));
  }
  function um(s, l) {
    return l >>>= 0, (s = He(s >>> 0)) == He(l);
  }
  function dm(s) {
    return (s >>>= 0) ? (s = wr(s), Ke(globalThis[s])) : Ke(globalThis);
  }
  function lm(s) {
    return s = wr(s >>> 0), Ke(e[s]);
  }
  function cm(s, l) {
    return l >>>= 0, s = He(s >>> 0), l = He(l), Ke(s[l]);
  }
  function pm(s) {
    9 < (s >>>= 0) && (At[s + 1] += 1);
  }
  function $i(s, l, h, f, v) {
    return On[s >>> 0](l >>> 0, h >>> 0, f >>> 0, v >>> 0);
  }
  function mm(s, l, h, f, v) {
    return $i(s >>> 0, l >>> 0, h >>> 0, f >>> 0, v >>> 0);
  }
  function fm() {
    return Ke([]);
  }
  ...
  function _m(s, l, h) {
    l >>>= 0, h >>>= 0, s = He(s >>> 0), l = He(l), h = He(h), s[l] = h;
  }
  function wm(s, l) {
    s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s), l >>>= 0, s = new Date(1e3 * s), (w(), B)[l >>> 2 >>> 0] = s.getUTCSeconds(), (w(), B)[l + 4 >>> 2 >>> 0] = s.getUTCMinutes(), (w(), B)[l + 8 >>> 2 >>> 0] = s.getUTCHours(), (w(), B)[l + 12 >>> 2 >>> 0] = s.getUTCDate(), (w(), B)[l + 16 >>> 2 >>> 0] = s.getUTCMonth(), (w(), B)[l + 20 >>> 2 >>> 0] = s.getUTCFullYear() - 1900, (w(), B)[l + 24 >>> 2 >>> 0] = s.getUTCDay(), s = (s.getTime() - Date.UTC(s.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, (w(), B)[l + 28 >>> 2 >>> 0] = s;
  }
  var xi = (s) => s % 4 == 0 && (s % 100 != 0 || s % 400 == 0), Si = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], Ti = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
  function vm(s, l) {
    s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s), l >>>= 0, s = new Date(1e3 * s), (w(), B)[l >>> 2 >>> 0] = s.getSeconds(), (w(), B)[l + 4 >>> 2 >>> 0] = s.getMinutes(), (w(), B)[l + 8 >>> 2 >>> 0] = s.getHours(), (w(), B)[l + 12 >>> 2 >>> 0] = s.getDate(), (w(), B)[l + 16 >>> 2 >>> 0] = s.getMonth(), (w(), B)[l + 20 >>> 2 >>> 0] = s.getFullYear() - 1900, (w(), B)[l + 24 >>> 2 >>> 0] = s.getDay();
    var h = (xi(s.getFullYear()) ? Si : Ti)[s.getMonth()] + s.getDate() - 1 | 0;
    (w(), B)[l + 28 >>> 2 >>> 0] = h, (w(), B)[l + 36 >>> 2 >>> 0] = -60 * s.getTimezoneOffset(), h = new Date(s.getFullYear(), 6, 1).getTimezoneOffset();
    var f = new Date(s.getFullYear(), 0, 1).getTimezoneOffset();
    s = 0 | (h != f && s.getTimezoneOffset() == Math.min(f, h)), (w(), B)[l + 32 >>> 2 >>> 0] = s;
  }
  function $m(s) {
    s >>>= 0;
    var l = new Date((w(), B)[s + 20 >>> 2 >>> 0] + 1900, (w(), B)[s + 16 >>> 2 >>> 0], (w(), B)[s + 12 >>> 2 >>> 0], (w(), B)[s + 8 >>> 2 >>> 0], (w(), B)[s + 4 >>> 2 >>> 0], (w(), B)[s >>> 2 >>> 0], 0), h = (w(), B)[s + 32 >>> 2 >>> 0], f = l.getTimezoneOffset(), v = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(), C = new Date(l.getFullYear(), 0, 1).getTimezoneOffset(), P = Math.min(C, v);
    return 0 > h ? (w(), B)[s + 32 >>> 2 >>> 0] = +(v != C && P == f) : 0 < h != (P == f) && (v = Math.max(C, v), l.setTime(l.getTime() + 6e4 * ((0 < h ? P : v) - f))), (w(), B)[s + 24 >>> 2 >>> 0] = l.getDay(), h = (xi(l.getFullYear()) ? Si : Ti)[l.getMonth()] + l.getDate() - 1 | 0, (w(), B)[s + 28 >>> 2 >>> 0] = h, (w(), B)[s >>> 2 >>> 0] = l.getSeconds(), (w(), B)[s + 4 >>> 2 >>> 0] = l.getMinutes(), (w(), B)[s + 8 >>> 2 >>> 0] = l.getHours(), (w(), B)[s + 12 >>> 2 >>> 0] = l.getDate(), (w(), B)[s + 16 >>> 2 >>> 0] = l.getMonth(), (w(), B)[s + 20 >>> 2 >>> 0] = l.getYear(), s = l.getTime(), BigInt(isNaN(s) ? -1 : s / 1e3);
  }
  function Ii(s, l, h, f, v, C, P) {
    return o ? xe(16, 1, s, l, h, f, v, C, P) : -52;
  }
  function Ci(s, l, h, f, v, C) {
    if (o) return xe(17, 1, s, l, h, f, v, C);
  }
  var Yt = {}, xm = () => performance.timeOrigin + performance.now();
  function Ai(s, l) {
    if (o) return xe(18, 1, s, l);
    if (Yt[s] && (clearTimeout(Yt[s].id), delete Yt[s]), !l) return 0;
    var h = setTimeout(() => {
      delete Yt[s], gr(() => Hi(s, performance.timeOrigin + performance.now()));
    }, l);
    return Yt[s] = { id: h, ce: l }, 0;
  }
  function Sm(s, l, h, f) {
    s >>>= 0, l >>>= 0, h >>>= 0, f >>>= 0;
    var v = (/* @__PURE__ */ new Date()).getFullYear(), C = new Date(v, 0, 1).getTimezoneOffset();
    v = new Date(v, 6, 1).getTimezoneOffset();
    var P = Math.max(C, v);
    (w(), L)[s >>> 2 >>> 0] = 60 * P, (w(), B)[l >>> 2 >>> 0] = +(C != v), s = (l = (z) => {
      var H = Math.abs(z);
      return `UTC${0 <= z ? "-" : "+"}${String(Math.floor(H / 60)).padStart(2, "0")}${String(H % 60).padStart(2, "0")}`;
    })(C), l = l(v), v < C ? (gt(s, h, 17), gt(l, f, 17)) : (gt(s, f, 17), gt(l, h, 17));
  }
  var Tm = () => Date.now();
  function Cm(s, l, h) {
    if (h >>>= 0, !(0 <= s && 3 >= s)) return 28;
    if (s === 0) s = Date.now();
    else {
      s = performance.timeOrigin + performance.now();
    }
    return s = Math.round(1e6 * s), (w(), Z)[h >>> 3 >>> 0] = BigInt(s), 0;
  }
  var Bn = [], Ei = (s, l) => {
    Bn.length = 0;
    for (var h; h = (w(), F)[s++ >>> 0]; ) {
      var f = h != 105;
      l += (f &= h != 112) && l % 8 ? 4 : 0, Bn.push(h == 112 ? (w(), L)[l >>> 2 >>> 0] : h == 106 ? (w(), Z)[l >>> 3 >>> 0] : h == 105 ? (w(), B)[l >>> 2 >>> 0] : (w(), Y)[l >>> 3 >>> 0]), l += f ? 8 : 4;
    }
    return Bn;
  };
  function Am(s, l, h) {
    return s >>>= 0, l = Ei(l >>> 0, h >>> 0), Wn[s](...l);
  }
  function Em(s, l, h) {
    return s >>>= 0, l = Ei(l >>> 0, h >>> 0), Wn[s](...l);
  }
  ...
  var Bm = () => navigator.hardwareConcurrency, Et = {}, vr = (s) => {
    var l;
    return (l = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(s)) ? +l[1] : (l = /:(\d+):\d+(?:\)|$)/.exec(s)) ? 2147483648 | +l[1] : 0;
  }, ki = (s) => {
    for (var l of s) (s = vr(l)) && (Et[s] = l);
  };
  function zm() {
    var s = Error().stack.toString().split(`
`);
    return s[0] == "Error" && s.shift(), ki(s), Et.kd = vr(s[3]), Et.Md = s, Et.kd;
  }
  function $r(s) {
    if (!(s = Et[s >>> 0])) return 0;
    var l;
    if (l = /^\s+at .*\.wasm\.(.*) \(.*\)$/.exec(s)) s = l[1];
    else if (l = /^\s+at (.*) \(.*\)$/.exec(s)) s = l[1];
    else {
      if (!(l = /^(.+?)@/.exec(s))) return 0;
      s = l[1];
    }
    tt($r.ld ?? 0), l = hr(s) + 1;
    var h = Xt(l);
    return h && gt(s, h, l), $r.ld = h, $r.ld;
  }
  function Mm(s) {
    s >>>= 0;
    var l = (w(), F).length;
    ...
    for (var h = 1; 4 >= h; h *= 2) {
      ...
      e: {
        f = (Math.min(4294901760, 65536 * Math.ceil(Math.max(s, f) / 65536)) - ht.buffer.byteLength + 65535) / 65536 | 0;
        try {
          ht.grow(f), Me();
          var v = 1;
          break e;
  ...
  function Rm(s, l, h) {
    if (s >>>= 0, l >>>= 0, Et.kd == s) var f = Et.Md;
    else (f = Error().stack.toString().split(`
`))[0] == "Error" && f.shift(), ki(f);
    for (var v = 3; f[v] && vr(f[v]) != s; ) ++v;
    for (s = 0; s < h && f[s + v]; ++s) (w(), B)[l + 4 * s >>> 2 >>> 0] = vr(f[s + v]);
    return s;
  }
  var zn, Mn = {}, Pi = () => {
    if (!zn) {
      var s, l = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (globalThis.navigator?.language ?? "C").replace("-", "_") + ".UTF-8", _: "./this.program" };
      for (s in Mn) Mn[s] === void 0 ? delete l[s] : l[s] = Mn[s];
      var h = [];
  ...
  function Di(s, l) {
    if (o) return xe(19, 1, s, l);
    s >>>= 0, l >>>= 0;
    var h, f = 0, v = 0;
    for (h of Pi()) {
      var C = l + f;
      (w(), L)[s + v >>> 2 >>> 0] = C, f += gt(h, C, 1 / 0) + 1, v += 4;
    }
    return 0;
  }
  function Oi(s, l) {
    if (o) return xe(20, 1, s, l);
    s >>>= 0, l >>>= 0;
    var h = Pi();
    for (var f of ((w(), L)[s >>> 2 >>> 0] = h.length, s = 0, h)) s += hr(f) + 1;
    return (w(), L)[l >>> 2 >>> 0] = s, 0;
  }
  function Bi(s) {
    return o ? xe(21, 1, s) : 52;
  }
  function zi(s, l, h, f, v) {
    return o ? xe(22, 1, s, l, h, f, v) : 52;
  }
  function Mi(s, l, h, f) {
    return o ? xe(23, 1, s, l, h, f) : 52;
  }
  function Ri(s, l, h, f) {
    return o ? xe(24, 1, s, l, h, f) : 70;
  }
  var Um = [null, [], []];
  function Ui(s, l, h, f) {
    if (o) return xe(25, 1, s, l, h, f);
    l >>>= 0, h >>>= 0, f >>>= 0;
    for (var v = 0, C = 0; C < h; C++) {
      var P = (w(), L)[l >>> 2 >>> 0], z = (w(), L)[l + 4 >>> 2 >>> 0];
      l += 8;
      for (var H = 0; H < z; H++) {
        var K = s, ae = (w(), F)[P + H >>> 0], pe = Um[K];
        ae === 0 || ae === 10 ? ((K === 1 ? I : A)(ti(pe)), pe.length = 0) : pe.push(ae);
      }
      v += z;
    }
    return (w(), L)[f >>> 2 >>> 0] = v, 0;
  }
  function Nm(s) {
    return s >>> 0;
  }
  o || (function() {
    for (var s = e.numThreads - 1; s--; ) jo();
    De.push(async () => {
      var l = (async function() {
        if (!o) return Promise.all(ft.map(Ko));
      })();
      ge++, await l, --ge == 0 && Te && (l = Te, Te = null, l());
    });
  })(), o || (ht = new WebAssembly.Memory({ initial: 256, maximum: 65536, shared: true }), Me()), e.wasmBinary && (g = e.wasmBinary), e.stackSave = () => de(), e.stackRestore = (s) => ue(s), e.stackAlloc = (s) => Nn(s), e.setValue = function(s, l, h = "i8") {
  ...
  }, e.UTF8ToString = Ee, e.stringToUTF8 = gt, e.lengthBytesUTF8 = hr;
  var Ni, Vi, xr, tt, Xt, Rn, Li, Wi, Gi, Un, Hi, Fi, le, Jt, qi, ue, Nn, de, Ki, Vn, ji, Zi, Qi, Ln, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, Da, Oa, Ba, za, Ma, ct, Vm = [pr, Go, Yo, ri, ni, oi, ii, ai, si, ui, di, li, ci, pi, mi, fi, Ii, Ci, Ai, Di, Oi, Bi, zi, Mi, Ri, Ui], Wn = { 1086876: (s, l, h, f, v) => {
    if (e === void 0 || !e.ad) return 1;
    if ((s = Ee(Number(s >>> 0))).startsWith("./") && (s = s.substring(2)), !(s = e.ad.get(s))) return 2;
    if (l = Number(l >>> 0), h = Number(h >>> 0), f = Number(f >>> 0), l + h > s.byteLength) return 3;
    try {
      let C = s.subarray(l, l + h);
      switch (v) {
        case 0:
          (w(), F).set(C, f >>> 0);
          break;
        case 1:
          e.Td ? e.Td(f, C) : e.Ld(f, C);
          break;
        default:
          return 4;
      }
    ...
    e.wd(s, (w(), F).subarray(l >>> 0, l + h >>> 0));
  }, 1087764: () => e.Vd(), 1087806: (s) => {
    e.vd(s);
  }, 1087843: () => {
    e.Ed();
  }, 1087874: () => {
    ...
    e.Jd();
  }, 1087928: (s) => e.Dd(s), 1087961: (s) => e.Hd(s), 1087993: (s, l, h) => {
    e.jd(Number(s), Number(l), Number(h), true);
  }, 1088056: (s, l, h) => {
    e.jd(Number(s), Number(l), Number(h));
  }, 1088113: () => typeof wasmOffsetConverter < "u", 1088170: (s) => {
    e.bc("Abs", s, void 0);
  }, 1088221: (s) => {
    e.bc("Neg", s, void 0);
  }, 1088272: (s) => {
    ...
    e.bc("Sigmoid", s, void 0);
  }, 1088644: (s, l, h) => {
    e.bc("HardSigmoid", s, { alpha: l, beta: h });
  }, 1088723: (s) => {
    e.bc("HardSwish", s, void 0);
  }, 1088780: (s) => {
    e.bc("Log", s, void 0);
  }, 1088831: (s) => {
    e.bc("Sin", s, void 0);
    ...
    e.bc("LeakyRelu", s, { alpha: l });
  }, 1089853: (s, l) => {
    e.bc("ThresholdedRelu", s, { alpha: l });
  }, 1089923: (s, l) => {
    e.bc("Cast", s, { to: l });
  }, 1089981: (s) => {
    e.bc("Add", s, void 0);
    ...
    e.bc("Greater", s, void 0);
  }, 1090344: (s) => {
    e.bc("GreaterOrEqual", s, void 0);
  }, 1090406: (s) => {
    e.bc("Less", s, void 0);
  }, 1090458: (s) => {
    e.bc("LessOrEqual", s, void 0);
  }, 1090517: (s, l, h, f, v) => {
    e.bc("ReduceMean", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1090692: (s, l, h, f, v) => {
    e.bc("ReduceMax", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1090866: (s, l, h, f, v) => {
    e.bc("ReduceMin", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091040: (s, l, h, f, v) => {
    e.bc("ReduceProd", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091215: (s, l, h, f, v) => {
    e.bc("ReduceSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091389: (s, l, h, f, v) => {
    e.bc("ReduceL1", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091562: (s, l, h, f, v) => {
    e.bc("ReduceL2", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091735: (s, l, h, f, v) => {
    e.bc("ReduceLogSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1091912: (s, l, h, f, v) => {
    e.bc("ReduceSumSquare", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1092092: (s, l, h, f, v) => {
    e.bc("ReduceLogSumExp", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1092272: (s) => {
    e.bc("Where", s, void 0);
  }, 1092325: (s, l, h) => {
    e.bc("Transpose", s, { perm: l ? Array.from((w(), B).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [] });
  }, 1092449: (s, l, h, f) => {
    e.bc("DepthToSpace", s, { blocksize: l, mode: Ee(h), format: f ? "NHWC" : "NCHW" });
  }, 1092582: (s, l, h, f) => {
    e.bc("DepthToSpace", s, { blocksize: l, mode: Ee(h), format: f ? "NHWC" : "NCHW" });
  }, 1092715: (s, l, h, f) => {
    e.bc("DFT", s, { axis: l, inverse: h, onesided: f });
  }, 1092807: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie, yt) => {
    e.bc("ConvTranspose", s, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [v], pads: [C, P], strides: [z], wIsConst: () => !!(w(), N)[K >>> 0], outputPadding: ae ? Array.from((w(), B).subarray(Number(ae) >>> 0, Number(pe) >>> 0)) : [], outputShape: Se ? Array.from((w(), B).subarray(Number(Se) >>> 0, Number(Ie) >>> 0)) : [], activation: Ee(yt) });
  }, 1093240: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("ConvTranspose", s, { format: z ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((w(), B).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)), group: f, kernelShape: Array.from((w(), B).subarray(Number(v) >>> 0, (Number(v) >>> 0) + 2 >>> 0)), pads: Array.from((w(), B).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)), strides: Array.from((w(), B).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)), wIsConst: () => !!(w(), N)[H >>> 0], outputPadding: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], outputShape: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [], activation: Ee(Ie) });
  }, 1093901: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie, yt) => {
    e.bc("ConvTranspose", s, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [v], pads: [C, P], strides: [z], wIsConst: () => !!(w(), N)[K >>> 0], outputPadding: ae ? Array.from((w(), B).subarray(Number(ae) >>> 0, Number(pe) >>> 0)) : [], outputShape: Se ? Array.from((w(), B).subarray(Number(Se) >>> 0, Number(Ie) >>> 0)) : [], activation: Ee(yt) });
  }, 1094334: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("ConvTranspose", s, { format: z ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((w(), B).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)), group: f, kernelShape: Array.from((w(), B).subarray(Number(v) >>> 0, (Number(v) >>> 0) + 2 >>> 0)), pads: Array.from((w(), B).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)), strides: Array.from((w(), B).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)), wIsConst: () => !!(w(), N)[H >>> 0], outputPadding: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], outputShape: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [], activation: Ee(Ie) });
  }, 1094995: (s, l) => {
    e.bc("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1095086: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("AveragePool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: v, dilations: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: z ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [] });
  }, 1095565: (s, l) => {
    e.bc("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1095656: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("AveragePool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: v, dilations: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: z ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [] });
  }, 1096135: (s, l) => {
    e.bc("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1096222: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("MaxPool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: v, dilations: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: z ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [] });
  }, 1096697: (s, l) => {
    e.bc("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
  }, 1096784: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie) => {
    e.bc("MaxPool", s, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: v, dilations: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: z ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], strides: pe ? Array.from((w(), B).subarray(Number(pe) >>> 0, Number(Se) >>> 0)) : [] });
  }, 1097259: (s, l, h, f, v) => {
    e.bc("Gemm", s, { alpha: l, beta: h, transA: f, transB: v });
  }, 1097363: (s) => {
    e.bc("MatMul", s, void 0);
  }, 1097417: (s, l, h, f) => {
    e.bc("ArgMax", s, { keepDims: !!l, selectLastIndex: !!h, axis: f });
  }, 1097525: (s, l, h, f) => {
    e.bc("ArgMin", s, { keepDims: !!l, selectLastIndex: !!h, axis: f });
  }, 1097633: (s, l) => {
    e.bc("Softmax", s, { axis: l });
  }, 1097696: (s, l) => {
    e.bc("Concat", s, { axis: l });
  }, 1097756: (s, l, h, f, v) => {
    e.bc("Split", s, { axis: l, numOutputs: h, splitSizes: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1097912: (s) => {
    e.bc("Expand", s, void 0);
  }, 1097966: (s, l) => {
    e.bc("Gather", s, { axis: Number(l) });
  }, 1098037: (s, l) => {
    e.bc("GatherElements", s, { axis: Number(l) });
  }, 1098116: (s, l) => {
    e.bc("GatherND", s, { batch_dims: Number(l) });
  }, 1098195: (s, l, h, f, v, C, P, z, H, K, ae) => {
    e.bc("Resize", s, { antialias: l, axes: h ? Array.from((w(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], coordinateTransformMode: Ee(v), cubicCoeffA: C, excludeOutside: P, extrapolationValue: z, keepAspectRatioPolicy: Ee(H), mode: Ee(K), nearestMode: Ee(ae) });
  }, 1098557: (s, l, h, f, v, C, P) => {
    e.bc("Slice", s, { starts: l ? Array.from((w(), B).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [], ends: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [], axes: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [] });
  }, 1098821: (s) => {
    e.bc("Tile", s, void 0);
  }, 1098873: (s, l, h) => {
    e.bc("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
  }, 1098987: (s, l, h) => {
    e.bc("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
  }, 1099101: (s) => {
    e.bc("Range", s, void 0);
  }, 1099154: (s, l) => {
    e.bc("Einsum", s, { equation: Ee(l) });
  }, 1099235: (s, l, h, f, v) => {
    e.bc("Pad", s, { mode: l, value: h, pads: f ? Array.from((w(), B).subarray(Number(f) >>> 0, Number(v) >>> 0)) : [] });
  }, 1099378: (s, l, h, f, v, C) => {
    e.bc("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!v, trainingMode: !!f, format: C ? "NHWC" : "NCHW" });
  }, 1099547: (s, l, h, f, v, C) => {
    e.bc("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!v, trainingMode: !!f, format: C ? "NHWC" : "NCHW" });
  }, 1099716: (s, l, h) => {
    e.bc("CumSum", s, { exclusive: Number(l), reverse: Number(h) });
  }, 1099813: (s, l, h) => {
    e.bc("DequantizeLinear", s, { axis: l, blockSize: h });
  }, 1099903: (s, l, h, f, v) => {
    e.bc("GridSample", s, { align_corners: l, mode: Ee(h), padding_mode: Ee(f), format: v ? "NHWC" : "NCHW" });
  }, 1100073: (s, l, h, f, v) => {
    e.bc("GridSample", s, { align_corners: l, mode: Ee(h), padding_mode: Ee(f), format: v ? "NHWC" : "NCHW" });
  }, 1100243: (s, l) => {
    e.bc("ScatterND", s, { reduction: Ee(l) });
  }, 1100328: (s, l, h, f, v, C, P, z, H) => {
    e.bc("Attention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: f, scale: v, doRotary: C, qkvHiddenSizes: P ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(z) + P >>> 0)) : [], pastPresentShareBuffer: !!H });
  }, 1100600: (s) => {
    e.bc("BiasAdd", s, void 0);
  }, 1100655: (s) => {
    e.bc("BiasSplitGelu", s, void 0);
  }, 1100716: (s) => {
    e.bc("FastGelu", s, void 0);
  }, 1100772: (s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie, yt, Gn) => {
    e.bc("Conv", s, { format: pe ? "NHWC" : "NCHW", auto_pad: l, dilations: h ? Array.from((w(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], group: v, kernel_shape: C ? Array.from((w(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], pads: z ? Array.from((w(), B).subarray(Number(z) >>> 0, Number(H) >>> 0)) : [], strides: K ? Array.from((w(), B).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [], w_is_const: () => !!(w(), N)[Number(Se) >>> 0], activation: Ee(Ie), activation_params: yt ? Array.from((w(), Q).subarray(Number(yt) >>> 0, Number(Gn) >>> 0)) : [] });
  }, 1101356: (s) => {
    e.bc("Gelu", s, void 0);
  }, 1101408: (s, l, h, f, v, C, P, z, H) => {
    e.bc("GroupQueryAttention", s, { numHeads: l, kvNumHeads: h, scale: f, softcap: v, doRotary: C, rotaryInterleaved: P, smoothSoftmax: z, localWindowSize: H });
  }, 1101625: (s, l, h, f) => {
    e.bc("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!f });
  }, 1101736: (s, l, h, f) => {
    e.bc("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!f });
  }, 1101847: (s, l, h, f, v, C) => {
    e.bc("MatMulNBits", s, { k: l, n: h, accuracyLevel: f, bits: v, blockSize: C });
  }, 1101974: (s, l, h, f, v, C) => {
    e.bc("MultiHeadAttention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: f, scale: v, doRotary: C });
  }, 1102133: (s, l) => {
    e.bc("QuickGelu", s, { alpha: l });
  }, 1102197: (s, l, h, f, v) => {
    e.bc("RotaryEmbedding", s, { interleaved: !!l, numHeads: h, rotaryEmbeddingDim: f, scale: v });
  }, 1102336: (s, l, h) => {
    e.bc("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
  }, 1102438: (s, l, h) => {
    e.bc("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
  }, 1102540: (s, l, h, f) => {
    e.bc("GatherBlockQuantized", s, { gatherAxis: l, quantizeAxis: h, blockSize: f });
  }, 1102661: (s) => {
    e.Id(s);
  }, 1102695: (s, l) => e.Kd(Number(s), Number(l), e.$c.Nd, e.$c.errors) };
  function Lm(s, l, h) {
    return vi(async () => {
      await e.Gd(Number(s), Number(l), Number(h));
    });
  }
  function Wm() {
  ...
  function Zm(s, l, h, f, v, C, P) {
    var z = de();
    try {
      return ra(s, l, h, f, v, C, P);
    } catch (H) {
      if (ue(z), H !== H + 0) throw H;
      le(1, 0);
    }
  }
  function Qm(s, l, h, f, v, C) {
    var P = de();
    try {
      Xi(s, l, h, f, v, C);
    } catch (z) {
      if (ue(P), z !== z + 0) throw z;
      le(1, 0);
    }
  }
  function Ym(s, l, h, f) {
  ...
  function af(s, l, h, f, v, C, P, z, H, K, ae, pe) {
    var Se = de();
    try {
      da(s, l, h, f, v, C, P, z, H, K, ae, pe);
    } catch (Ie) {
      if (ue(Se), Ie !== Ie + 0) throw Ie;
      le(1, 0);
    }
  }
  function sf(s, l, h) {
  ...
  function uf(s, l, h, f, v, C, P, z, H) {
    var K = de();
    try {
      ta(s, l, h, f, v, C, P, z, H);
    } catch (ae) {
      if (ue(K), ae !== ae + 0) throw ae;
      le(1, 0);
    }
  }
  function df(s) {
  ...
  function hf(s, l, h, f, v, C) {
    var P = de();
    try {
      return Ia(s, l, h, f, v, C);
    } catch (z) {
      if (ue(P), z !== z + 0) throw z;
      le(1, 0);
    }
  }
  function gf(s, l, h, f, v, C) {
    var P = de();
    try {
      return la(s, l, h, f, v, C);
    } catch (z) {
      if (ue(P), z !== z + 0) throw z;
      le(1, 0);
    }
  }
  function bf(s, l, h, f, v, C) {
    var P = de();
    try {
      return Ca(s, l, h, f, v, C);
    } catch (z) {
      if (ue(P), z !== z + 0) throw z;
      le(1, 0);
    }
  }
  function yf(s, l, h, f, v, C, P, z) {
    var H = de();
    try {
      return ca(s, l, h, f, v, C, P, z);
    } catch (K) {
      if (ue(H), K !== K + 0) throw K;
      le(1, 0);
    }
  }
  function _f(s, l, h, f, v) {
    var C = de();
    try {
      return Aa(s, l, h, f, v);
    } catch (P) {
  ...
  function $f(s, l, h, f, v, C, P, z, H, K, ae, pe) {
    var Se = de();
    try {
      return Pa(s, l, h, f, v, C, P, z, H, K, ae, pe);
    } catch (Ie) {
      if (ue(Se), Ie !== Ie + 0) throw Ie;
      le(1, 0);
    }
  }
  function xf(s, l, h, f, v, C, P, z, H, K, ae) {
    var pe = de();
    try {
      $a(s, l, h, f, v, C, P, z, H, K, ae);
    } catch (Se) {
      if (ue(pe), Se !== Se + 0) throw Se;
      le(1, 0);
    }
  }
  function Sf(s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie, yt, Gn) {
    var Af = de();
    try {
      xa(s, l, h, f, v, C, P, z, H, K, ae, pe, Se, Ie, yt, Gn);
    } catch (Hn) {
      if (ue(Af), Hn !== Hn + 0) throw Hn;
      le(1, 0);
    }
  }
  function Tf(s, l, h) {
  ...
  function Sr() {
    if (0 < ge) Te = Sr;
      ...
      for (var s = De; 0 < s.length; ) s.shift()(e);
      0 < ge ? Te = Sr : (e.calledRun = true, E || (ve(), _?.(e)));
    }
  }
  return o || (ct = await be(), Sr()), e.PTR_SIZE = 4, ce ? e : new Promise((s, l) => {
    _ = s, S = l;
  });
}
var Mf, Rf, ys = V(() => {
  "use strict";
  Mf = gs, Rf = globalThis.self?.name?.startsWith("em-pthread");
  Rf && gs();
});
var vs, to, Uf, We, $s, eo, Nf, Vf, xs, Lf, _s, Ss, ws, Ts, kr = V(() => {
  "use strict";
  Er();
  vs = typeof location > "u" ? void 0 : location.origin, to = import.meta.url > "file:" && import.meta.url < "file;", Uf = () => {
    if (true) {
      if (to) {
        let t = URL;
        return new URL(new t("ort.bundle.min.mjs", import.meta.url).href, vs).href;
      }
    ...
    try {
      let r = e ?? We;
      return (r ? new URL(t, r) : new URL(t)).origin === vs;
    } catch {
      return false;
    }
  }, Nf = (t, e) => {
  ...
  }, Vf = (t, e) => `${e ?? "./"}${t}`, xs = async (t) => {
    let r = await (await fetch(t, { credentials: "same-origin" })).blob();
    return URL.createObjectURL(r);
  }, Lf = async (t) => (await import(
    /*webpackIgnore:true*/
    /*@vite-ignore*/
    t
  )).default, _s = (hs(), er(fs)).default, Ss = async () => {
    if (!We) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
    if (eo(We)) return [void 0, _s()];
    let t = await xs(We);
    return [t, _s(t)];
  }, ws = (ys(), er(bs)).default, Ts = async (t, e, r, n) => {
    let o = ws && !(t || e);
    if (o) if (We) o = eo(We) || n && !r;
    else if (n && !r) o = true;
    else throw new Error("cannot determine the script source URL.");
    if (o) return [void 0, ws];
    {
      let i = "ort-wasm-simd-threaded.jsep.mjs", a = t ?? Nf(i, e), u = r && a && !eo(a, e), d = u ? await xs(a) : a ?? Vf(i, e);
      return [u ? d : void 0, await Lf(d)];
    }
  };
});
var ro, no, Nr, Is, Wf, Gf, Hf, Pr, ye, vt = V(() => {
  "use strict";
  kr();
  no = false, Nr = false, Is = false, Wf = () => {
    ...
    if (Is) throw new Error("previous call to 'initializeWebAssembly()' failed.");
    Nr = true;
    let e = t.initTimeout, r = t.numThreads;
    if (t.simd !== false) {
      if (t.simd === "relaxed") {
        if (!Hf()) throw new Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
    ...
    let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, a = o?.mjs, u = a?.href ?? a, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = await Ts(u, i, r > 1, !!p || !!c), y = false, b = [];
    if (e > 0 && b.push(new Promise((_) => {
      ...
      g(x).then(($) => {
        Nr = false, no = true, ro = $, _(), m && URL.revokeObjectURL(m);
      }, ($) => {
        Nr = false, Is = true, S($);
      });
...
var Ge, nr, me, Vr = V(() => {
  ...
  Ge = (t, e) => {
    ...
    try {
      ...
      let i = Number(e.getValue(o, n === 4 ? "i32" : "i64")), a = e.getValue(o + n, "*"), u = a ? e.UTF8ToString(a) : "";
...
var Cs, As = V(() => {
  ...
  Cs = (t) => {
    ...
    try {
      ...
      let i = 0;
      return t?.tag !== void 0 && (i = Ge(t.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), t?.extra !== void 0 && nr(t.extra, "", /* @__PURE__ */ new WeakSet(), (a, u) => {
        let d = Ge(a, n), c = Ge(u, n);
        e._OrtAddRunConfigEntry(r, d, c) !== 0 && me(`Can't set a run config entry: ${a} - ${u}.`);
      }), [r, n];
    } catch (i) {
      throw r !== 0 && e._OrtReleaseRunOptions(r), n.forEach((a) => e._free(a)), i;
    }
  };
});
var Ff, qf, Kf, Gt, jf, Es, ks = V(() => {
  "use strict";
  vt();
  Vr();
  Ff = (t) => {
    ...
    for (let o of n) {
      let i = typeof o == "string" ? o : o.name, a = [];
      switch (i) {
        case "webnn":
          if (i = "WEBNN", Gt(t, "session.disable_quant_qdq", "1", r), Gt(t, "session.disable_qdq_constant_folding", "1", r), typeof o != "string") {
            let g = o?.deviceType;
            g && Gt(t, "deviceType", g, r);
          }
          break;
        case "webgpu":
          if (i = "JS", typeof o != "string") {
            ...
            if (m?.preferredLayout) {
              ...
              Gt(t, "preferredLayout", m.preferredLayout, r);
            }
          }
          break;
        case "wasm":
      ...
      let u = Ge(i, r), d = a.length, c = 0, p = 0;
      if (d > 0) {
        c = ye()._malloc(d * ye().PTR_SIZE), r.push(c), p = ye()._malloc(d * ye().PTR_SIZE), r.push(p);
        for (let m = 0; m < d; m++) ye().setValue(c + m * ye().PTR_SIZE, a[m][0], "*"), ye().setValue(p + m * ye().PTR_SIZE, a[m][1], "*");
      }
    ...
    Kf(o);
    try {
      let i = Ff(o.graphOptimizationLevel ?? "all"), a = qf(o.executionMode ?? "sequential"), u = typeof o.logId == "string" ? Ge(o.logId, n) : 0, d = o.logSeverityLevel ?? 2;
      ...
      if (r = e._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, a, !!o.enableProfiling, 0, u, d, c, p), r === 0 && me("Can't create session options."), o.executionProviders && await jf(r, o, n), o.enableGraphCapture !== void 0) {
        if (typeof o.enableGraphCapture != "boolean") throw new Error(`enableGraphCapture must be a boolean value: ${o.enableGraphCapture}`);
        Gt(r, "enableGraphCapture", o.enableGraphCapture.toString(), n);
      }
      ...
      return o.extra !== void 0 && nr(o.extra, "", /* @__PURE__ */ new WeakSet(), (m, g) => {
        Gt(r, m, g, n);
      }), [r, n];
    } catch (i) {
      throw r !== 0 && e._OrtReleaseSessionOptions(r) !== 0 && me("Can't release session options."), n.forEach((a) => e._free(a)), i;
    }
  };
});
var $t, rt, xt, Ht, or, Lr, Wr, oo, ee = V(() => {
  "use strict";
  $t = (t) => {
    switch (t) {
      case "int8":
  ...
  }, Lr = (t) => t === "float32" || t === "float16" || t === "int32" || t === "int64" || t === "uint32" || t === "uint8" || t === "bool" || t === "uint4" || t === "int4", Wr = (t) => t === "float32" || t === "float16" || t === "int32" || t === "int64" || t === "uint32" || t === "uint64" || t === "int8" || t === "uint8" || t === "bool" || t === "uint4" || t === "int4", oo = (t) => {
    switch (t) {
      case "none":
        return 0;
      case "cpu":
...
var Zf, Qf, Ps, Ds, Gr, Yf, se, nt = V(() => {
  "use strict";
  ee();
  Zf = ["V", "I", "W", "E", "F"], Qf = (t, e) => {
    console.log(`[${Zf[t]},${(/* @__PURE__ */ new Date()).toISOString()}]${e}`);
  }, Gr = (t, e) => {
    Ps = t, Ds = e;
  }, Yf = (t, e) => {
    let r = or(t), n = or(Ps);
    r >= n && Qf(r, typeof e == "function" ? e() : e);
  }, se = (...t) => {
    Ds && Yf(...t);
  };
});
var ao, ot, k, Bt, Hr, Os, Bs, te = V(() => {
  "use strict";
  ao = class {
    ...
    static calcShape(e, r, n = false) {
      ...
      if (o === 0) return r;
      if (i === 0) return e;
      let a = Math.max(e.length, r.length), u = new Array(a);
      if (n) {
        if (o < 2 || i < 2) return;
        let d = ao.calcMatMulShape([e[o - 2], e[o - 1]], [r[i - 2], r[i - 1]]);
        if (d === void 0) return;
        [u[a - 2], u[a - 1]] = d;
      }
    ...
    static adjustPoolAttributes(e, r, n, o, i, a) {
    ...
    static adjustPadsBasedOnAutoPad(e, r, n, o, i, a, u) {
      if (u) {
        ...
        for (let d = 0; d < e.length - 2; d++) t.adjustPadAndReturnShape(e[d + (a ? 1 : 2)], r[d], n[d], o[d], i, d, d + e.length - 2, u);
      }
    }
    static computePoolOutputShape(e, r, n, o, i, a, u, d = 0) {
      if (r.length <= 0) throw new Error("input shape must be of size greater than 0");
      let c = [r[0], r[1]];
      return t.computeShapeHelper(e, r, c, n, o, i, a, u, d), c;
    }
    static computeConvOutputShape(e, r, n, o, i, a, u) {
      if (e.length <= 0 || r.length <= 0) throw new Error("invalid input tensor dims or invalid filter tensor dims");
      let d = [e[0], r[0]];
      return t.computeShapeHelper(false, e, d, n, o, i, a, u), d;
    }
    static computeShapeHelper(e, r, n, o, i, a, u, d, c = 0) {
      if (e) for (let p = 0; p < r.length - 2; p++) n.push(1);
      else for (let p = 0; p < r.length - 2; p++) n.push(t.adjustPadAndReturnShape(r[p + 2], o[p], i[p], a[p], u, p, p + r.length - 2, d, c));
    }
    static computeOutputSize(e, r, n, o, i) {
      let a = Math.floor(e / r) + 1;
      return i === 1 && (a = Math.ceil(e / r) + 1, (a - 1) * r >= n + o && (a -= 1)), a;
    }
    static adjustPadAndReturnShape(e, r, n, o, i, a, u, d, c = 0) {
      let p = n * (o - 1) + 1;
      if (d && d !== "NOTSET") switch (d) {
        case "VALID":
          return i[a] = 0, i[u] = 0, t.computeOutputSize(e - p, r, e, 0, c);
        case "SAME_LOWER":
        case "SAME_UPPER":
          if (n !== 1) throw new Error("Dilation not supported for SAME_UPPER or SAME_LOWER");
          {
            let g = (Math.floor((e + r - 1) / r) - 1) * r + o - e;
            return i[a] = Math.floor(d === "SAME_LOWER" ? (g + 1) / 2 : g / 2), i[u] = g - i[a], t.computeOutputSize(e + i[a] + i[u] - p, r, e, i[a], c);
          }
        default:
          throw new Error("Unsupported AutoPad type");
      }
      else return t.computeOutputSize(e + i[a] + i[u] - p, r, e, i[a], c);
    }
  }, Hr = class {
    static getShapeOfGemmResult(e, r, n, o, i) {
      if (e.length !== 2 || n.length !== 2) throw new Error("shape need to be of size 2");
      let a, u, d;
      r ? (a = e[1], u = e[0]) : (a = e[0], u = e[1]);
      let c = -1;
      if (o ? (d = n[0], c = 1) : (d = n[1], c = 0), n[c] !== u) throw new Error("dimension mismatch");
      if (a <= 0 || d <= 0 || u <= 0) throw new Error("invalid shape specified");
      if (i && !ot.isValidBroadcast(i, [a, d])) throw new Error("gemm: invalid bias shape for broadcast");
      return [a, d, u];
    }
  }, Os = -34028234663852886e22, Bs = 34028234663852886e22;
});
var Fr, so = V(() => {
  "use strict";
  ee();
...
var Ms, Xf, Rs, Jf, zs, eh, Us, qr, Kr, uo, Ns, Vs = V(() => {
  "use strict";
  ee();
  nt();
  Ms = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Xf = (t, e) => {
    if (e === "int32") return t;
    let r = Ms.get(e);
    ...
    let o = t.byteLength / n, i = new (Ht(e))(t.buffer, t.byteOffset, o);
    switch (e) {
      case "int64":
      case "uint64": {
  ...
  }, Jf = 1, zs = () => Jf++, eh = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), Us = (t, e) => {
    let r = Ms.get(t);
    ...
    constructor(e) {
      ...
      let { sessionId: r, context: n, tensor: o, dataType: i, shape: a, fallbackDataType: u } = e;
    ...
    get byteLength() {
      return Us(this.dataType, this.tensorShape);
    }
    destroy() {
    ...
    async read(e) {
      if (this.fallbackDataType) {
        let r = await this.mlContext.readTensor(this.mlTensor), n = Rs(new Uint8Array(r), this.dataType);
        if (e) {
    ...
    async ensureTensor(e, r, n, o) {
      let i = this.tensorManager.getMLContext(e), a = this.tensorManager.getMLOpSupportLimits(e), u;
      if (!a?.input.dataTypes.includes(r)) {
        if (u = eh.get(r), !u || !a?.input.dataTypes.includes(u)) throw new Error(`WebNN backend does not support data type: ${r}`);
      ...
      if (this.wrapper) {
        ...
        if (o) {
          if (this.wrapper.byteLength !== Us(r, n)) throw new Error("Unable to copy data to tensor with different size.");
    ...
    upload(e) {
      let r = e;
      if (this.wrapper) {
        if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") r = Xf(e, this.wrapper.type), this.wrapper.setIsDataConverted(true);
    ...
    async download(e) {
      if (this.activeUpload) {
        let r = this.wrapper?.isDataConverted ? Rs(this.activeUpload, this.wrapper?.type) : this.activeUpload;
        if (e) {
    ...
    reserveTensorId() {
      let e = zs();
      return this.tensorTrackersById.set(e, new Kr(this)), e;
    }
    releaseTensorId(e) {
    ...
    registerTensor(e, r, n, o) {
      let i = this.getMLContext(e), a = zs(), u = new qr({ sessionId: e, context: i, tensor: r, dataType: n, shape: o });
      return this.tensorTrackersById.set(a, new Kr(this, u)), this.externalTensors.add(u), a;
    }
    async getCachedTensor(e, r, n, o, i, a, u) {
      ...
      return new qr({ sessionId: e, context: d, tensor: c, dataType: r, shape: n, fallbackDataType: u });
    }
    releaseTensor(e) {
...
var jr, th, Zr, Ls = V(() => {
  ...
  Vs();
  nt();
  jr = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), th = (t, e) => {
    if (t === e) return true;
    ...
    async createMLContext(e) {
      ...
      let r = this.mlContextCache.findIndex((n) => th(n.options, e));
    ...
    async ensureTensor(e, r, n, o, i) {
      ...
      return this.tensorManager.ensureTensor(e ?? this.currentSessionId, r, a, o, i);
    }
    ...
    registerMLTensor(e, r, n, o) {
      ...
      let a = this.tensorManager.registerTensor(e, r, i, o);
    ...
    isGraphInputOutputTypeSupported(e, r, n = true) {
      let o = jr.get($t(r)), i = this.mlOpSupportLimitsBySessionId.get(e);
...
var Ws, lo, co, rh, nh, Gs, mo, po, Fs, qs = V(() => {
  "use strict";
  nt();
  Qr();
  Ws = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), lo = [], co = (t) => Math.ceil(Number(t) / 16) * 16, rh = (t) => {
    for (let e = 0; e < lo.length; e++) {
      let r = lo[e];
      if (t <= r) return r;
    }
    return Math.ceil(t / 16) * 16;
  }, nh = 1, Gs = () => nh++, mo = async (t, e, r, n) => {
    let o = co(r), i = t.device.createBuffer({ size: o, usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ });
    try {
      let a = t.getCommandEncoder();
      t.endComputePass(), a.copyBufferToBuffer(e, 0, i, 0, o), t.flush(), await i.mapAsync(GPUMapMode.READ);
    ...
    constructor(e) {
      ...
      for (let [r] of Ws) lo.push(r), this.freeBuffers.set(r, []), this.freeUniformBuffers.set(r, []);
      this.sessionCount = 0;
    }
    upload(e, r) {
      let n = r.buffer, o = r.byteOffset, i = r.byteLength, a = co(i), u = this.storageCache.get(e);
      ...
      if (a === i && o % 4 === 0) this.backend.device.queue.writeBuffer(u.gpuData.buffer, 0, n, o, i);
      else {
        let d = new Uint8Array(a);
        d.set(r), this.backend.device.queue.writeBuffer(u.gpuData.buffer, 0, d, 0, a);
      }
      se("verbose", () => `[WebGPU] GpuDataManager.upload(id=${e})`);
    }
    memcpy(e, r) {
      ...
      let i = co(n.originalSize), a = this.backend.getCommandEncoder();
    ...
    create(e, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
      let n = rh(e), o, i = (r & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, a = (r & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
      if (i || a) {
    ...
    async download(e, r) {
      ...
      await mo(this.backend, n.gpuData.buffer, n.originalSize, r);
    }
...
var zt, go, we, Ae, W, fe, bo, Mt, Ze, j, Yr, D, R, Ks, Xr, ho, js, oe = V(() => {
  "use strict";
  ee();
  te();
  zt = 64, go = (t, e) => {
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${$}
    return indices;
  }`, I = (M) => (b.offsetToIndices = true, a < 2 ? M : `o2i_${t}(${M})`), A = [];
    if (a >= 2) for (let M = a - 1; M >= 0; M--) A.push(`${j(x, M, a)} * (indices[${M}])`);
    let E = a < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${A.join("+")};
  }`, O = (M) => (b.indicesToOffset = true, a < 2 ? M : `i2o_${t}(${M})`), w = (...M) => a === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, U = (M, G) => a < 2 ? `${M}` : `${j(M, G, a)}`, N = (M, G, be) => a < 2 ? `${M}=${be};` : `${j(M, G, a)}=${be};`, F = {}, q = (M, G) => {
      b.broadcastedIndicesToOffset = true;
      let be = `${G.name}broadcastedIndicesTo${t}Offset`;
      if (be in F) return `${be}(${M})`;
      let ke = [];
      for (let $e = a - 1; $e >= 0; $e--) {
        let De = G.indicesGet("outputIndices", $e + G.rank - a);
        ke.push(`${U(x, $e)} * (${De} % ${U(S, $e)})`);
      }
  ...
  fn get_${t}(${M}) -> ${p} {
    return get_${t}ByIndices(${w(G)});
      ...
      if (M.length !== a) throw new Error(`indices length must be ${a}`);
      let G = M.map(y).join(",");
      return a === 0 ? B("0u") : a === 1 ? B(G[0]) : (b.get = true, b.getByIndices = true, b.indicesToOffset = true, `get_${t}(${G})`);
    }, Z = (M) => a < 2 ? B(M) : (b.getByIndices = true, b.indicesToOffset = true, `get_${t}ByIndices(${M})`), ne = a < 2 ? "" : `
  ...
  fn set_${t}(${M}, value: ${p}) {
    ...
    return { impl: () => {
      let M = [], G = false;
      return b.offsetToIndices && (M.push(T), G = true), b.indicesToOffset && (M.push(E), G = true), b.broadcastedIndicesToOffset && (Object.values(F).forEach((be) => M.push(be)), G = true), b.set && (M.push(ie), G = true), b.setByIndices && (M.push(ne), G = true), b.get && (M.push(Q), G = true), b.getByIndices && (M.push(L), G = true), !i && G && M.unshift(`const ${S} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), M.join(`
`);
    }, type: g, offsetToIndices: I, indicesToOffset: O, broadcastedIndicesToOffset: q, indices: w, indicesGet: U, indicesSet: N, set: (...M) => {
      if (M.length !== a + 1) throw new Error(`indices length must be ${a}`);
      let G = M[a];
      if (typeof G != "string") throw new Error("value must be string");
      let be = M.slice(0, a).map(y).join(",");
      return a === 0 ? X("0u", G) : a === 1 ? X(be[0], G) : (b.set = true, b.setByIndices = true, b.indicesToOffset = true, `set_${t}(${be}, ${G})`);
    }, setByOffset: X, setByIndices: (M, G) => a < 2 ? X(M, G) : (b.setByIndices = true, b.indicesToOffset = true, `set_${t}ByIndices(${M}, ${G});`), get: Y, getByOffset: B, getByIndices: Z, usage: n, name: t, strides: x, shape: S, rank: a };
  }, D = (t, e, r, n = 1) => Yr(t, e, r, "input", n), R = (t, e, r, n = 1) => Yr(t, e, r, "output", n), Ks = (t, e, r) => Yr(t, e, r, "atomicOutput", 1), Xr = (t, e, r, n = 1) => Yr(t, e, r, "internal", n), ho = class {
    constructor(e, r) {
...
var oh, Zs, ih, ah, sh, uh, Be, Qs, Ys, pt = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  oh = (t, e) => {
  ...
  }, Zs = (t, e) => e.length !== 0 ? e : [...new Array(t).keys()].reverse(), ih = (t, e) => k.sortBasedOnPerm(t, Zs(t.length, e)), ah = (t, e, r, n) => {
    ...
    let r = t.dataType, n = t.dims.length, o = Zs(n, e), i = ih(t.dims, o), a = t.dims, u = i, d = n < 2 || uh(o, t.dims), c;
    if (d) return c = (_) => {
      let S = D("input", r, a, 4), x = R("output", r, u, 4);
      return `
  ...
  ${_.mainStart()}
    ...
    let { newShape: p, newPerm: m } = sh(t.dims, o), g = k.areEqual(m, [2, 3, 1]), y = k.areEqual(m, [3, 1, 2]);
    if (p.length === 2 || g || y) {
      a = g ? [p[0], p[1] * p[2]] : y ? [p[0] * p[1], p[2]] : p, u = [a[1], a[0]];
      let _ = 16;
      return c = (S) => {
        let x = D("a", r, a.length), $ = R("output", r, u.length);
        return `
  ...
  ${S.mainStart([_, _, 1])}
    ...
    if (output_row < uniforms.output_shape[0] && output_col < uniforms.output_shape[1]) {
      ${$.setByIndices(`${$.type.indices}(output_row, output_col)`, "tile[local_id.x][local_id.y]")}
        ...
        let S = k.size(i);
        return { outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(u[1] / _), y: Math.ceil(u[0] / _) }, programUniforms: [{ type: 12, data: S }, ...W(a, u)] };
      }, getShaderSource: c };
    }
    return c = (_) => {
      let S = D("a", r, a.length), x = R("output", r, u.length);
      return `
  ${_.registerUniform("output_size", "u32").declareVariables(S, x)}
  ...
  ${_.mainStart()}
    ...
    ${x.setByOffset("global_idx", S.getByIndices("aIndices"))}
      ...
      let _ = k.size(i);
      return { outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(_ / 64) }, programUniforms: [{ type: 12, data: _ }, ...W(a, u)] };
    }, getShaderSource: c };
  }, Qs = (t, e) => {
    oh(t.inputs, e.perm), t.compute(Be(t.inputs[0], e.perm));
  }, Ys = (t) => J({ perm: t.perm });
});
var dh, lh, ch, ph, mh, fh, hh, gh, bh, yh, it, Xs, Js, eu, tu, ru, nu, ou, iu, au, su, uu = V(() => {
  "use strict";
  ee();
  te();
  oe();
  Jr();
  pt();
  dh = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, lh = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, ch = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, ph = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, mh = (t, e) => {
    let r = [];
    ...
    let u = r[0].dims, d = k.size(i), c = k.size(a), p = D("_A", r[0].dataType, u), m = R("output", o, i), g = 64;
    d === 1 && (g = 256);
    let y = `
    ...
    let o = t.inputs.length === 1 ? r : yo(t.inputs, r), i = o.axes;
    i.length === 0 && !o.noopWithEmptyAxes && (i = t.inputs[0].dims.map((y, b) => b));
    let a = k.normalizeAxes(i, t.inputs[0].dims.length), u = a, d = t.inputs[0], c = bh(u, t.inputs[0].dims.length);
    c.length > 0 && (d = t.compute(Be(t.inputs[0], c), { inputs: [0], outputs: [-1] })[0], u = mh(u.length, d.dims.length));
    let [p, m] = fh(d.dims, u), g = p;
    o.keepDims && (g = hh(p, a)), t.compute(yh(e, o.cacheKey, [d], n, t.inputs[0].dataType, g, m), { inputs: [d] });
  }, Xs = (t, e) => {
...
var at, _h, en, yo, st, wh, vh, $h, xh, Sh, Th, Ih, Ch, Ah, Eh, ut, du, lu, cu, pu, mu, fu, hu, gu, bu, yu, Jr = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  }, _h = (t) => ["", "", `var value = ${t.getByIndices("input_indices")};`, ""], en = (t, e, r, n, o, i, a = false, u = false) => {
    let d = [], c = r[0].dims, p = c.length, m = k.normalizeAxes(o, p), g = !u && m.length === 0;
    c.forEach((S, x) => {
      g || m.indexOf(x) >= 0 ? a && d.push(1) : d.push(S);
    });
    let y = d.length, b = k.size(d);
    return { name: t, shaderCache: e, getShaderSource: (S) => {
      let x = [], $ = D("_A", r[0].dataType, p), T = R("output", i, y), I = n($, T, m), A = I[2];
      for (let E = 0, O = 0; E < p; E++) g || m.indexOf(E) >= 0 ? (a && O++, A = `for(var j${E}: u32 = 0; j${E} < ${c[E]}; j${E}++) {
                  ${I[2].includes("last_index") ? `let last_index = j${E};` : ""}
                  ${$.indicesSet("input_indices", E, `j${E}`)}
                  ${A}
                }`) : (x.push(`${$.indicesSet("input_indices", E, T.indicesGet("output_indices", O))};`), O++);
      return `
...
`)}
    ...
    let r = [];
    return t[1].dims[0] > 0 && t[1].getBigInt64Array().forEach((n) => r.push(Number(n))), J({ axes: r, keepDims: e.keepDims, noopWithEmptyAxes: e.noopWithEmptyAxes });
  }, st = (t, e, r, n) => {
    let o = t.inputs, i = o.length === 1 ? r : yo(o, r);
    t.compute(en(e, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? _h : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
  }, wh = (t, e) => {
...
`)}`, `var value = ${n.getByIndices("input_indices")};`, `value = max(value, ${n.getByIndices("input_indices")});`, ""];
    ...
    at(t.inputs), st(t, "ReduceMean", e, (n, o, i) => {
      let a = 1;
      for (let u = 0; u < n.rank; u++) (i.indexOf(u) >= 0 || i.length === 0) && (a *= t.inputs[0].dims[u]);
...
`)}`, `var value = ${n.getByIndices("input_indices")};`, `value = min(value, ${n.getByIndices("input_indices")});`, ""];
    ...
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Th(t, e) : Xs(t, e);
  }, lu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? vh(t, e) : Js(t, e);
  }, cu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? $h(t, e) : eu(t, e);
  }, pu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? xh(t, e) : tu(t, e);
  }, mu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Sh(t, e) : ru(t, e);
  }, fu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Ih(t, e) : nu(t, e);
  }, hu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Ch(t, e) : ou(t, e);
  }, gu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Ah(t, e) : iu(t, e);
  }, bu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? Eh(t, e) : au(t, e);
  }, yu = (t, e) => {
    ut(t.inputs[0].dims, e.axes, e.noopWithEmptyAxes) ? wh(t, e) : su(t, e);
  };
});
var _u, wu, vu, _o, $u = V(() => {
  "use strict";
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${e.selectLastIndex > 0 ? "<=" : "<"} value) {
    ...
    t.compute(en("ArgMin", { hint: e.cacheKey, inputDependencies: ["rank"] }, [t.inputs[0]], r, [e.axis], 7, e.keepDims), { inputs: [0] });
  }, vu = (t, e) => {
    _u(t.inputs);
    let r = (n, o, i) => {
      let a = [];
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${e.selectLastIndex > 0 ? ">=" : ">"} value) {
    ...
    t.compute(en("argMax", { hint: e.cacheKey, inputDependencies: ["rank"] }, [t.inputs[0]], r, [e.axis], 7, e.keepDims), { inputs: [0] });
  }, _o = (t) => J(t);
});
var kh, wo, Ph, Dh, Oh, Ft, Bh, xu, tn = V(() => {
  "use strict";
  ee();
  te();
  Qr();
  oe();
  kh = (t, e) => {
    let r = t[0], n = t[1], o = t[2], i = t[3], a = t[4], u = t[5];
    ...
    if (a) {
      ...
      if (a.dims[2] !== e.numHeads) throw new Error('Input "past" third dimension must be num_heads');
      if (a.dims[4] !== g / e.numHeads) throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');
      e.pastPresentShareBuffer || (_ = a.dims[3]);
    }
    let S = b + _, x = -1, $ = 0;
    ...
    `, Ph = (t, e, r, n, o, i, a, u) => {
    let d = fe(a ? 1 : i), c = 64, p = i / d;
    p < c && (c = 32);
    let m = Math.ceil(i / d / c), g = [{ type: 12, data: e }, { type: 12, data: r }, { type: 12, data: n }, { type: 12, data: o }, { type: 12, data: p }, { type: 12, data: m }], y = we(t.dataType, d), b = Ae(1, d), _ = ["type"];
    a && _.push("type"), u && _.push("type");
    let S = (x) => {
      let $ = R("x", t.dataType, t.dims, d), T = [$], I = a ? D("seq_lens", a.dataType, a.dims) : void 0;
      I && T.push(I);
      let A = u ? D("total_sequence_length_input", u.dataType, u.dims) : void 0;
      A && T.push(A);
      let E = Ae(t.dataType), O = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
      return `
  ...
  ${x.mainStart([c, 1, 1])}
    ...
    let O = [{ dims: p, dataType: e.dataType, gpuDataType: 0 }];
    m && O.push({ dims: y, dataType: e.dataType, gpuDataType: 0 });
    let w = (U) => {
      let N = D("q", e.dataType, e.dims, S), F = D("key", r.dataType, r.dims, S), q = [N, F];
      if (A) {
        let ne = D("past_key", n.dataType, n.dims, S);
        q.push(ne);
      }
      o && q.push(D("attention_bias", o.dataType, o.dims));
      let X = u ? D("seq_lens", u.dataType, u.dims) : void 0;
      X && q.push(X);
      let B = d ? D("total_sequence_length_input", d.dataType, d.dims) : void 0;
      B && q.push(B);
      let L = R("output", e.dataType, p), Q = [L];
      m && Q.push(R("present_key", e.dataType, y, S));
      let Y = Ae(1, S), Z = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
      return `
  const TILE_SIZE = ${$}u;
  ...
  ${U.mainStart([$, $, 1])}
    ...
    return { name: "AttentionProbs", shaderCache: { hint: `${S};${o !== void 0};${n !== void 0};${t}`, inputDependencies: E }, getRunData: () => ({ outputs: O, dispatchGroup: T, programUniforms: I }), getShaderSource: w };
  }, Oh = (t, e, r, n, o, i, a = void 0, u = void 0) => {
    ...
    $ && T.push("type"), a && T.push("type"), u && T.push("type");
    let I = [{ dims: b, dataType: e.dataType, gpuDataType: 0 }];
    m && I.push({ dims: y, dataType: e.dataType, gpuDataType: 0 });
    let A = (E) => {
      let O = D("probs", e.dataType, e.dims), w = D("v", r.dataType, r.dims), U = [O, w];
      $ && U.push(D("past_value", n.dataType, n.dims));
      let N = a ? D("seq_lens", a.dataType, a.dims) : void 0;
      a && U.push(N);
      let F = u ? D("total_sequence_length_input", u.dataType, u.dims) : void 0;
      u && U.push(F);
      let X = [R("output", e.dataType, b)];
      m && X.push(R("present_value", e.dataType, y));
  ...
  }, Ft = (t, e, r, n, o, i, a, u, d, c, p = void 0, m = void 0) => {
    let g = Math.min(t.outputCount, 1 + (a ? 1 : 0) + (u ? 1 : 0)), y = g > 1 ? a : void 0, b = g > 1 ? u : void 0, _ = g > 1 ? c.pastSequenceLength : 0, S = _ + c.kvSequenceLength, x = d && k.size(d.dims) > 0 ? d : void 0, $ = [e, r];
    y && k.size(y.dims) > 0 && $.push(y), x && $.push(x), p && $.push(p), m && $.push(m);
    let T = t.compute(Dh(g, e, r, y, x, c, _, p, m), { inputs: $, outputs: g > 1 ? [-1, 1] : [-1] })[0];
    t.compute(Ph(T, c.batchSize, c.numHeads, _, c.sequenceLength, S, p, m), { inputs: p && m ? [T, p, m] : [T], outputs: [] });
    let I = [T, n];
    b && k.size(b.dims) > 0 && I.push(b), p && I.push(p), m && I.push(m), t.compute(Oh(g, T, n, b, c, _, p, m), { inputs: I, outputs: g > 1 ? [0, 2] : [0] });
  }, Bh = (t, e) => {
    let r = [e.batchSize, e.numHeads, e.sequenceLength, e.headSize], n = e.sequenceLength, o = e.inputHiddenSize, i = e.headSize, a = 12, u = { x: Math.ceil(e.headSize / a), y: Math.ceil(e.sequenceLength / a), z: e.batchSize * e.numHeads }, d = [t.inputs[0], t.inputs[1], t.inputs[2]], c = [{ type: 12, data: n }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: e.numHeads }, { type: 12, data: e.headSize }, { type: 12, data: e.hiddenSize }, { type: 12, data: e.hiddenSize + e.hiddenSize + e.vHiddenSize }], p = (m) => {
      let g = R("output_q", d[0].dataType, r), y = R("output_k", d[0].dataType, r), b = R("output_v", d[0].dataType, r), _ = D("input", d[0].dataType, d[0].dims), S = D("weight", d[1].dataType, d[1].dims), x = D("bias", d[2].dataType, d[2].dims), $ = _.type.storage, T = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "ldb", type: "u32" }];
      return `
  const TILE_SIZE = ${a}u;
  ...
  ${m.mainStart([a, a, 1])}
    ...
    let r = kh(t.inputs, e), [n, o, i] = Bh(t, r);
    return Ft(t, n, o, i, t.inputs[4], void 0, void 0, void 0, t.inputs[5], r);
  };
});
var zh, Mh, Rh, Su, Tu = V(() => {
  "use strict";
  Le();
  ee();
  te();
  ...
  zh = (t, e) => {
    ...
    let { epsilon: r, spatial: n, format: o } = e, i = t[0].dims, a = n ? fe(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? a : 1, d = k.size(i) / a, c = n, p = c ? i.length : i, m = D("x", t[0].dataType, t[0].dims, a), g = D("scale", t[1].dataType, t[1].dims, u), y = D("bias", t[2].dataType, t[2].dims, u), b = D("inputMean", t[3].dataType, t[3].dims, u), _ = D("inputVar", t[4].dataType, t[4].dims, u), S = R("y", t[0].dataType, p, a), x = () => {
      let T = "";
      if (n) T = `let cOffset = ${i.length === 1 ? "0u" : o === "NHWC" ? `outputIndices[${i.length - 1}] / ${a}` : "outputIndices[1]"};`;
      else if (o === "NCHW") T = `
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    return { name: "BatchNormalization", shaderCache: { hint: `${e.epsilon}_${e.format}_${n}_${a}`, inputDependencies: c ? ["rank", "type", "type", "type", "type"] : void 0 }, getShaderSource: $, getRunData: () => ({ outputs: [{ dims: t[0].dims, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(d / 64) }, programUniforms: c ? [{ type: 12, data: d }, ...W(i)] : [{ type: 12, data: d }] }) };
  }, Rh = (t) => J(t), Su = (t, e) => {
    let { inputs: r, outputCount: n } = t, o = Rh({ ...e, outputCount: n });
    if (_e.webgpu.validateInputContent && zh(r, o), e.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
    t.compute(Mh(r, o));
  };
});
var Uh, Nh, Iu, Cu = V(() => {
  ...
  Uh = (t) => {
    ...
    let e = t[0].dims, r = t[0].dims[2], n = k.size(e) / 4, o = t[0].dataType, i = D("input", o, e, 4), a = D("bias", o, [r], 4), u = D("residual", o, e, 4), d = R("output", o, e, 4);
  ...
  ${p.mainStart()}
    ...
    Uh(t.inputs), t.compute(Nh(t.inputs));
  };
});
var Vh, he, Au, Eu, ku, Pu, Du, Ou, Bu, zu, Mu, Lh, Ru, Uu, Nu, Vu, ar, Lu, rn, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Yu, Xu, Ju, ed, td, rd, nd, od, id, ad, vo, $o, sd, ud, dd, Wh, Gh, ld, nn = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Vh = (t, e, r, n, o, i, a) => {
    ...
    let c = D("inputData", r, [u], 4), p = R("outputData", n, [u], 4), m = [{ name: "vec_size", type: "u32" }];
    return a && m.push(...a), `
  ...
  ${t.mainStart()}
  ...
  }, he = (t, e, r, n, o, i = t.dataType, a, u) => {
    let d = [{ type: 12, data: Math.ceil(k.size(t.dims) / 4) }];
    return a && d.push(...a), { name: e, shaderCache: { hint: o, inputDependencies: ["type"] }, getShaderSource: (c) => Vh(c, k.size(t.dims), t.dataType, i, r, n, u), getRunData: (c) => ({ outputs: [{ dims: t.dims, dataType: i }], dispatchGroup: { x: Math.ceil(k.size(c[0].dims) / 64 / 4) }, programUniforms: d }) };
  }, Au = (t) => {
    ...
    return J({ min: e, max: r });
  }, Ru = (t, e) => {
    let r = e || Lh(t.inputs), n = Ae(t.inputs[0].dataType);
...
fn erf_vf32(v: vec4<${t}>) -> vec4<${t}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
    ...
    let e = Ae(t.inputs[0].dataType);
    t.compute(he(t.inputs[0], "Erf", (r) => `erf_vf32(${r})`, rn(e)));
  }, Gu = (t) => {
    ...
    let e = Ae(t.inputs[0].dataType);
    t.compute(he(t.inputs[0], "Gelu", (r) => `0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`, rn(e)));
  }, qu = (t, e) => {
    let r = Ae(t.inputs[0].dataType);
    ...
    let e = Ae(t.inputs[0].dataType);
    t.compute(he(t.inputs[0], "HardSwish", (r) => `${r} * max(vec4<${e}>(0.0), min(vec4<${e}>(1.0), vec4<${e}>(${e}(1.0 / 6.0)) * ${r} + vec4<${e}>(0.5)))`));
  }, td = (t) => {
  ...
  }, id = (t) => `sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`, ad = (t) => {
    t.compute(he(t.inputs[0], "Tanh", id));
  }, vo = (t = "f32") => `
...
`, $o = (t) => `(fast_gelu_a + fast_gelu_a * tanh_v(${t} * (fast_gelu_c * ${t} * ${t} + fast_gelu_b))) * ${t}`, sd = (t) => {
    let e = Ae(t.inputs[0].dataType);
    t.compute(he(t.inputs[0], "FastGelu", $o, vo(e), void 0, t.inputs[0].dataType));
  }, ud = (t, e) => {
    let r = Ae(t.inputs[0].dataType);
...
`, Gh = (t) => `quick_gelu_impl(${t})`, ld = (t, e) => {
    let r = Ae(t.inputs[0].dataType);
    t.compute(he(t.inputs[0], "QuickGelu", Gh, Wh(r, e.alpha), e.cacheKey, t.inputs[0].dataType));
  };
});
var Hh, Fh, pd, md = V(() => {
  "use strict";
  ...
  Hh = (t) => {
    ...
    e[2] = e[2] / 2;
    let r = D("input", t[0].dataType, t[0].dims, 4), n = D("bias", t[0].dataType, [t[0].dims[2]], 4), o = R("output", t[0].dataType, e, 4), i = k.size(e) / 4, a = we(t[0].dataType);
  ...
  ${d.mainStart()}
    ...
    Hh(t.inputs), t.compute(Fh(t.inputs));
  };
});
var qh, Kh, dt, fd, hd, gd, bd, yd, _d, wd, vd, $d, xd, Sd = V(() => {
  "use strict";
  ee();
  te();
  oe();
  qh = (t, e, r, n, o, i, a, u, d, c, p, m) => {
    let g, y;
    typeof u == "string" ? g = y = ($, T) => `${u}((${$}),(${T}))` : typeof u == "function" ? g = y = u : (g = u.scalar, y = u.vector);
    let b = R("outputData", p, n.length, 4), _ = D("aData", d, e.length, 4), S = D("bData", c, r.length, 4), x;
    if (o) if (i) {
      ...
      let $ = (T, I, A = "") => {
        let E = `aData[indexA${I}][componentA${I}]`, O = `bData[indexB${I}][componentB${I}]`;
        return `
    ...
    if (c) {
      ...
      for (let A = 1; A < p.length; A++) {
        let E = u[u.length - A], O = d[d.length - A];
        if (E === O) I *= E;
        else break;
      }
      I % 4 === 0 ? (y = true, g = true) : (S || x || $ || T) && (g = true);
    } else g = true;
    return b.push(g), { name: t, shaderCache: { hint: e + b.map((_) => _.toString()).join("_"), inputDependencies: ["rank", "rank"] }, getShaderSource: (_) => qh(_, u, d, p, g, c, y, o, r.dataType, n.dataType, a, i), getRunData: () => ({ outputs: [{ dims: p, dataType: a }], dispatchGroup: { x: Math.ceil(m / 64 / 4) }, programUniforms: [{ type: 12, data: Math.ceil(k.size(p) / 4) }, ...W(u, d, p)] }) };
  }, dt = (t, e, r, n, o, i) => {
    t.compute(Kh(e, o ?? "", t.inputs[0], t.inputs[1], r, n, i));
  }, fd = (t) => {
    dt(t, "Add", (e, r) => `${e}+${r}`);
  }, hd = (t) => {
    dt(t, "Div", (e, r) => `${e}/${r}`);
    ...
    let e = D("input", t.inputs[0].dataType, t.inputs[0].dims).type.value;
...
`);
    ...
    let o = k.size(r), i = new Array(t.length), a = new Array(t.length), u = 0, d = [], c = [], p = [{ type: 12, data: o }];
    for (let _ = 0; _ < t.length; ++_) u += t[_].dims[e], i[_] = u, c.push(t[_].dims.length), a[_] = D(`input${_}`, n, c[_]), d.push("rank"), p.push({ type: 12, data: i[_] });
    for (let _ = 0; _ < t.length; ++_) p.push(...W(t[_].dims));
    p.push(...W(r));
    let m = R("output", n, r.length), g = m.indicesGet("indices", e), y = Array.from(Array(i.length).keys()).map((_) => `uniforms.sizeInConcatAxis${_}`).join(","), b = (_) => `
  ...
  ${_.mainStart()}
    ...
    t.compute(Xh(a, o, i, r[0].dataType), { inputs: a });
  }, Id = (t) => J({ axis: t.axis });
});
var Qe, Ye, Xe, on, St = V(() => {
  "use strict";
  ee();
  te();
  Qe = (t, e, r = "f32") => {
    ...
    if (e === "HardSigmoid") {
      ...
      let [r, n] = t?.activation_params || [Os, Bs];
...
`;
  }, sn = (t, e, r, n, o = false, i) => {
    let a = t[0].dims, u = t[1].dims, d = a[a.length - 2], c = u[u.length - 1], p = a[a.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), $ = [k.size(S), d, c], T = [{ type: 12, data: b }, { type: 12, data: d }, { type: 12, data: c }, { type: 12, data: p }];
    Ye(e, T), T.push(...W(S, a, u)), _ && T.push(...W(t[2].dims)), T.push(...W($));
    let I = (A) => {
      let E = Xr("batch_dims", t[0].dataType, S.length), O = D("a", t[0].dataType, a.length, g), w = D("b", t[1].dataType, u.length, m), U = R("output", t[0].dataType, $.length, m), N = we(U.type.tensor), F = Qe(e, U.type.value, N), q = [O, w], X = "";
      if (_) {
        let Q = o ? m : 1;
        q.push(D("bias", t[2].dataType, t[2].dims.length, Q)), X = `${o ? `value += bias[col / ${Q}];` : `value += ${U.type.value}(bias[row + i]);`}`;
      }
...
var Jh, eg, xo, Pd, tg, So, rg, ur, dn = V(() => {
  "use strict";
  ee();
  te();
  oe();
  ...
  Jh = (t, e) => t ? `
        ...
        }`, xo = (t, e, r = "f32", n, o = false, i = 32, a = false, u = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, tg = (t) => t ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", So = (t, e, r = "f32", n, o = false, i = 32, a = false, u = 32, d = false) => {
...
`;
    ...
    let [i, a, u, d] = n, c = we(n[0].type.tensor);
    return `
    ...
    `;
  }, ur = (t, e, r, n, o = false, i) => {
    let a = t[0].dims, u = t[1].dims, d = a.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = k.size(p), g = a[a.length - 2], y = a[a.length - 1], b = u[u.length - 1], _ = y % 4 === 0 && b % 4 === 0, S = g <= 8 ? [4, 1, 1] : [4, 4, 1], x = [8, 8, 1], $ = [Math.ceil(b / x[0] / S[0]), Math.ceil(g / x[1] / S[1]), Math.ceil(m / x[2] / S[2])], T = _ ? 4 : 1, I = [...d, g, y / T], A = I.length, E = [...c, y, b / T], O = E.length, w = [m, g, b / T], U = [{ type: 6, data: g }, { type: 6, data: b }, { type: 6, data: y }];
    Ye(e, U), U.push(...W(p, I, E));
    let N = ["rank", "rank"], F = t.length > 2;
    F && (U.push(...W(t[2].dims)), N.push("rank")), U.push(...W(w));
    let q = (X) => {
      let B = p.length, L = Xr("batchDims", t[0].dataType, B, 1), Q = we(t[0].dataType), Y = D("a", t[0].dataType, A, T), Z = D("b", t[1].dataType, O, T), ne = R("result", t[0].dataType, w.length, T), ie = [Y, Z];
      if (F) {
        let G = o ? T : 1;
        ie.push(D("bias", t[2].dataType, t[2].dims.length, G));
      }
      let ce = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }];
      Xe(e, ce);
      let Me = we(ne.type.tensor), ve = Qe(e, ne.type.value, Me), M = rg(T, F, ve, [L, Y, Z, ne], o);
      return `
  ...
  ${_ ? xo(S, x, Q, L) : So(S, x, Q, L)}
    ...
    return { name: "MatMul", shaderCache: { hint: `${S};${e.activation};${_};${o}`, inputDependencies: N }, getRunData: () => ({ outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: $[0], y: $[1], z: $[2] }, programUniforms: U }), getShaderSource: q };
  };
});
var ng, Dd, Od = V(() => {
  "use strict";
  ...
  kd();
  dn();
  ng = (t, e, r, n, o = false, i, a = 4, u = 4, d = 4, c = "f32") => {
    let p = (N) => {
      switch (N) {
        case 1:
    ...
    return ${Pe(u, c)}(0.0);`, A = Pe(d, c), E = t ? Pe(a, c) : Pe(u, c), O = t ? Pe(u, c) : Pe(a, c), w = Qe(i, A, c);
    return `
    ...
    let A = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, E = $[1] * T[1], O = $[0] * T[0], w = Math.max($[0] * A, $[1]), U = n % E === 0, N = o % O === 0, F = i % w === 0, q = _ ? [A, 4, 4] : [1, 1, 1], X = [{ type: 6, data: n }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [e.pads[0], e.pads[1]] }, { type: 6, data: e.strides }, { type: 6, data: e.dilations }];
    Ye(e, X), X.push(...W(t[0].dims, t[1].dims));
    let B = ["rank", "rank"];
    a && (X.push(...W(t[2].dims)), B.push("rank")), X.push(...W(r));
    let L = (Q) => {
      ...
      Xe(e, Y);
      let Z = _ ? 4 : 1, ne = we(t[0].dataType), ie = `
      ...
      }`, ce = D("x", t[0].dataType, t[0].dims.length, A === 3 ? 1 : A), Me = D("w", t[1].dataType, t[1].dims.length, Z), ve = [ce, Me], M = R("result", t[0].dataType, r.length, Z);
      if (a) {
        let G = D("bias", t[2].dataType, t[2].dims.length, Z);
        ve.push(G), ie += `
      ...
      return `
        ...
        ${_ ? xo(T, $, ne, void 0, !c, w) : So(T, $, ne, void 0, !c, w, false, void 0, u)}`;
    };
    return { name: "Conv2DMatMul", shaderCache: { hint: `${e.cacheKey};${A};${_};${U};${N};${F};${E};${O};${w}`, inputDependencies: B }, getRunData: () => ({ outputs: [{ dims: d ? d(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: I[0], y: I[1], z: I[2] }, programUniforms: X }), getShaderSource: L };
  };
});
var og, Bd, ln, ig, zd, ag, Md, Rd, Ud = V(() => {
  "use strict";
  ee();
  nt();
  te();
  ...
  og = (t) => {
    ...
    return e;
  }, Bd = (t) => typeof t == "number" ? [t, t, t] : t, ln = (t, e) => e <= 1 ? t : t + (t - 1) * (e - 1), ig = (t, e, r, n = 1) => {
    let o = ln(e, n);
    return Math.floor((t[0] * (r - 1) - r + o) / 2);
  }, zd = (t, e, r, n, o) => {
    o == null && (o = ig(t, e[0], n[0]));
    let i = [0, 0, 0, r];
    for (let a = 0; a < 3; a++) t[a] + 2 * o >= e[a] && (i[a] = Math.trunc((t[a] - e[a] + 2 * o) / n[a] + 1));
    return i;
  }, ag = (t, e, r, n, o, i, a, u, d, c) => {
    let p, m, g, y;
    if (t === "VALID" && (t = 0), typeof t == "number") {
      p = { top: t, bottom: t, left: t, right: t, front: t, back: t };
      let b = zd([e, r, n, 1], [u, d, c], 1, [o, i, a], t);
      m = b[0], g = b[1], y = b[2];
      ...
      let b = zd([e, r, n, 1], [u, d, c], 1, [o, i, a], t[0]);
      m = b[0], g = b[1], y = b[2];
    } else if (t === "SAME_UPPER") {
      m = Math.ceil(e / o), g = Math.ceil(r / i), y = Math.ceil(n / a);
      let b = (m - 1) * o + u - e, _ = (g - 1) * i + d - r, S = (y - 1) * a + c - n, x = Math.floor(b / 2), $ = b - x, T = Math.floor(_ / 2), I = _ - T, A = Math.floor(S / 2), E = S - A;
  ...
  }, Md = (t, e, r, n, o, i = false, a = "channelsLast") => {
    let u, d, c, p, m;
    if (a === "channelsLast") [u, d, c, p, m] = t;
    else if (a === "channelsFirst") [u, m, d, c, p] = t;
    else throw new Error(`Unknown dataFormat ${a}`);
    let [g, , y, b, _] = e, [S, x, $] = Bd(r), [T, I, A] = Bd(n), E = ln(y, T), O = ln(b, I), w = ln(_, A), { padInfo: U, outDepth: N, outHeight: F, outWidth: q } = ag(o, d, c, p, S, x, $, E, O, w), X = i ? g * m : g, B = [0, 0, 0, 0, 0];
    return a === "channelsFirst" ? B = [u, X, N, F, q] : a === "channelsLast" && (B = [u, N, F, q, X]), { batchSize: u, dataFormat: a, inDepth: d, inHeight: c, inWidth: p, inChannels: m, outDepth: N, outHeight: F, outWidth: q, outChannels: X, padInfo: U, strideDepth: S, strideHeight: x, strideWidth: $, filterDepth: y, filterHeight: b, filterWidth: _, effectiveFilterDepth: E, effectiveFilterHeight: O, effectiveFilterWidth: w, dilationDepth: T, dilationHeight: I, dilationWidth: A, inShape: t, outShape: B, filterShape: e };
  }, Rd = (t, e, r, n, o, i) => {
    let a = i === "channelsLast", u = a ? t[0].dims[3] : t[0].dims[1], d = false, c = [64, 1, 1], p = { x: r.map(($, T) => T) }, m = [Math.ceil(og(p.x.map(($) => r[$])) / c[0]), 1, 1];
    se("verbose", () => `[conv3d_naive_webgpu] dispatch = ${m}`);
    let g = d ? a && u % 4 !== 0 ? 3 : 4 : 1, y = k.size(r), b = [{ type: 12, data: y }, { type: 12, data: n }, { type: 12, data: o }, { type: 12, data: e.strides }, { type: 12, data: e.dilations }];
    ...
    let x = ($) => {
      ...
      Xe(e, T);
      let I = d ? 4 : 1, A = we(t[0].dataType), E = D("x", t[0].dataType, t[0].dims.length, g === 3 ? 1 : g), O = D("W", t[1].dataType, t[1].dims.length, I), w = [E, O], U = R("result", t[0].dataType, r.length, I), N = "";
      if (S) {
        let X = D("bias", t[2].dataType, t[2].dims.length, I);
        w.push(X), N += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${d ? `vec4<${A}>` : A} {
          return bias[${a ? j("coords", 4, 5) : j("coords", 1, 5)}${d ? "/ 4" : ""}];
        }`;
      }
      let F = Pe(g, A), q = Qe(e, F, A);
      return `
            ${N}
    ...
    return { name: "Conv3DNaive", shaderCache: { hint: `${e.cacheKey};${a};${g};${S}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: r, dataType: t[0].dataType }], dispatchGroup: { x: m[0], y: m[1], z: m[2] }, programUniforms: b }), getShaderSource: x };
  };
});
var Nd, Vd, Ld = V(() => {
  "use strict";
  ...
  St();
  Nd = (t, e, r, n) => {
    let o = t.length > 2, i = o ? "value += b[output_channel];" : "", a = t[0].dims, u = t[1].dims, d = e.format === "NHWC", c = d ? r[3] : r[1], p = c / e.group, m = d && p >= 4 ? fe(c) : 1, g = k.size(r) / m, y = [{ type: 12, data: g }, { type: 12, data: e.dilations }, { type: 12, data: [e.strides[0], e.strides[1]] }, { type: 12, data: [e.pads[0], e.pads[1]] }, { type: 12, data: p }];
    Ye(e, y), y.push(...W(a, [u[0], u[1], u[2], u[3] / m]));
    let b = o ? ["rank", "rank", "rank"] : ["rank", "rank"];
    y.push(...W([r[0], r[1], r[2], r[3] / m]));
    let _ = (S) => {
      let x = R("output", t[0].dataType, r.length, m), $ = we(x.type.tensor), T = Qe(e, x.type.value, $), I = D("x", t[0].dataType, a.length), A = D("w", t[1].dataType, u.length, m), E = [I, A];
      o && E.push(D("b", t[2].dataType, t[2].dims, m));
      let O = [{ name: "output_size", type: "u32" }, { name: "dilations", type: "u32", length: e.dilations.length }, { name: "strides", type: "u32", length: 2 }, { name: "pads", type: "u32", length: 2 }, { name: "output_channels_per_group", type: "u32" }];
      Xe(e, O);
      let w = d ? `
  ...
  ${S.mainStart()}
    ...
    let o = t.length > 2, i = fe(r[3]), a = fe(r[2]), u = k.size(r) / i / a, d = [t[0].dims[0], t[0].dims[1], t[0].dims[2], t[0].dims[3] / i], c = [t[1].dims[0], t[1].dims[1], t[1].dims[2], t[1].dims[3] / i], p = [r[0], r[1], r[2], r[3] / i], m = [{ type: 12, data: u }, { type: 6, data: [e.strides[0], e.strides[1]] }, { type: 6, data: [e.pads[0], e.pads[1]] }];
    Ye(e, m), m.push(...W(d, c, p));
    let g = (a - 1) * e.strides[1] + c[1], y = (b) => {
      let _ = R("output", t[0].dataType, p.length, i), S = we(_.type.tensor), x = Qe(e, _.type.value, S), $ = D("x", t[0].dataType, d.length, i), T = D("w", t[1].dataType, c.length, i), I = [$, T];
      o && I.push(D("b", t[2].dataType, t[2].dims, i));
  ...
  ${b.mainStart()}
    ...
    return { name: "GroupedConv-Vectorize", shaderCache: { hint: `${e.cacheKey};${i};${a};${g};${c[0]};${c[1]}`, inputDependencies: o ? ["rank", "rank", "type"] : ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: n ? n(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(u / 64) }, programUniforms: m }), getShaderSource: y };
  };
});
var sg, To, ug, Io, Co, Wd, dg, lg, Ao, Gd = V(() => {
  "use strict";
  te();
  Od();
  Ud();
  ...
  pt();
  sg = (t, e, r, n, o, i) => {
    let a = t[0], u = t.slice(i ? 1 : 2, i ? 3 : 4), d = u.length, c = e[0], m = e.slice(2).map((b, _) => b + (b - 1) * (r[_] - 1)), y = u.map((b, _) => b + n[_] + n[_ + d]).map((b, _) => Math.floor((b - m[_] + o[_]) / o[_]));
    return y.splice(0, 0, a), y.splice(i ? 3 : 1, 0, c), y;
  }, To = [2, 3, 1, 0], ug = (t, e) => {
    ...
    let n = t.pads.slice();
    Bt.adjustPadsBasedOnAutoPad(e[0].dims, t.strides, t.dilations, r, n, t.format === "NHWC", t.autoPad);
    let o = Object.assign({}, t);
    return Object.assign(o, { kernelShape: r, pads: n }), o;
  }, Co = (t) => {
    let e = on(t), r = t.format, n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][t.auto_pad], o = t.dilations, i = t.group, a = t.kernel_shape, u = t.pads, d = t.strides, c = t.w_is_const();
    return { autoPad: n, format: r, dilations: o, group: i, kernelShape: a, pads: u, strides: d, wIsConst: c, ...e, cacheKey: `${t.format};${e.activation};` };
  }, Wd = (t, e, r, n) => {
    let o = r.format === "NHWC", i = sg(e[0].dims, e[1].dims, r.dilations, r.pads, r.strides, o);
    if (r.group !== 1) {
      let E = [e[0]];
      if (o) {
        let w = t.kernelCustomData.wT ?? t.compute(Be(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = w), E.push(w);
      } else E.push(e[1]);
      e.length === 3 && E.push(e[2]), !t.adapterInfo.isArchitecture("ampere") && o && e[1].dims[0] === r.group && e[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? t.compute(Vd(E, r, i, n), { inputs: E }) : t.compute(Nd(E, r, i, n), { inputs: E });
      return;
    }
    let a = e.length === 3, u = e[0].dims[o ? 1 : 2], d = e[0].dims[o ? 2 : 3], c = e[0].dims[o ? 3 : 1], p = e[1].dims[2], m = e[1].dims[3], g = i[o ? 1 : 2], y = i[o ? 2 : 3], b = i[o ? 3 : 1], _ = o && p === u && m === d && r.pads[0] === 0 && r.pads[1] === 0;
    if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
      let E = i[0], O, w, U, N = [];
      if (o) {
        let X = t.kernelCustomData.wT ?? t.compute(Be(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        if (r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = X), _) {
          let B = u * d * c;
          O = e[0].reshape([1, E, B]), w = X.reshape([1, B, b]), U = [1, E, b];
        } else O = e[0].reshape([E, u * d, c]), w = X.reshape([1, c, b]), U = [E, g * y, b];
        N.push(O), N.push(w);
      } else O = e[0].reshape([E, c, u * d]), w = e[1].reshape([1, b, c]), U = [E, b, g * y], N.push(w), N.push(O);
      a && N.push(e[2]);
      let F = U[2], q = N[0].dims[N[0].dims.length - 1];
      F < 8 && q < 8 ? t.compute(sn(N, r, i, U, o, n), { inputs: N }) : t.compute(ur(N, r, i, U, o, n), { inputs: N });
      return;
    }
    let S = true, x = t.kernelCustomData.wT ?? t.compute(Be(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
    r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = x);
    let $ = [e[0], x];
    a && $.push(e[2]);
    let T = o ? g * y : b, I = o ? b : g * y, A = p * m * c;
    t.compute(Dd($, r, i, T, I, A, a, S, n), { inputs: $ });
  }, dg = (t, e) => {
    ...
    let o = [0, e.pads[0], 0, e.pads[1]], i = [1].concat(e.strides), a = [1].concat(e.dilations), u = [1].concat(e.kernelShape), d = Io({ ...e, pads: o, strides: i, dilations: a, kernelShape: u }, n);
    Wd(t, n, d, (c) => r ? [c[0], c[2], c[3]] : [c[0], c[1], c[3]]);
  }, lg = (t, e, r) => {
    let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = Io(r, e), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = Md(e[0].dims, e[1].dims, r.strides, r.dilations, i, false, n);
    t.compute(Rd(e, o, a.outShape, [a.filterDepth, a.filterHeight, a.filterWidth], [a.padInfo.front, a.padInfo.top, a.padInfo.left], n));
  }, Ao = (t, e) => {
    if (ug(t.inputs, e), t.inputs[0].dims.length === 3) dg(t, e);
    else if (t.inputs[0].dims.length === 5) lg(t, t.inputs, e);
    else {
      let r = Io(e, t.inputs);
      Wd(t, t.inputs, r);
    }
...
var Hd, Fd = V(() => {
  ...
  oe();
  Hd = (t, e, r) => {
    let n = t.length > 2, o = e.outputShape, i = e.format === "NHWC", a = e.group, u = t[1].dims, d = u[2] / a, c = u[3], p = i ? fe(d) : 1, m = i && c === 1 && d >= 4, g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, y = d - g, b = i ? fe(c) : 1, _ = i ? c === 1 ? p : b : 1, S = k.size(o) / b, x = [Math.ceil(S / 64), 1, 1];
    se("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${x}`);
    let $ = ["rank", "rank"], T = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], A = [e.dilations[0], e.dilations[1]], E = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], O = [E[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), E[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], w = [{ type: 12, data: S }, { type: 12, data: T }, { type: 12, data: I }, { type: 12, data: A }, { type: 12, data: E }, { type: 6, data: O }, { type: 12, data: g }, { type: 12, data: d }, { type: 12, data: c }, ...W(t[0].dims, t[1].dims)];
    n && (w.push(...W(t[2].dims)), $.push("rank")), w.push(...W(o));
    let U = (N) => {
      let F = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: T.length }, { name: "filter_dims", type: "u32", length: I.length }, { name: "dilations", type: "u32", length: I.length }, { name: "effective_filter_dims", type: "u32", length: E.length }, { name: "pads", type: "i32", length: O.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], q = we(t[0].dataType), X = i ? 1 : 2, B = i ? 2 : 3, L = i ? 3 : 1, Q = D("W", t[1].dataType, t[1].dims.length, _), Y = D("Dy", t[0].dataType, t[0].dims.length, p), Z = [Y, Q];
      n && Z.push(D("bias", t[2].dataType, [o[L]].length, b));
      let ne = R("result", t[0].dataType, o.length, b), ie = () => {
        let ve = "";
        if (m) p === 4 ? ve += `
    ...
    return { name: "ConvTranspose2D", shaderCache: { hint: `${e.cacheKey};${p}${_}${b}${m}${y}`, inputDependencies: $ }, getRunData: () => ({ dispatchGroup: { x: x[0], y: x[1], z: x[2] }, outputs: [{ dims: r ? r(o) : o, dataType: t[0].dataType }], programUniforms: w }), getShaderSource: U };
  };
});
var cg, pg, mg, qd, Kd, fg, jd, hg, Zd, Qd = V(() => {
  "use strict";
  Fd();
  St();
  pt();
  cg = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, pg = (t, e, r, n, o) => {
    let i = Math.floor(t / 2);
    e === "SAME_UPPER" ? (r[n] = i, r[o] = t - i) : e === "SAME_LOWER" && (r[n] = t - i, r[o] = i);
  }, mg = (t, e, r, n, o, i, a, u, d, c) => {
    ...
    for (let b = 0, _ = t.length - p - (u ? 1 : 0); b < p; ++b, ++_) {
      let S = t[_], x = m ? S * a[b] : c[b], $ = cg(S, a[b], i[b], e[_], r[b], x);
      pg($, n, i, b, b + p), m && c.push(a[b] * (S - 1) + d[b] + (e[_] - 1) * r[b] + 1 - i[b] - i[b + p]);
    }
    ...
    let o = t.pads.slice(), i = t.outputShape.slice(), a = t.outputPadding.slice(), u = e[0].dims, d = t.dilations.slice();
    ...
    mg(u, r, d, t.autoPad, t.group, o, c, n, a, i);
    let p = Object.assign({}, t);
    return Object.assign(p, { kernelShape: r, pads: o, outputPadding: a, outputShape: i, dilations: d, strides: c }), p;
  }, Kd = (t) => {
    let e = on(t), r = t.format, n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][typeof t.autoPad > "u" ? 0 : t.autoPad], o = t.dilations, i = t.group ?? 1, a = t.kernelShape, u = t.pads, d = t.strides, c = t.wIsConst(), p = t.outputPadding, m = t.outputShape;
    return { autoPad: n, format: r, dilations: o, group: i, kernelShape: a, outputPadding: p, outputShape: m, pads: u, strides: d, wIsConst: c, ...e, cacheKey: `${t.format};${e.activation};` };
  }, fg = (t, e) => {
    if (!t || t.length !== 2 && t.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
    ...
    let i = [e[0], o];
    e.length === 3 && i.push(e[2]), t.compute(Hd(i, r, n), { inputs: i });
  }, hg = (t, e) => {
    let r = e.format === "NHWC", n = [t.inputs[0].reshape(r ? [t.inputs[0].dims[0], 1, t.inputs[0].dims[1], t.inputs[0].dims[2]] : [t.inputs[0].dims[0], t.inputs[0].dims[1], 1, t.inputs[0].dims[2]]), t.inputs[1].reshape([t.inputs[1].dims[0], t.inputs[1].dims[1], 1, t.inputs[1].dims[2]])];
    t.inputs.length === 3 && n.push(t.inputs[2]);
    let o = e.kernelShape;
    ...
    d = [0].concat(d);
    let c = qd({ ...e, pads: u, strides: a, dilations: i, kernelShape: o, outputPadding: d }, n);
    jd(t, n, c, (p) => r ? [p[0], p[2], p[3]] : [p[0], p[1], p[3]]);
  }, Zd = (t, e) => {
    if (fg(t.inputs, e), t.inputs[0].dims.length === 3) hg(t, e);
    else {
      let r = qd(e, t.inputs);
      jd(t, t.inputs, r);
    }
...
var gg, Yd, Xd, Jd = V(() => {
  ...
  oe();
  gg = (t, e, r, n) => {
    let o = k.size(e), i = e.length, a = D("input", t, i), u = R("output", t, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = k.normalizeAxis(d, i), p = (m) => {
      let g = ` i32(${a.indicesGet("inputIndices", "uniforms.axis")}) `, y = j("uniforms.input_shape", "uniforms.axis", i), b = n.reverse ? g + (n.exclusive ? " + 1" : "") : "0", _ = n.reverse ? y : g + (n.exclusive ? "" : " + 1");
      return `
    ...
    t.compute(gg(n, r, o, e), { inputs: [0] });
  }, Xd = (t) => {
    let e = t.exclusive === 1, r = t.reverse === 1;
    return J({ exclusive: e, reverse: r });
  };
});
var bg, yg, _g, el, tl, rl = V(() => {
  "use strict";
  ee();
  te();
  Ce();
...
`);
    ...
    let r, n, o, i, a, u, d = e.format === "NHWC", c = e.blocksize, p = e.mode === "DCR";
    d ? ([r, n, o, i] = t.dims, a = p ? [r, n, o, c, c, i / c ** 2] : [r, n, o, i / c ** 2, c, c], u = p ? [0, 1, 3, 2, 4, 5] : [0, 1, 4, 2, 5, 3]) : ([r, n, o, i] = [t.dims[0], t.dims[2], t.dims[3], t.dims[1]], a = p ? [r, c, c, i / c ** 2, n, o] : [r, i / c ** 2, c, c, n, o], u = p ? [0, 3, 4, 1, 5, 2] : [0, 1, 4, 2, 5, 3]);
    let m = t.reshape(a), g = m.dims.length, y = t.dataType, b = D("a", y, g), _ = R("output", y, g), S = (x) => `
  ...
  ${x.mainStart()}
    ...
    bg(t.inputs), t.compute(_g(t.inputs[0], e));
  }, tl = (t) => J({ blocksize: t.blocksize, mode: t.mode, format: t.format });
});
var Tt, cn, Eo, ol, Rt, wg, vg, $g, il, al, sl, xg, Sg, nl, Tg, ul, dl, ll = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  oe();
  Tt = 256, cn = 512, Eo = 2 * Math.PI, ol = (t) => {
    let e = [], r = t;
    for (let n of [4, 2, 3, 5]) for (; r % n === 0; ) e.push(n), r /= n;
    return r === 1 ? e : void 0;
  }, Rt = (t) => {
    let e = t.toPrecision(9);
    return /[.eE]/.test(e) ? e : `${e}.0`;
  }, wg = (t, e, r, n, o) => {
    let i = r / t, a = cn - n, u = (c) => `smem[${a}u + base + ${c * e}u]`, d = `  for (var t = local_idx; t < ${i}u; t += ${Tt}u) {
`;
...
`;
    for (let c = 0; c < t; c++) {
      let p = `${n}u + t + ${c * i}u`;
      if (c === 0) d += `    leg[0] = smem[${p}];
`;
      else {
        let m = o * Eo * c / (t * e);
        d += `    { let a = ${Rt(m)} * angleUnit; leg[${c}] = cmul(smem[${p}], vec2<f32>(cos(a), sin(a))); }
`;
      }
    }
...
`;
      ...
      let c = o < 0 ? "vec2<f32>(oddDiff.y, -oddDiff.x)" : "vec2<f32>(-oddDiff.y, oddDiff.x)";
      d += `    let evenSum = leg[0] + leg[2]; let evenDiff = leg[0] - leg[2];
...
`, d += `    ${u(2)} = evenSum - oddSum;
    ${u(3)} = evenDiff - oddRot;
`;
    } else for (let c = 0; c < t; c++) {
      let p = ["leg[0]"];
      for (let m = 1; m < t; m++) {
        let g = o * Eo * (m * c) / t, y = Rt(Math.cos(g)), b = Rt(Math.sin(g));
        p.push(`vec2<f32>(leg[${m}].x*${y} - leg[${m}].y*${b}, leg[${m}].x*${b} + leg[${m}].y*${y})`);
      }
      d += `    ${u(c)} = ${p.join(" + ")};
`;
    }
...
`;
    ...
    let n = "", o = 1, i = 0;
    for (let a of t) n += wg(a, o, e, i, r), o *= a, i = cn - i;
    return { code: n, resultOffset: i };
  }, $g = (t, e, r, n, o) => {
    let i = t.dims, a = i.length, u = i[a - 1], d = i[e], c = r && n ? (d - 1) * 2 : d;
    o !== void 0 && (c = o);
    let p = r && n ? 1 : 2, m = n && !r ? Math.floor(c / 2) + 1 : c, g = i.slice();
    g[e] = m, g[a - 1] = p;
    let y = 1;
    for (let _ = e + 1; _ < a - 1; _++) y *= i[_];
    let b = k.size(i) / u / d;
    return { dataType: t.dataType, outputDims: g, length: c, signalLength: d, inner: y, batch: b, inputComponents: u, outputComponents: p, outputLength: m, inverse: r, onesided: n };
  }, il = (t, e) => [e, t.length, t.inputComponents, t.outputComponents, t.inverse, t.onesided].join(";"), al = (t) => [{ type: 12, data: t.batch }, { type: 12, data: t.signalLength }, { type: 12, data: t.inner }, { type: 12, data: t.outputLength }], sl = (t, e, r) => t.registerUniform("batch", "u32").registerUniform("signalLength", "u32").registerUniform("inner", "u32").registerUniform("outputLength", "u32").declareVariables(e, r), xg = (t) => {
    let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = ol(r), m = (g) => {
      let y = D("x", e, [1]), b = R("y", e, [1]), _ = (A) => {
        let E = `inBase + (${A}) * uniforms.inner * ${n}u`, O = `f32(${y.getByOffset(E)})`, w = n === 2 ? `f32(${y.getByOffset(`${E} + 1u`)})` : "0.0";
        return `vec2<f32>(${O}, ${w})`;
      }, S;
      if (i && a) {
        let A = Math.floor(r / 2) + 1, E = r % 2 === 0 ? `select(provided, provided - 1u, provided == ${A}u)` : "provided";
        S = `
    ...
    workgroupBarrier();`;
      let { code: x, resultOffset: $ } = vg(p, r, d), T = c === 1 ? `smem[${$}u + i]` : `smem[${$}u + i] * ${Rt(c)}`, I = o === 2 ? b.setByOffset("off + 1u", `${u}(v.y)`) : "";
      return `
  ${sl(g, y, b)}
...
${x}    for (var i = local_idx; i < uniforms.outputLength; i += ${Tt}u) {
    ...
    return { name: "DFT", shaderCache: { hint: il(t, "fft"), inputDependencies: ["type"] }, getShaderSource: m, getRunData: () => ({ outputs: [{ dims: t.outputDims, dataType: e }], programUniforms: al(t), dispatchGroup: { x: t.batch } }) };
  }, Sg = (t) => {
    let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = (m) => {
      let g = D("x", e, [1]), y = R("y", e, [1]), b = (T) => {
        let I = `inBase + (${T}) * uniforms.inner * ${n}u`, A = `f32(${g.getByOffset(I)})`, E = n === 2 ? `f32(${g.getByOffset(`${I} + 1u`)})` : "0.0";
        return `vec2<f32>(${A}, ${E})`;
      }, _ = i && a ? `fn spectrum(inBase: u32, k: u32) -> vec2<f32> {
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      knMod += k;
      if (knMod >= ${r}u) { knMod -= ${r}u; }`, x = o === 2 ? y.setByOffset("off + 1u", `${u}(v.y)`) : "", $ = c === 1 ? "acc" : `acc * ${Rt(c)}`;
      return `
  ${sl(m, g, y)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
    return vec2<f32>(a.x * b.x - a.y * b.y, a.x * b.y + a.y * b.x);
  ...
  ${m.mainStart(Tt)}
    ...
    return { name: "DFT", shaderCache: { hint: il(t, "direct"), inputDependencies: ["type"] }, getShaderSource: p, getRunData: () => ({ outputs: [{ dims: t.outputDims, dataType: e }], programUniforms: al(t), dispatchGroup: { x: t.batch } }) };
  }, nl = (t) => {
    if (!t || t.dataType === 0) return;
    if (k.size(t.dims) !== 1) throw new Error("DFT optional scalar inputs must have exactly 1 element.");
    if (t.dataType === 6) return t.getInt32Array()[0];
    let e = Number(t.getBigInt64Array()[0]);
    if (!Number.isSafeInteger(e)) throw new Error("DFT optional scalar inputs are out of JavaScript safe integer range.");
    return e;
  }, Tg = (t) => {
    if (!t || t.length < 1) throw new Error("DFT requires at least 1 input.");
    let e = t[0].dims;
    if (e.length < 2) throw new Error("DFT input must have at least 2 dimensions.");
    let r = e[e.length - 1];
    if (r !== 1 && r !== 2) throw new Error("DFT input's innermost dimension must be 1 (real) or 2 (complex).");
  }, ul = (t, e) => {
    Tg(t.inputs);
    let r = t.inputs[0], n = r.dims.length, o = e.inverse !== 0, i = e.onesided !== 0, a = nl(t.inputs[1]);
    if (a !== void 0 && a <= 0) throw new Error("dft_length must be greater than zero.");
    let u = k.normalizeAxis(nl(t.inputs[2]) ?? e.axis, n);
    if (u === n - 1) throw new Error("DFT axis must refer to a signal dimension, not the innermost (real/imaginary) dimension.");
    if (o && i && r.dims[n - 1] !== 2) throw new Error("Inverse one-sided DFT (IRFFT) requires complex-valued input (innermost dimension 2).");
    let d = $g(r, u, o, i, a);
    if (d.length <= 0) throw new Error(`Invalid DFT length: ${d.length}`);
    let p = d.length <= cn && ol(d.length) !== void 0 ? xg(d) : Sg(d);
    t.compute(p, { inputs: [0] });
  }, dl = (t) => J({ axis: t.axis ?? 1, inverse: t.inverse ?? 0, onesided: t.onesided ?? 0 });
});
var ko, pn, cl, Ig, Cg, Po, Do, pl, Ag, ml, fl, hl = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  oe();
  ko = "[a-zA-Z]|\\.\\.\\.", pn = "(" + ko + ")+", cl = "^" + pn + "$", Ig = "(" + pn + ",)*" + pn, Cg = "^" + Ig + "$", Po = class {
    constructor(e = -1) {
    ...
    constructor(e, r) {
      ...
      if (!n.match(RegExp(Cg))) throw new Error("Invalid LHS term");
      if (n.split(",").forEach((u, d) => {
        let c = e[d].dims.slice();
        if (!u.match(RegExp(cl))) throw new Error("Invalid LHS term");
        let p = this.processTerm(u, true, c, d);
        this.lhs.push(p);
      }), o === "") o += [...this.symbolToInfo.entries()].filter(([u, d]) => d.count === 1 || u === "...").map(([u]) => u).join("");
      else if (!o.match(RegExp(pn))) throw new Error("Invalid RHS");
      o.match(RegExp(ko, "g"))?.forEach((u) => {
    ...
    processTerm(e, r, n, o = -1) {
      ...
      if (!e.match(RegExp(cl)) && !r && e !== "") throw new Error("Invalid LHS term");
      let c = e.match(RegExp(ko, "g")), p = new Po(o);
  ...
  }, pl = (t) => t + "_max", Ag = (t, e, r, n) => {
    let i = t.map((p) => p.length).map((p, m) => D(`input${m}`, e, p)), a = k.size(n), u = R("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
      ...
      r.symbolToInfo.forEach((A, E) => {
        if (r.rhs.symbolToIndices.has(E)) {
          let O = r.rhs.symbolToIndices.get(E)?.[0];
          O !== void 0 && r.lhs.forEach((w, U) => {
            if (A.inputIndices.includes(U)) {
              let N = w.symbolToIndices.get(E);
              if (N === void 0) throw new Error("Invalid symbol error");
              N.forEach((F) => {
                m.push(`${i[U].indicesSet(`input${U}Indices`, F, u.indicesGet("outputIndices", O))}`);
              });
            }
          });
        } else r.lhs.forEach((O, w) => {
          if (A.inputIndices.includes(w)) {
            let U = O.symbolToIndices.get(E);
            if (U === void 0) throw new Error("Invalid symbol error");
            U.forEach((N) => {
              _.push(`${i[w].indicesSet(`input${w}Indices`, N, `${E}`)}`);
            }), $.push(`prod *= ${i[w].getByIndices(`input${w}Indices`)};`);
          }
        }), S.push(`for(var ${E}: u32 = 0; ${E} < uniforms.${pl(E)}; ${E}++) {`), x.push("}");
      });
...
`)};
    ...
    return { name: "Einsum", shaderCache: { hint: r.equation, inputDependencies: t.map(() => "rank") }, getRunData: () => {
      ...
      return m.push(...W(n)), { outputs: [{ dims: n, dataType: e }], dispatchGroup: { x: Math.ceil(a / 64) }, programUniforms: m };
    }, getShaderSource: c };
  }, ml = (t, e) => {
    let r = new Do(t.inputs, e.equation), n = r.outputDims, o = t.inputs.map((i, a) => i.dims);
...
var Eg, gl, kg, Pg, bl, yl = V(() => {
  ...
  Eg = (t) => {
    ...
    return n;
  }, kg = (t, e) => t.length > e.length ? gl(t, e) : gl(e, t), Pg = (t) => {
    let e = t[0].dims, r = Array.from(t[1].getBigInt64Array(), Number), n = kg(e, r), o = t[0].dataType, i = o === 9 || k.size(e) === 1, a = o === 9 || e.length > 0 && e[e.length - 1] % 4 === 0 ? 4 : 1, u = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, d = Math.ceil(k.size(n) / u), c = (m) => {
      let g = D("input", o, e.length, a), y = R("output", o, n.length, u), b;
      if (o === 9) {
        let _ = (S, x, $ = "") => `
    ...
    return { name: "Expand", shaderCache: { hint: `${n.length};${a}${u}`, inputDependencies: ["rank"] }, getShaderSource: c, getRunData: () => ({ outputs: [{ dims: n, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(d / 64) }, programUniforms: p }) };
  }, bl = (t) => {
    Eg(t.inputs), t.compute(Pg(t.inputs), { inputs: [0] });
  };
});
var Dg, _l, wl = V(() => {
  "use strict";
  ...
  nn();
  Dg = (t) => {
    let e = t[0].dataType, r = k.size(t[0].dims), n = k.size(t[1].dims), o = n % 4 === 0, i = (a) => {
      let u = D("x", e, [1], 4), d = D("bias", e, [1], 4), c = R("y", e, [1], 4), p = [{ name: "output_vec_size", type: "u32" }, { name: "bias_size", type: "u32" }], m = (y) => `
    ...
    return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (a) => ({ outputs: [{ dims: a[0].dims, dataType: a[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(r / 4) }, { type: 12, data: n }], dispatchGroup: { x: Math.ceil(r / zt / 4) } }) };
  }, _l = (t) => {
    t.inputs.length < 2 || k.size(t.inputs[1].dims) === 0 ? sd(t) : t.compute(Dg(t.inputs));
  };
});
var Og, Bg, vl, $l, xl = V(() => {
  "use strict";
  ...
  Og = (t) => {
    ...
    let r = t[0].dims, n = t[1].dims, o = r.length, i = k.normalizeAxis(e.axis, o), a = r.slice(0);
    a.splice(i, 1, ...n);
    let u = r[i], d = t[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(a) / d), p = [{ type: 12, data: c }, { type: 6, data: u }, { type: 12, data: i }, ...W(t[0].dims, t[1].dims, a)], m = (g) => {
      let y = D("data", t[0].dataType, t[0].dims.length, d), b = D("inputIndices", t[1].dataType, t[1].dims.length), _ = R("output", t[0].dataType, a.length, d), S = ($) => {
        let T = n.length, I = `var indicesIndices${$}  = ${b.type.indices}(0);`;
        for (let A = 0; A < T; A++) I += `${T > 1 ? `indicesIndices${$}[${A}]` : `indicesIndices${$}`} = ${a.length > 1 ? `outputIndices${$}[uniforms.axis + ${A}]` : `outputIndices${$}`};`;
        I += `
        ...
        `;
        for (let A = 0, E = 0; A < o; A++) A === i ? (I += `${o > 1 ? `dataIndices${$}[${A}]` : `dataIndices${$}`} = u32(idx${$});`, E += T) : (I += `${o > 1 ? `dataIndices${$}[${A}]` : `dataIndices${$}`} = ${a.length > 1 ? `outputIndices${$}[${E}]` : `outputIndices${$}`};`, E++);
        return I;
      }, x;
      if (t[0].dataType === 9) {
        let $ = (T, I, A = "") => `
    ...
    return { name: "Gather", shaderCache: { hint: e.cacheKey, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: a, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(c / 64) }, programUniforms: p }), getShaderSource: m };
  }, vl = (t) => J({ axis: t.axis }), $l = (t, e) => {
    let r = t.inputs;
    Og(r), t.compute(Bg(t.inputs, e));
  };
});
var zg, Sl, Tl, Il = V(() => {
  "use strict";
  ...
  ${g.mainStart()}
    ...
    let r = t.inputs, n = r[0].dims, o = r[0].dataType, i = r[1].dims, a = i[i.length - 1], u = k.sizeToDimension(i, i.length - 1), d = k.sizeFromDimension(n, e.batchDims + a), c = k.sizeToDimension(n, e.batchDims), p = k.sizeFromDimension(n, e.batchDims), m = u / c, g = new Array(a), y = d;
    for (let I = 0; I < a; ++I) g[a - 1 - I] = y, y *= n[e.batchDims + a - 1 - I];
    let b = zg(t, r[1], g, e.batchDims, n, u, m, p, a), _ = e.batchDims + a;
    ...
    let S = i.slice(0, -1).concat(n.slice(_)), x = k.size(S), $ = [{ type: 12, data: x }, { type: 12, data: d }, ...W(r[0].dims, b.dims, S)], T = (I) => {
      let A = D("data", r[0].dataType, r[0].dims.length), E = D("slice_offsets", 12, b.dims.length), O = R("output", r[0].dataType, S.length);
      return `
  ...
  }, Tl = (t) => ({ batchDims: t.batch_dims, cacheKey: "" });
});
var Mg, Rg, Cl, Al, El = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Mg = (t, e) => {
    ...
    let r = k.normalizeAxis(e.quantizeAxis, t[0].dims.length), n = e.blockSize, o = t[0], i = t[2], a = t.length === 4 ? t[3] : void 0;
    ...
    let r = t[0].dims, n = t[1].dims, o = r.length, i = k.normalizeAxis(e.gatherAxis, o), a = k.normalizeAxis(e.quantizeAxis, o), u = r.slice(0);
    u.splice(i, 1, ...n);
    let d = k.size(u), c = t[2].dataType, m = t[0].dataType === 22, g = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }, { type: 12, data: e.blockSize }, ...W(...t.map((b, _) => b.dims), u)], y = (b) => {
      let _ = D("data", t[0].dataType, t[0].dims.length), S = D("inputIndices", t[1].dataType, t[1].dims.length), x = D("scales", t[2].dataType, t[2].dims.length), $ = t.length > 3 ? D("zeroPoint", t[3].dataType, t[3].dims.length) : void 0, T = R("output", c, u.length), I = [_, S, x];
      $ && I.push($);
    ...
    let r = t.inputs;
    Mg(r, e), t.compute(Rg(t.inputs, e));
  }, Al = (t) => J({ blockSize: t.blockSize, gatherAxis: t.gatherAxis, quantizeAxis: t.quantizeAxis });
});
var Ug, Ng, kl, Pl, Dl = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Ug = (t) => {
    ...
    let r = t[0].dims, n = t[0].dataType, o = r.length, i = t[1].dims, a = t[1].dataType, u = k.normalizeAxis(e.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = D("input", n, o), g = D("indicesInput", a, i.length), y = R("output", n, c.length), b = [{ type: 12, data: p }, { type: 6, data: d }, { type: 12, data: u }];
  ...
  }, kl = (t) => J({ axis: t.axis }), Pl = (t, e) => {
    let r = t.inputs;
    Ug(r), t.compute(Ng(t.inputs, e));
  };
});
var Vg, Lg, Ol, Bl, zl = V(() => {
  "use strict";
  ee();
  te();
  oe();
  Vg = (t) => {
    ...
    let r = t[0].dims.slice(), n = t[1].dims.slice(), [o, i, a] = Hr.getShapeOfGemmResult(r, e.transA, n, e.transB, t.length === 3 ? t[2].dims : void 0), u = [o, i];
    if (!u) throw new Error("Can't use gemm on the given tensors");
    let d = 16, c = Math.ceil(i / d), p = Math.ceil(o / d), m = true, g = k.size(u), y = [{ type: 12, data: m ? c : g }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: a }, { type: 1, data: e.alpha }, { type: 1, data: e.beta }], b = ["type", "type"];
    ...
    let _ = (x) => {
      ...
      let T = e.alpha === 1 ? "" : "value *= uniforms.alpha;", I = D("a", t[0].dataType, t[0].dims), A = D("b", t[1].dataType, t[1].dims), E = I.type.value, O = null, w = [I, A];
      t.length === 3 && (O = D("c", t[2].dataType, t[2].dims.length), w.push(O));
      let U = R("output", t[0].dataType, u.length);
      w.push(U);
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
      ...
      let $ = D("a", t[0].dataType, t[0].dims), T = D("b", t[1].dataType, t[1].dims), I = null, A = [$, T];
      t.length === 3 && (I = D("c", t[2].dataType, t[2].dims.length), A.push(I));
      let E = R("output", t[0].dataType, u.length);
      A.push(E);
      let O = [{ name: "num_tile_n", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }], w = "", U = "";
      e.transA && e.transB ? (U = `
      ...
      `, w = "value += tile_a[local_id.y][k] * tile_b[k][local_id.x];");
  ...
  ${x.mainStart([d, d, 1])}
    ...
    Vg(t.inputs), t.compute(Lg(t.inputs, e));
  };
});
var mt, It, qt, Kt, Wg, Gg, Hg, Fg, qg, Kg, jg, Zg, Ml, Rl, Ul = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  oe();
  [mt, It, qt, Kt] = [0, 1, 2, 3], Wg = (t) => {
...
`, jg = (t, e, r) => (() => {
  ...
  })() + `${t.setByOffset("global_idx", "result")}`, Zg = (t, e) => {
    let r = D("x", t[0].dataType, t[0].dims.length), n = [t[1].dims[0], t[1].dims[1], t[1].dims[2]], o = D("grid", t[1].dataType, n.length, 2), i = [t[0].dims[0], t[0].dims[1], t[1].dims[1], t[1].dims[2]];
    e.format === "NHWC" && (i = [t[0].dims[0], t[1].dims[1], t[1].dims[2], t[0].dims[3]], [mt, It, qt, Kt] = [0, 3, 1, 2]);
    let a = R("output", t[0].dataType, i.length), u = r.type.value, d = k.size(i), c = [{ type: 12, data: d }, ...W(t[0].dims, n, i)], p = (m) => `
  ...
  ${m.mainStart()}
    ...
    Wg(t.inputs), t.compute(Zg(t.inputs, e));
  }, Rl = (t) => J({ alignCorners: t.align_corners, mode: t.mode, paddingMode: t.padding_mode, format: t.format });
});
var Ue, Xg, Vl, Nl, Jg, dr, Ll, Oo = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  oe();
  pt();
  Ue = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, Xg = (t, e) => {
    let r = t[0], n = Ue(t, 1), o = Ue(t, 2), i = Ue(t, 3), a = Ue(t, 4), u = Ue(t, 5), d = Ue(t, 6), c = Ue(t, 7);
    ...
    if (a && k.size(a.dims) > 0) {
      T = 8;
      let O = a.dims;
      throw O.length === 1 ? O[0] === p ? T = 1 : O[0] === 3 * p + 2 && (T = 3) : O.length === 2 && O[0] === p && O[1] === $ && (T = 5), T === 8 ? new Error('Input "key_padding_mask" shape shall be (batch_size) or (batch_size, total_sequence_length)') : new Error("Mask not supported");
    }
    let I = false, A = g;
  ...
  }, Vl = (t) => J({ ...t }), Nl = J({ perm: [0, 2, 1, 3] }), Jg = (t, e, r, n, o, i, a) => {
    let u = [n, o, i], d = k.size(u), c = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }], p = (m) => {
      let g = R("qkv_with_bias", e.dataType, u), y = D("qkv", e.dataType, u), b = D("bias", r.dataType, u), _ = [{ name: "output_size", type: "u32" }, { name: "bias_offset", type: "u32" }, { name: "hidden_size", type: "u32" }];
      return `
  ...
  ${m.mainStart()}
    ...
    if (a && k.size(a.dims) > 0) {
      ...
      return d = Jg(t, i, a, e, n, r * o, u), d = d.reshape([e, n, r, o]), r === 1 || n === 1 ? d : t.compute(Be(d, Nl.perm), { inputs: [d], outputs: [-1] })[0];
    } else return i.dims.length === 3 && (d = i.reshape([e, n, r, o])), r === 1 || n === 1 ? d : t.compute(Be(d, Nl.perm), { inputs: [d], outputs: [-1] })[0];
  }, Ll = (t, e) => {
    let r = Xg(t.inputs, e), n = t.inputs[0], o = Ue(t.inputs, 1), i = Ue(t.inputs, 2), a = Ue(t.inputs, 3), u = Ue(t.inputs, 4), d = Ue(t.inputs, 5), c = Ue(t.inputs, 6), p = Ue(t.inputs, 7);
    ...
    let m = o && i && o.dims.length === 4 && i.dims.length === 4, g = dr(t, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, a, 0);
    if (m) return Ft(t, g, o, i, u, void 0, c, p, d, r);
    if (!o || !i) throw new Error("key and value must be provided");
    let y = dr(t, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, a, r.hiddenSize), b = dr(t, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, a, 2 * r.hiddenSize);
    Ft(t, g, y, b, u, void 0, c, p, d, r);
  };
});
var eb, tb, rb, nb, Bo, Wl, Gl, zo = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  eb = (t) => {
    ...
    return t[1].dims[0] > 0 && (t[1].getBigInt64Array().forEach((o) => r.push(Number(o))), n = r.length), J({ numOutputs: n, axis: e.axis, splitSizes: r });
  }, rb = (t) => `
...
`)}
    ...
    let r = t[0].dims, n = k.size(r), o = t[0].dataType, i = k.normalizeAxis(e.axis, r.length), a = new Array(e.numOutputs), u = D("input", o, r.length), d = new Array(e.numOutputs), c = [], p = [], m = 0, g = [{ type: 12, data: n }];
    for (let b = 0; b < e.numOutputs; b++) {
      m += e.splitSizes[b], d[b] = m;
      let _ = r.slice();
      _[i] = e.splitSizes[b], p.push(_), a[b] = R(`output${b}`, o, _.length), c.push({ dims: p[b], dataType: t[0].dataType });
    }
  ...
  ${b.mainStart()}
    ...
    eb(t.inputs);
    let r = t.inputs.length === 1 ? e : tb(t.inputs, e);
    t.compute(Bo(t.inputs, r), { inputs: [0] });
  }, Gl = (t) => {
    ...
    return J({ axis: e, numOutputs: n, splitSizes: r });
  };
});
var ob, mn, Hl, Mo = V(() => {
  "use strict";
  ...
  oe();
  ob = (t, e) => {
    let [r, n, o, i] = t, { numHeads: a, rotaryEmbeddingDim: u } = e;
    ...
    let d = r.dims[0], c = r.dims[r.dims.length - 2], p = o.dims[0], m = k.sizeFromDimension(r.dims, 1) / c, g = u === 0 ? o.dims[1] * 2 : m / a;
    ...
    let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, a = t[0].dims[0], u = k.sizeFromDimension(t[0].dims, 1), d = t[0].dims[t[0].dims.length - 2], c = u / d, p = t[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(a, d, c / m, m - p), y = k.computeStrides(g), b = [{ type: 1, data: i }, { type: 12, data: g }, { type: 12, data: y }, ...t[0].dims.length === 3 ? new Array({ type: 12, data: [u, c, m, 1] }) : [], ...t[0].dims.length === 4 ? new Array({ type: 12, data: [u, m, d * m, 1] }) : [], ...W(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims)], _ = (S) => {
      let x = D("input", t[0].dataType, t[0].dims.length), $ = D("position_ids", t[1].dataType, t[1].dims.length), T = D("cos_cache", t[2].dataType, t[2].dims.length), I = D("sin_cache", t[3].dataType, t[3].dims.length), A = R("output", t[0].dataType, t[0].dims.length);
    ...
    return { name: "RotaryEmbedding", shaderCache: { hint: J({ interleaved: r }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: _, getRunData: () => ({ outputs: [{ dims: t[0].dims, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(k.size(g) / zt) }, programUniforms: b }) };
  }, Hl = (t, e) => {
    ob(t.inputs, e), t.compute(mn(t.inputs, e));
  };
});
var ib, ab, Fl, sb, ql, Kl = V(() => {
  "use strict";
  Ce();
  ee();
  tn();
  ...
  ib = (t, e) => {
    ...
    let r = t[0], n = t[1], o = t[2], i = t[3], a = t[4];
    ...
    if (E) {
      if (E.dims.length === 0) throw new Error("seqlens_k must be at least 1D, got scalar.");
      let N = E.dims.reduce((F, q) => F * q, 1);
      if (N !== d) throw new Error(`seqlens_k must have batch_size (${d}) elements, got ${N}.`);
      for (let F = 0; F < E.dims.length; F++) if (E.dims[F] !== 1 && E.dims[F] !== d) throw new Error(`seqlens_k has unexpected shape. Each dimension must be 1 or batch_size (${d}), got dims[${F}] = ${E.dims[F]}.`);
    }
  ...
  }, ab = J({ perm: [0, 2, 1, 3] }), Fl = (t, e, r) => {
    let n = e, o = r.kvNumHeads;
    return e.dims.length === 3 && r.kvSequenceLength !== 0 && (n = e.reshape([r.batchSize, r.kvSequenceLength, o, r.headSize]), n = t.compute(Be(n, ab.perm), { inputs: [n], outputs: [-1] })[0]), n;
  }, sb = (t, e, r, n) => {
    let o = 7, i = ["type", "type"], a = [t * e], u = t * e, d = [{ type: 12, data: u }, { type: 12, data: e }, { type: 12, data: t }], c = (p) => {
      let m = D("seq_lens", r.dataType, r.dims), g = D("total_seq_lens", n.dataType, n.dims), y = R("pos_ids", o, a), b = [{ name: "output_size", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "batch_size", type: "u32" }];
      return `
  ...
  `;
    ...
    return { name: "GeneratePositionIds", shaderCache: { hint: `${t};${e}`, inputDependencies: i }, getRunData: () => ({ outputs: [{ dims: a, dataType: o }], dispatchGroup: { x: Math.ceil(u / 64) }, programUniforms: d }), getShaderSource: c };
  }, ql = (t, e) => {
    if (t.inputs.length > 14 && t.inputs[14] || t.inputs.length > 15 && t.inputs[15]) throw new Error("GroupQueryAttention (JSEP): q_norm_weight / k_norm_weight inputs are not supported. The per-head Q/K RMS normalization prologue is implemented only on the CUDA and native WebGPU EPs.");
    let r = ib(t.inputs, e);
    ...
    let n = t.inputs[0], o = t.inputs[1] && t.inputs[1].dims.length > 0 ? t.inputs[1] : void 0, i = t.inputs[2] && t.inputs[2].dims.length > 0 ? t.inputs[2] : void 0, a = t.inputs[3] && t.inputs[3].dims.length !== 0 ? t.inputs[3] : void 0, u = t.inputs[4] && t.inputs[4].dims.length !== 0 ? t.inputs[4] : void 0, d = t.inputs.length > 4 ? t.inputs[5] : void 0, c = t.inputs.length > 5 ? t.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = J({ axis: 2, numOutputs: 3, splitSizes: [r.numHeads * r.headSize, p * r.headSize, p * r.headSize] }), [g, y, b] = !o && !i ? t.compute(Bo([n], m), { inputs: [n], outputs: [-1, -1, -1] }) : [n, o, i], _, S;
    if (e.doRotary) {
      let I = t.compute(sb(r.batchSize, r.sequenceLength, d, c), { inputs: [d, c], outputs: [-1] })[0], A = t.inputs[7], E = t.inputs[8], O = J({ interleaved: e.rotaryInterleaved !== 0, numHeads: r.numHeads, rotaryEmbeddingDim: 0, scale: e.scale }), w = [g, I, A, E], U = [-1];
      _ = t.compute(mn(w, O), { inputs: w, outputs: U })[0], w.splice(0, 1, y);
      let N = J({ interleaved: e.rotaryInterleaved !== 0, numHeads: r.kvNumHeads, rotaryEmbeddingDim: 0, scale: e.scale });
      S = t.compute(mn(w, N), { inputs: w, outputs: U })[0];
    }
    let x = dr(t, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, e.doRotary ? _ : g, void 0, 0), $ = Fl(t, e.doRotary ? S : y, r), T = Fl(t, b, r);
    Ft(t, x, $, T, void 0, void 0, a, u, void 0, r, d, c);
  };
});
var jl, ub, db, Zl, Ql = V(() => {
  "use strict";
  ee();
  te();
  pt();
  oe();
  jl = (t, e, r, n, o, i, a, u) => {
    let d = fe(i), c = d === 1 ? "f32" : `vec${d}f`, p = d === 1 ? "vec2f" : `mat2x${d}f`, m = o * a, g = 64;
    m === 1 && (g = 256);
    let y = [o, a, i / d], b = [o, a, 2], _ = ["rank", "type", "type"], S = [];
    S.push(...W(y, b));
    let x = ($) => {
      let T = D("x", e.dataType, 3, d), I = D("scale", r.dataType, r.dims), A = D("bias", n.dataType, n.dims), E = R("output", 1, 3, 2), O = [T, I, A, E];
      return `
  ...
  ${$.mainStart(g)}
    ...
    let n = e[0].dims, o = n, i = 2, a = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = jl(t, e[0], e[1], e[2], a, d, u, r.epsilon), g = [a, u, d / c], y = [a, u], b = ["type", "none"], _ = (S) => {
      let x = D("x", e[0].dataType, g.length, c), $ = D("scale_shift", 1, y.length, 2), T = R("output", e[0].dataType, g.length, c), I = [x, $, T];
      return `
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    ...
    let n = e[0].dims, o = n, i = n[0], a = n[n.length - 1], u = k.sizeFromDimension(n, 1) / a, d = fe(a), c = k.size(o) / d, p = [{ type: 12, data: u }, { type: 12, data: Math.floor(a / d) }], m = ["type", "type"], g = false, y = [0, n.length - 1];
    for (let x = 0; x < n.length - 2; x++) g = g || n[x + 1] !== 1, y.push(x + 1);
    g = g && n[n.length - 1] !== 1;
    let b = g ? t.compute(Be(t.inputs[0], y), { inputs: [t.inputs[0]], outputs: [-1] })[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[y[$]])), _ = jl(t, b, e[1], e[2], i, u, a, r.epsilon), S = (x) => {
      let $ = we(e[0].dataType), T = d === 1 ? "vec2f" : `mat${d}x2f`, I = (O) => {
        let w = O === 0 ? "x" : "y", U = d === 1 ? "f32" : `vec${d}f`;
        switch (d) {
          case 1:
            return `${$}(${U}(scale.${w}))`;
          case 2:
            return `vec2<${$}>(${U}(scale[0].${w}, scale[1].${w}))`;
          case 4:
            return `vec4<${$}>(${U}(scale[0].${w}, scale[1].${w}, scale[2].${w}, scale[3].${w}))`;
          default:
            throw new Error(`Not supported compoents ${d}`);
        }
      }, A = D("input", e[0].dataType, e[0].dims, d), E = R("output", e[0].dataType, o, d);
      return `
  ...
  ${x.mainStart()}
    ...
    e.format === "NHWC" ? db(t, t.inputs, e) : ub(t, t.inputs, e);
  };
});
var lb, cb, Yl, Xl = V(() => {
  "use strict";
  ...
  lb = (t) => {
    ...
    let n = e.simplified, o = t[0].dims, i = t[1], a = !n && t[2], u = o, d = k.normalizeAxis(e.axis, o.length), c = k.sizeToDimension(o, d), p = k.sizeFromDimension(o, d), m = k.size(i.dims), g = a ? k.size(a.dims) : 0;
    if (m !== p || a && g !== p) throw new Error(`Size of X.shape()[axis:] == ${p}.
    ...
    a && _.push("type");
    let x = r > 1, $ = r > 2, T = (A) => {
      let E = we(t[0].dataType), O = [D("x", t[0].dataType, t[0].dims, b), D("scale", i.dataType, i.dims, b)];
      a && O.push(D("bias", a.dataType, a.dims, b)), O.push(R("output", t[0].dataType, u, b)), x && O.push(R("mean_data_output", 1, y)), $ && O.push(R("inv_std_output", 1, y));
      let w = [{ name: "norm_count", type: "u32" }, { name: "norm_size", type: "f32" }, { name: "norm_size_vectorized", type: "u32" }, { name: "epsilon", type: "f32" }];
      return `
  ...
  ${A.mainStart()}
    ...
    lb(t.inputs), t.compute(cb(t.inputs, e, t.outputCount));
  };
});
var pb, Jl, ec = V(() => {
  "use strict";
  ...
  pb = (t) => {
    ...
    if (r < 8 && n < 8) t.compute(sn(t.inputs, { activation: "" }, e));
    else {
      let o = e[e.length - 2], i = k.size(t.inputs[0].dims.slice(0, -2)), a = k.size(t.inputs[1].dims.slice(0, -2));
      if (i !== 1 && o === 1 && a === 1) {
        let u = t.inputs[0].reshape([1, i, n]), d = t.inputs[1].reshape([1, n, r]), c = [1, i, r], p = [u, d];
        t.compute(ur(p, { activation: "" }, e, c), { inputs: p });
      } else t.compute(ur(t.inputs, { activation: "" }, e));
    }
  };
});
var mb, fb, hb, tc, rc, nc = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  mb = (t, e) => {
    ...
    let o = Math.floor((e.k + e.blockSize - 1) / e.blockSize), i = e.blockSize / 8 * e.bits, a = t[1];
    if (!k.areEqual(a.dims, [e.n, o, i])) throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");
    let d = t[2].dims;
    ...
    let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = fe(a), _ = u.concat([o, a]), S = o > 1 && a / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / S, $ = 64, T = [], I = [d, o, i / g], A = k.convertShape(t[1].dims).slice();
    A.splice(-1, 1, p / y), T.push(...W(I)), T.push(...W(A)), T.push(...W(t[2].dims)), t.length === 4 && T.push(...W(k.convertShape(t[3].dims)));
    let E = [d, o, a / b];
    T.push(...W(E));
    let O = (w) => {
      let U = I.length, N = D("a", t[0].dataType, U, g), F = D("b", 12, A.length, y), q = D("scales", t[2].dataType, t[2].dims.length), X = [N, F, q], B = t.length === 4 ? D("zero_points", 12, t[3].dims.length) : void 0;
      B && X.push(B);
      let L = E.length, Q = R("output", t[0].dataType, L, b), Y = we(t[0].dataType), Z = (() => {
        switch (g) {
          case 1:
            return `array<${Y}, 8>`;
          case 2:
      ...
      })(), ne = Math.floor(32 / e.bits), ie = Math.floor(ne / 8), ce = () => {
        let M = "";
        for (let G = 0; G < ie; G++) {
          let be = G * e.bits * 4, ke = be + e.bits;
          M += `
          // reuse a data (pass ${G})
    ...
    return { name: "MatMulNBits", shaderCache: { hint: `${e.blockSize};${e.bits};${g};${y};${b};${S};${$}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: _, dataType: m }], dispatchGroup: { x }, programUniforms: T }), getShaderSource: O };
  }, hb = (t, e) => {
    let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([o, a]), _ = 128, S = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, x = _ / S, $ = Math.floor(32 / e.bits), T = x * y * $, I = T / g, A = T / e.blockSize, E = k.size(b) / S, O = [], w = [d, o, i / g], U = k.convertShape(t[1].dims).slice();
    U.splice(-1, 1, p / y), O.push(...W(w)), O.push(...W(U)), O.push(...W(t[2].dims)), t.length === 4 && O.push(...W(k.convertShape(t[3].dims)));
    let N = [d, o, a];
    O.push(...W(N));
    let F = (q) => {
      let X = w.length, B = D("a", t[0].dataType, X, g), L = D("b", 12, U.length, y), Q = D("scales", t[2].dataType, t[2].dims.length), Y = [B, L, Q], Z = t.length === 4 ? D("zero_points", 12, t[3].dims.length) : void 0;
      Z && Y.push(Z);
      let ne = N.length, ie = R("output", t[0].dataType, ne), ce = we(t[0].dataType), Me = () => {
        switch (g) {
          case 1:
            return `
    ...
    return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${e.blockSize};${g};${y};${x};${S}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: b, dataType: m }], dispatchGroup: { x: E }, programUniforms: O }), getShaderSource: F };
  }, tc = (t, e) => {
    mb(t.inputs, e), e.blockSize === 32 && t.adapterInfo.isVendor("intel") && t.adapterInfo.isArchitecture("gen-12lp") ? t.compute(hb(t.inputs, e)) : t.compute(fb(t.inputs, e));
  }, rc = (t) => J(t);
});
var gb, bb, yb, _b, wb, vb, $b, xb, oc, ic = V(() => {
  "use strict";
  ee();
  te();
  oe();
  gb = (t) => {
    ...
    switch (r.mode) {
      case 0:
        return bb(t, e, r.pads.length);
      case 1:
        return yb(t, e, r.pads.length);
      case 2:
        return _b(t, e, r.pads.length);
      case 3:
        return wb(t, e, r.pads.length);
      default:
        throw new Error("Invalid mode");
    }
  }, $b = (t, e) => {
    let r = k.padShape(t[0].dims.slice(), e.pads), n = t[0].dims, o = k.size(r), i = [{ type: 12, data: o }, { type: 6, data: e.pads }], a = t.length >= 3 && t[2].data;
    e.mode === 0 && i.push({ type: a ? t[2].dataType : 1, data: e.value }), i.push(...W(t[0].dims, r));
    let u = ["rank"], d = (c) => {
      let p = R("output", t[0].dataType, r.length), m = D("x", t[0].dataType, n.length), g = m.type.value, y = vb(p, n.length, e), b = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: e.pads.length }];
      return e.mode === 0 && b.push({ name: "constant_value", type: a ? g : "f32" }), `
    ...
    return { name: "Pad", shaderCache: { hint: `${e.mode}${a}`, inputDependencies: u }, getRunData: () => ({ outputs: [{ dims: r, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(k.size(r) / 64) }, programUniforms: i }), getShaderSource: d };
  }, xb = (t, e) => {
    if (t.length > 1) {
      ...
      let a = [];
      return i.forEach((u) => a.push(u)), { mode: e.mode, value: n, pads: a };
    } else return e;
  }, oc = (t, e) => {
    gb(t.inputs);
    let r = xb(t.inputs, e);
    t.compute($b(t.inputs, r), { inputs: [0] });
  };
});
var fn, ac, sc, uc, dc, Sb, Tb, lc, cc, pc, mc, fc, hc, gc, bc, yc, _c, wc, vc, $c = V(() => {
  "use strict";
  Le();
  ee();
  te();
  ...
  fn = (t) => {
    ...
    let i = Object.hasOwnProperty.call(e, "dilations"), a = e.kernelShape.slice(), u = e.strides.slice(), d = i ? e.dilations.slice() : [], c = e.pads.slice();
    Bt.adjustPoolAttributes(r, o, a, u, d, c);
    let p = Bt.computePoolOutputShape(r, o, u, d, a, c, e.autoPad, e.ceilMode), m = Object.assign({}, e);
    i ? Object.assign(m, { kernelShape: a, strides: u, pads: c, dilations: d, cacheKey: e.cacheKey }) : Object.assign(m, { kernelShape: a, strides: u, pads: c, cacheKey: e.cacheKey });
    let g = p.slice();
    return g.push(g.splice(1, 1)[0]), [m, n ? g : p];
  }, sc = (t, e) => {
    let r = e.format === "NHWC", n = k.size(t), o = k.size(e.kernelShape), i = [{ type: 12, data: n }, { type: 12, data: o }], a = [{ name: "outputSize", type: "u32" }, { name: "kernelSize", type: "u32" }];
    if (e.kernelShape.length <= 2) {
      ...
      if (e.kernelShape.length === 2) {
        ...
        g = !!(_ + S), i.push({ type: 12, data: y }, { type: 12, data: b }, { type: 12, data: _ }, { type: 12, data: S }), a.push({ name: "kh", type: "u32" }, { name: "sh", type: "u32" }, { name: "phStart", type: "u32" }, { name: "phEnd", type: "u32" });
      }
      return [i, a, true, m, g];
    } else {
      ...
      i.push({ type: 12, data: u }, { type: 12, data: e.pads }, { type: 12, data: e.strides }), a.push({ name: "kernelStrides", type: "u32", length: u.length }, { name: "pads", type: "u32", length: e.pads.length }, { name: "strides", type: "u32", length: e.strides.length });
      let d = e.pads.reduce((c, p) => c + p);
      return [i, a, !!d, false, false];
    }
  }, uc = (t, e, r, n, o, i, a, u, d, c, p, m) => {
    let g = o.format === "NHWC", y = e.type.value, b = R("output", e.type.tensor, n);
  ...
  }, dc = (t) => `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`, Sb = (t) => `${dc(t)};${t.countIncludePad}`, Tb = (t) => `${dc(t)};${t.storageOrder};${t.dilations}`, lc = (t) => ({ format: t.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][t.auto_pad], ceilMode: t.ceil_mode, kernelShape: t.kernel_shape, strides: t.strides, pads: t.pads }), cc = (t, e, r, n) => {
    let [o, i] = ac(e, n, r), a = D("x", e.dataType, e.dims.length), u = a.type.value, d = "value += x_val;", c = "";
    o.countIncludePad ? c += `value /= ${u}(uniforms.kernelSize);` : c += `value /= ${u}(i32(uniforms.kernelSize) - pad);`;
    let [p, m, g, y, b] = sc(i, o);
    p.push(...W(e.dims, i));
    let _ = ["rank"];
    return { name: t, shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(k.size(i) / 64) }, programUniforms: p }), getShaderSource: (S) => uc(S, a, e.dims.length, i.length, o, d, c, 0, m, g, y, b) };
  }, pc = (t) => {
    let e = t.count_include_pad !== 0, r = lc(t);
    if (r.ceilMode !== 0) throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding/divisor) is not yet implemented in the WebGPU AveragePool kernel");
    let n = { countIncludePad: e, ...r, cacheKey: "" };
    return { ...n, cacheKey: Sb(n) };
  }, mc = (t, e) => {
    fn(t.inputs), t.compute(cc("AveragePool", t.inputs[0], false, e));
  }, fc = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, hc = (t) => {
    let e = t.format;
    return { format: e, ...fc, cacheKey: e };
  }, gc = (t, e) => {
    fn(t.inputs), t.compute(cc("GlobalAveragePool", t.inputs[0], true, e));
  }, bc = (t, e, r, n) => {
    let [o, i] = ac(e, n, r), a = `
      value = max(x_val, value);
    `, u = "", d = D("x", e.dataType, e.dims.length), c = ["rank"], [p, m, g, y, b] = sc(i, o);
    return p.push(...W(e.dims, i)), { name: t, shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: c }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(k.size(i) / 64) }, programUniforms: p }), getShaderSource: (_) => uc(_, d, e.dims.length, i.length, o, a, u, e.dataType === 10 ? -65504 : -1e5, m, g, y, b) };
  }, yc = (t, e) => {
    fn(t.inputs), t.compute(bc("MaxPool", t.inputs[0], false, e));
  }, _c = (t) => {
    let e = t.storage_order, r = t.dilations, n = lc(t);
    if (e !== 0) throw new Error("column major storage order is not yet supported for MaxPool");
    if (n.ceilMode !== 0) throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel");
    let o = { storageOrder: e, dilations: r, ...n, cacheKey: "" };
    return { ...o, cacheKey: Tb(o) };
  }, wc = (t) => {
    let e = t.format;
    return { format: e, ...fc, cacheKey: e };
  }, vc = (t, e) => {
    fn(t.inputs), t.compute(bc("GlobalMaxPool", t.inputs[0], true, e));
  };
});
var Cb, Ab, xc, Sc, Tc = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Cb = (t, e) => {
    ...
    let r = k.normalizeAxis(e.axis, t[0].dims.length), n = t[0].dataType, o = n === 3, i = t[0].dims, a = t[1].dataType, u = k.size(i), d = n === 3 || n === 2, c = d ? [Math.ceil(k.size(t[0].dims) / 4)] : t[0].dims, p = t[1].dims, m = t.length > 2 ? t[2] : void 0, g = m ? d ? [Math.ceil(k.size(m.dims) / 4)] : m.dims : void 0, y = p.length === 0 || p.length === 1 && p[0] === 1, b = y === false && p.length === 1, _ = fe(u), S = y && (!d || _ === 4), x = S ? _ : 1, $ = S && !d ? _ : 1, T = D("input", d ? 12 : n, c.length, $), I = D("scale", a, p.length), A = m ? D("zero_point", d ? 12 : n, g.length) : void 0, E = R("output", a, i.length, x), O = [T, I];
    A && O.push(A);
    let w = [c, p];
    m && w.push(g);
    let U = [{ type: 12, data: u / x }, { type: 12, data: r }, { type: 12, data: e.blockSize }, ...W(...w, i)], N = (F) => {
    ...
    return { name: "DequantizeLinear", shaderCache: { hint: e.cacheKey, inputDependencies: A ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: N, getRunData: () => ({ outputs: [{ dims: i, dataType: a }], dispatchGroup: { x: Math.ceil(u / x / 64), y: 1, z: 1 }, programUniforms: U }) };
  }, xc = (t, e) => {
    Cb(t.inputs, e), t.compute(Ab(t.inputs, e));
  }, Sc = (t) => J({ axis: t.axis, blockSize: t.blockSize });
});
var Eb, kb, Ic, Cc = V(() => {
  "use strict";
  Le();
  ...
  Eb = (t, e, r) => {
    ...
    let o = Math.abs(Math.ceil((e - t) / r)), i = [o], a = o, u = [{ type: 12, data: a }, { type: n, data: t }, { type: n, data: r }, ...W(i)], d = (c) => {
...
var Pb, Db, Ac, Ec, kc = V(() => {
  ...
  Pb = (t, e, r, n) => {
    ...
    let r = t[0].dims, n = t[1].dims, o = r, i = 1, a = Math.ceil(k.sizeToDimension(n, n.length - 1) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = [{ type: 12, data: a }, { type: 12, data: u }, { type: 12, data: d }, ...W(t[1].dims, t[2].dims, o)], p = (m) => {
      let g = D("indices", t[1].dataType, t[1].dims.length), y = D("updates", t[2].dataType, t[2].dims.length, i), b = e.reduction !== "none" && e.reduction !== "" ? Ks("output", t[0].dataType, o.length) : R("output", t[0].dataType, o.length, i);
      return `
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    return { name: "ScatterND", shaderCache: { hint: `${e.cacheKey}_${e.reduction}`, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: o, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(a / 64) }, programUniforms: c }), getShaderSource: p };
  }, Ac = (t) => J({ reduction: t.reduction }), Ec = (t, e) => {
    t.compute(Db(t.inputs, e), { inputs: [t.inputs[1], t.inputs[2]], outputs: [] });
  };
});
var Ob, Bb, zb, Pc, Mb, Rb, Ub, Nb, Vb, Lb, Wb, Gb, Dc, Hb, Fb, qb, Kb, jb, Oc, Bc, zc = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Ob = (t, e) => {
    ...
    let [a, u, d] = r > 10 ? [1, 2, 3] : [-1, t.length > 1 ? 1 : -1, -1], c = t[0].dims.length;
    if (a > 0 && t.length > a && t[a].dims.length > 0) t[a].getFloat32Array().forEach((p) => i.push(p));
    ...
    if (u > 0 && t.length > u && t[u].dims.length === 1 && t[u].dims[0] > 0) {
      ...
      Ob(n, e), e.axes.length > 0 && Bb(n, e.axes, c).forEach((p, m) => n[m] = p);
    }
...
`, Mb = (t, e) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
  ...
  })() + "}", Rb = (t, e, r) => `fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {` + (() => {
    switch (t) {
    ...
    return e.length > 0 ? (e.forEach((i, a) => {
      n[i] = o[a], n[a + r] = o[e.length + a];
    }), n) : o;
  }, Nb = (t, e, r, n) => {
    let o = [];
    ...
    e.fill(1, 0, e.length);
    let o = t.slice();
    return r.axes.length > 0 ? (r.axes.forEach((i) => e[i] = n), r.axes.forEach((i) => o[i] = Math.round(t[i] * e[i]))) : (e.fill(n, 0, e.length), o.forEach((i, a) => o[a] = Math.round(i * e[a]))), o;
  }, Lb = (t, e, r, n, o) => `
...
` : "", Hb = (t, e, r, n, o) => {
    let [a, u, d, c] = r.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1], p = t.type.value;
    return `
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    let [a, u, d, c, p] = r.length === 3 ? [-1, 0, 1, 2, -1] : [0, 2, 3, 4, 1], m = t.type.value;
    return `
    ...
    let a = t.dims, u = Ub(i, e.axes, a.length), d = Nb(a, n, o, e.axes), c = n.slice();
    n.length === 0 && (c = a.map(($, T) => $ === 0 ? 1 : d[T] / $), e.keepAspectRatioPolicy !== "stretch" && (d = Vb(a, c, e)));
    let p = R("output", t.dataType, d.length), m = D("input", t.dataType, a.length), g = k.size(d), y = a.length === d.length && a.every(($, T) => $ === d[T]), b = e.coordinateTransformMode === "tf_crop_and_resize", _ = e.extrapolationValue, S = m.type.value, x = ($) => `
      ${y ? "" : `
      ...
      switch (e.mode) {
        ...
        case "linear":
          return `
              ...
              ${(() => {
            if (a.length === 2 || a.length === 4) return `${Hb(m, p, a, b, _)}`;
            if (a.length === 3 || a.length === 5) return `${qb(m, p, a, b, _)}`;
        ...
        case "cubic":
          return `
            ${(() => {
            if (a.length === 2 || a.length === 4) return `${Fb(m, p, a, d, c, u, e.cubicCoeffA, b, e.extrapolationValue, e.excludeOutside)}`;
...
`}
    ...
    zb(t.inputs, e, i, r, n, o), t.compute(Kb(t.inputs[0], e, i, r, n, o), { inputs: [0] });
  }, Bc = (t) => {
    let e = t.antialias, r = t.axes, n = t.coordinateTransformMode, o = t.cubicCoeffA, i = t.excludeOutside !== 0, a = t.extrapolationValue, u = t.keepAspectRatioPolicy, d = t.mode, c = t.nearestMode === "" ? "simple" : t.nearestMode;
    return J({ antialias: e, axes: r, coordinateTransformMode: n, cubicCoeffA: o, excludeOutside: i, extrapolationValue: a, keepAspectRatioPolicy: u, mode: d, nearestMode: c });
  };
});
var Zb, Qb, Mc, Rc = V(() => {
  "use strict";
  ...
  Zb = (t) => {
    ...
    let o = e.simplified, i = t[0].dims, a = k.size(i), u = i, d = a, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t.length > 3, g = t.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, S = 64, x = fe(c), $ = [{ type: 12, data: d }, { type: 12, data: x }, { type: 12, data: c }, { type: 1, data: e.epsilon }], T = (A) => {
      let E = [{ name: "output_size", type: "u32" }, { name: "components", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "epsilon", type: "f32" }], O = [D("x", t[0].dataType, t[0].dims, x), D("skip", t[1].dataType, t[1].dims, x), D("gamma", t[2].dataType, t[2].dims, x)];
      m && O.push(D("beta", t[3].dataType, t[3].dims, x)), g && O.push(D("bias", t[4].dataType, t[4].dims, x)), O.push(R("output", t[0].dataType, u, x)), y && O.push(R("mean_output", 1, p)), b && O.push(R("inv_std_output", 1, p)), _ && O.push(R("input_skip_bias_sum", t[0].dataType, u, x));
      let w = we(t[0].dataType), U = we(1, x);
      return `
    ...
    Zb(t.inputs);
    let n = [0];
    t.outputCount > 1 && n.push(-3), t.outputCount > 2 && n.push(-3), t.outputCount > 3 && n.push(3), t.compute(Qb(t.inputs, e, t.outputCount, false), { outputs: n });
  };
});
var Yb, hn, Xb, Uc, Jb, ey, Nc, Vc, Lc = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  Yb = (t, e) => {
    ...
    if (t.length > 1) {
      let r = hn(t, 1), n = hn(t, 2), o = hn(t, 3);
      return o.length === 0 && (o = [...Array(t[0].dims.length).keys()]), J({ starts: r, ends: n, axes: o });
    } else return e;
  }, Uc = (t, e, r, n, o) => {
    let i = t;
    return t < 0 && (i += r[n[e]]), o[e] < 0 ? Math.max(0, Math.min(i, r[n[e]] - 1)) : Math.max(0, Math.min(i, r[n[e]]));
  }, Jb = (t, e, r) => `fn calculateInputIndices(output_indices: ${e.type.indices}) -> ${t.type.indices} {
          var input_indices: ${t.type.indices};
          var carry = 0u;
    ...
    let r = t[0].dims, n = k.size(r), o = e.axes.length > 0 ? k.normalizeAxes(e.axes, r.length) : [...Array(r.length).keys()], i = hn(t, 4);
    i.forEach((x) => x !== 0 || (() => {
      throw new Error("step cannot be 0");
    })), i.length === 0 && (i = Array(o.length).fill(1));
    let a = e.starts.map((x, $) => Uc(x, $, r, o, i)), u = e.ends.map((x, $) => Uc(x, $, r, o, i));
    if (o.length !== a.length || o.length !== u.length) throw new Error("start, ends and axes should have the same number of elements");
    if (o.length !== r.length) for (let x = 0; x < r.length; ++x) o.includes(x) || (a.splice(x, 0, 0), u.splice(x, 0, r[x]), i.splice(x, 0, 1));
    let d = i.map((x) => Math.sign(x));
    i.forEach((x, $, T) => {
      if (x < 0) {
        let I = (u[$] - a[$]) / x, A = a[$], E = A + I * i[$];
        a[$] = E, u[$] = A, T[$] = -x;
      }
    });
    let c = r.slice(0);
    o.forEach((x, $) => {
      c[x] = Math.ceil((u[x] - a[x]) / i[x]);
    });
    let p = { dims: c, dataType: t[0].dataType }, m = R("output", t[0].dataType, c.length), g = D("input", t[0].dataType, t[0].dims.length), y = k.size(c), b = [{ name: "outputSize", type: "u32" }, { name: "starts", type: "u32", length: a.length }, { name: "signs", type: "i32", length: d.length }, { name: "steps", type: "u32", length: i.length }], _ = [{ type: 12, data: y }, { type: 12, data: a }, { type: 6, data: d }, { type: 12, data: i }, ...W(t[0].dims, c)], S = (x) => `
    ...
    Yb(t.inputs, e);
    let r = Xb(t.inputs, e);
    t.compute(ey(t.inputs, r), { inputs: [0] });
  }, Vc = (t) => {
    let e = t.starts, r = t.ends, n = t.axes;
    return J({ starts: e, ends: r, axes: n });
  };
});
var ty, ry, Wc, Gc, Hc = V(() => {
  "use strict";
  ee();
  te();
  Ce();
  ...
  ty = (t) => {
    ...
    let r = t.inputs[0], n = r.dims, o = k.size(n), i = n.length, a = k.normalizeAxis(e.axis, i), u = a < n.length - 1, d, c = [];
    u ? (c = Array.from({ length: i }, (O, w) => w), c[a] = i - 1, c[i - 1] = a, d = t.compute(Be(r, c), { inputs: [r], outputs: [-1] })[0]) : d = r;
    let p = d.dims, m = p[i - 1], g = o / m, y = fe(m), b = m / y, _ = 64;
    g === 1 && (_ = 256);
    let S = (O, w) => w === 4 ? `max(max(${O}.x, ${O}.y), max(${O}.z, ${O}.w))` : w === 2 ? `max(${O}.x, ${O}.y)` : w === 3 ? `max(max(${O}.x, ${O}.y), ${O}.z)` : O, x = D("x", d.dataType, d.dims, y), $ = R("result", d.dataType, d.dims, y), T = x.type.value, I = we(d.dataType) === "f32" ? `var threadMax = ${T}(-3.4028234663852886e+38f);` : `var threadMax = ${T}(-65504.0h);`, A = (O) => `
    ...
    u && t.compute(Be(E, c), { inputs: [E] });
  }, Wc = (t, e) => {
    ty(t.inputs), ry(t, e);
  }, Gc = (t) => J({ axis: t.axis });
});
var Fc, ny, oy, iy, qc, Kc = V(() => {
  "use strict";
  ee();
  te();
  oe();
  Fc = (t) => Array.from(t.getBigInt64Array(), Number), ny = (t) => {
    ...
    if (Fc(t[1]).length !== t[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
  }, oy = (t, e) => {
    let r = [];
    for (let n = 0; n < t.length; ++n) r.push(t[n] * e[n]);
    return r;
  }, iy = (t, e) => {
    let r = t[0].dims, n = e ?? Fc(t[1]), o = oy(r, n), i = k.size(o), a = t[0].dataType, u = D("input", a, r.length), d = R("output", a, o.length), c = (p) => `
    ...
    ny(t.inputs), t.compute(iy(t.inputs), { inputs: [0] });
  };
});
var ay, sy, jc, Zc = V(() => {
  "use strict";
  ...
  oe();
  ay = (t, e, r, n, o) => {
    let i = R("output_data", o, r.length, 4), a = D("a_data", e[1].dataType, e[1].dims.length, 4), u = D("b_data", e[2].dataType, e[2].dims.length, 4), d = D("c_data", e[0].dataType, e[0].dims.length, 4), c, p = (m, g, y) => `select(${g}, ${m}, ${y})`;
    ...
    let e = t[1].dims, r = t[2].dims, n = t[0].dims, o = t[1].dataType, i = !(k.areEqual(e, r) && k.areEqual(r, n)), a = e, u = k.size(e);
    if (i) {
    ...
    let d = Math.ceil(u / 4);
    return { name: "Where", shaderCache: { inputDependencies: ["rank", "rank", "rank"] }, getShaderSource: (c) => ay(c, t, a, i, o), getRunData: () => ({ outputs: [{ dims: a, dataType: o }], dispatchGroup: { x: Math.ceil(u / 64 / 4) }, programUniforms: [{ type: 12, data: d }, ...W(n, e, r, a)] }) };
  }, jc = (t) => {
    t.compute(sy(t.inputs));
  };
});
var Qc, Yc = V(() => {
  "use strict";
...
var gn, Xc = V(() => {
  ...
  gn = class {
    ...
    run(e, r, n, o, i) {
      ...
      let c = a.createBindGroup({ layout: e.computePipeline.getBindGroupLayout(0), entries: d, label: e.programInfo.name });
    ...
    build(e, r) {
      ...
      let a = js(r, this.backend.device.limits), u = e.getShaderSource(a), d = `${o.join(`
`)}
...
${u}`, c = n.createShaderModule({ code: d, label: e.name });
      ...
      return Re(e.name), { programInfo: e, computePipeline: p, uniformVariablesInfo: a.variablesInfo };
    }
...
var Jc = {};
Wt(Jc, { WebGpuBackend: () => Uo });
var uy, dy, Ro, Uo, ep = V(() => {
  "use strict";
  Le();
  ee();
  nt();
  ...
  uy = (t, e) => {
    ...
    let n = t.name;
    return t.shaderCache?.hint && (n += "[" + t.shaderCache.hint + "]"), n += ":" + r + `:${uy(e, t.shaderCache?.inputDependencies ?? new Array(e.length).fill("dims"))}`, n;
  }, Ro = class {
    constructor(e) {
    ...
    async initialize(e, r) {
      ...
      let a = r, u = r.info ?? (typeof a.requestAdapterInfo == "function" ? await a.requestAdapterInfo() : void 0);
      this.adapterInfo = new Ro(u), this.gpuDataManager = Fs(this), this.programManager = new gn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Gr(e.logLevel, !!e.debug), this.device.onuncapturederror = (d) => {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          let i = n[o], a = i.kernelId, u = this.kernels.get(a), d = u.kernelType, c = u.kernelName, p = i.programName, m = i.inputTensorViews, g = i.outputTensorViews, y = r[o * 2], b = r[o * 2 + 1];
          ...
          if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: a, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
          else {
            let x = "";
            m.forEach((T, I) => {
            ...
            }), console.log(`[profiling] kernel "${a}|${d}|${c}|${p}" ${x}${$}start time: ${_} ns, execution time: ${S - _} ns`);
          }
          Cr("GPU", `${p}::${y}::${b}`);
        }
    ...
    run(e, r, n, o, i, a) {
      ...
      for (let T = 0; T < d.length; ++T) {
        if (!Number.isInteger(m[T]) || m[T] < -3 || m[T] >= a) throw new Error(`Invalid output index: ${m[T]}`);
        if (m[T] === -3) continue;
        let I = m[T] === -1, A = m[T] === -2, E = I || A ? i(d[T].dataType, d[T].dims) : o(m[T], d[T].dataType, d[T].dims);
        if (g.push(E), E.data === 0) continue;
        let O = this.gpuDataManager.get(E.data);
        if (!O) throw new Error(`no GPU data for output: ${E.data}`);
        if (I && this.temporaryData.push(O), A) {
          let w = this.kernelPersistentData.get(this.currentKernelId);
          w || (w = [], this.kernelPersistentData.set(this.currentKernelId, w)), w.push(O);
        }
        y.push(O);
      }
      ...
      if (p) {
        let T = 0, I = [];
        p.forEach((w) => {
          let U = typeof w.data == "number" ? [w.data] : w.data;
          if (U.length === 0) return;
          let N = w.type === 10 ? 2 : 4, F, q;
          w.type === 10 ? (q = U.length > 4 ? 16 : U.length > 2 ? 8 : U.length * N, F = U.length > 4 ? 16 : N * U.length) : (q = U.length <= 2 ? U.length * N : 16, F = 16), T = Math.ceil(T / q) * q, I.push(T);
          let X = w.type === 10 ? 8 : 4;
          T += U.length > 4 ? Math.ceil(U.length / X) * F : U.length * N;
        });
        let A = 16;
        T = Math.ceil(T / A) * A;
        let E = new ArrayBuffer(T);
        p.forEach((w, U) => {
          let N = I[U], F = typeof w.data == "number" ? [w.data] : w.data;
          if (w.type === 6) new Int32Array(E, N, F.length).set(F);
          else if (w.type === 12) new Uint32Array(E, N, F.length).set(F);
          else if (w.type === 10) new Uint16Array(E, N, F.length).set(F);
          else if (w.type === 1) new Float32Array(E, N, F.length).set(F);
          else throw new Error(`Unsupported uniform type: ${rt(w.type)}`);
        });
        let O = this.gpuDataManager.create(T, GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM);
        this.device.queue.writeBuffer(O.buffer, 0, E, 0, T), this.gpuDataManager.release(O.id), b = { offset: 0, size: T, buffer: O.buffer };
      }
      let _ = this.programManager.normalizeDispatchGroupSize(c), S = _[1] === 1 && _[2] === 1, x = dy(e, r, S), $ = this.programManager.getArtifact(x);
      if ($ || ($ = this.programManager.build(e, _), this.programManager.setArtifact(x, $), se("info", () => `[artifact] key: ${x}, programName: ${e.name}`)), p && $.uniformVariablesInfo) {
        ...
        for (let T = 0; T < p.length; T++) {
          let I = p[T], A = I.type, E = typeof I.data == "number" ? 1 : I.data.length, [O, w] = $.uniformVariablesInfo[T];
          if (A !== O || E !== w) throw new Error(`Uniform variable ${T} mismatch: expect type ${O} with size ${w}, got type ${A} with size ${E} in program "${$.programInfo.name}".`);
        }
      }
      if (se("info", () => `[ProgramManager] run "${e.name}" (key=${x}) with ${_[0]}x${_[1]}x${_[2]}`), this.queryType !== "none" || this.sessionStatus === "capturing") {
    ...
    createKernel(e, r, n, o) {
      ...
      let a = { kernelType: e, kernelName: o, kernelEntry: i[0], attributes: [i[1], n] };
    ...
    computeKernel(e, r, n) {
      ...
      this.currentKernelId = e, d[0] && (d[1] = d[0](d[1]), d[0] = void 0), se("info", () => `[WebGPU] Start to run kernel "[${i}] ${a}"...`);
    ...
    createDownloader(e, r, n) {
      return async () => {
        let o = await mo(this, e, r);
        return Fr(o.buffer, n);
      };
    }
    writeTimestamp(e) {
    ...
    replay() {
      ...
      this.pendingKernels = [];
      for (let o = 0; o < n; o++) {
        let i = this.getComputePassEncoder(), a = e[o];
...
var lr, No, ly, rp = V(() => {
  ...
  lr = class t {
    ...
    constructor(e, r, n) {
      ...
      let o = e.PTR_SIZE, i = n / e.PTR_SIZE, a = o === 4 ? "i32" : "i64";
      this.opKernelContext = Number(e.getValue(o * i++, a));
      let u = Number(e.getValue(o * i++, a));
      this.outputCount = Number(e.getValue(o * i++, a)), this.customDataOffset = Number(e.getValue(o * i++, "*")), this.customDataSize = Number(e.getValue(o * i++, a));
      let d = [];
      for (let c = 0; c < u; c++) {
        let p = Number(e.getValue(o * i++, a)), m = Number(e.getValue(o * i++, "*")), g = Number(e.getValue(o * i++, a)), y = [];
        for (let b = 0; b < g; b++) y.push(Number(e.getValue(o * i++, a)));
        d.push(new lr(e, p, m, y));
      }
      this.inputs = d;
    }
    ...
    compute(e, r) {
      let n = r?.inputs?.map((u) => typeof u == "number" ? this.inputs[u] : u) ?? this.inputs, o = r?.outputs ?? [], i = (u, d, c) => new lr(this.module, d, this.output(u, c), c), a = (u, d) => {
        let c = xt(u, d);
        if (!c) throw new Error(`Unsupported data type: ${u}`);
        let p = c > 0 ? this.backend.gpuDataManager.create(c).id : 0;
        return new lr(this.module, u, p, d);
      };
      return this.backend.run(e, n, o, i, a, this.outputCount);
    }
    output(e, r) {
    ...
    if (t === "webgpu") {
      let i = (ep(), er(Jc)).WebGpuBackend, a = new i();
      await a.initialize(r, n), o("webgpu", [a, (u) => a.alloc(Number(u)), (u) => a.free(u), (u, d, c, p = false) => {
        ...
        se("verbose", () => `[WebGPU] jsepCopyGpuToCpu: gpuDataId=${u}, dataOffset=${d}, size=${c}`), await a.download(Number(u), () => e.HEAPU8.subarray(Number(d) >>> 0, Number(d + c) >>> 0));
      }, (u, d, c) => a.createKernel(u, Number(d), c, e.UTF8ToString(e._JsepGetNodeName(Number(d)))), (u) => a.releaseKernel(u), (u, d, c, p) => {
        se("verbose", () => `[WebGPU] jsepRun: sessionHandle=${c}, kernel=${u}, contextDataOffset=${d}`);
        let m = new No(e, a, Number(d));
      ...
      o("webnn", [i, () => i.reserveTensorId(), (a) => i.releaseTensorId(a), async (a, u, d, c, p) => i.ensureTensor(a, u, d, c, p), (a, u) => {
        i.uploadTensor(a, u);
      }, async (a, u) => i.downloadTensor(a, u), (a, u) => i.registerMLContext(a, u), !!r.trace]);
    }
  };
});
var cy, Dr, Or, Ut, py, np, rr, Br, zr, op, Mr, Rr, Ur, Jn = V(() => {
  "use strict";
  Le();
  As();
  ks();
  ...
  cy = (t, e) => {
    ...
    cy(t.wasm.numThreads, or(t.logLevel));
  }, Or = async (t, e) => {
    ye().asyncInit?.();
  ...
  }, Ut = /* @__PURE__ */ new Map(), py = (t) => {
    let e = ye(), r = e.stackSave();
    try {
      let n = e.PTR_SIZE, o = e.stackAlloc(2 * n);
      e._OrtGetInputOutputCount(t, o, o + n) !== 0 && me("Can't get session input/output count.");
      let a = n === 4 ? "i32" : "i64";
      return [Number(e.getValue(o, a)), Number(e.getValue(o + n, a))];
    } finally {
      e.stackRestore(r);
    }
  }, np = (t, e) => {
    ...
    try {
      ...
      r._OrtGetInputOutputMetadata(t, e, a, a + i) !== 0 && me("Can't get session input/output metadata.");
    ...
    let r, n, o = ye();
    Array.isArray(t) ? [r, n] = t : t.buffer === o.HEAPU8.buffer ? [r, n] = [t.byteOffset, t.byteLength] : [r, n] = rr(t);
    let i = 0, a = 0, u = 0, d = [], c = [], p = [];
    try {
      if ([a, d] = await Es(e), e?.externalData && o.mountExternalData) {
        let I = [];
        for (let A of e.externalData) {
          let E = typeof A == "string" ? A : A.path, O = typeof A == "string" ? A : A.data;
          I.push(ir(O).then((w) => {
            o.mountExternalData(E, w);
          }));
        }
        await Promise.all(I);
      }
      for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof I != "string") {
          let E = I, O = E?.context, w = E?.gpuDevice, U = E?.deviceType, N = E?.powerPreference;
          O ? o.currentContext = O : w ? o.currentContext = await o.webnnCreateMLContext(w) : o.currentContext = await o.webnnCreateMLContext({ deviceType: U, powerPreference: N });
        } else o.currentContext = await o.webnnCreateMLContext();
        break;
      }
      i = await o._OrtCreateSession(r, n, a), o.webgpuOnCreateSession?.(i), i === 0 && me("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [m, g] = py(i), y = !!e?.enableGraphCapture, b = [], _ = [], S = [], x = [], $ = [];
      for (let I = 0; I < m; I++) {
        let [A, E, O] = np(i, I);
        A === 0 && me("Can't get an input name."), c.push(A);
        let w = o.UTF8ToString(A);
        b.push(w), S.push(E === 0 ? { name: w, isTensor: false } : { name: w, isTensor: true, type: rt(E), shape: O });
      }
      for (let I = 0; I < g; I++) {
        let [A, E, O] = np(i, I + m);
        A === 0 && me("Can't get an output name."), p.push(A);
        let w = o.UTF8ToString(A);
        _.push(w), x.push(E === 0 ? { name: w, isTensor: false } : { name: w, isTensor: true, type: rt(E), shape: O });
        {
          if (y && e?.preferredOutputLocation === void 0) {
            $.push("gpu-buffer");
            continue;
          }
          let U = typeof e?.preferredOutputLocation == "string" ? e.preferredOutputLocation : e?.preferredOutputLocation?.[w] ?? "cpu", N = o.webnnIsGraphOutput;
          if (U === "cpu" && N && N(i, w)) {
            $.push("ml-tensor-cpu-output");
            continue;
          }
          if (U !== "cpu" && U !== "cpu-pinned" && U !== "gpu-buffer" && U !== "ml-tensor") throw new Error(`Not supported preferred output location: ${U}.`);
          if (y && U !== "gpu-buffer") throw new Error(`Not supported preferred output location: ${U}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);
          $.push(U);
        }
      }
      let T = null;
      return $.some((I) => I === "gpu-buffer" || I === "ml-tensor" || I === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && me("Can't create IO binding."), T = { handle: u, outputPreferredLocations: $, outputPreferredLocationsEncoded: $.map((I) => I === "ml-tensor-cpu-output" ? "ml-tensor" : I).map((I) => oo(I)) }), Ut.set(i, [i, c, p, T, y, false]), [i, b, _, S, x];
    } catch (m) {
      ...
      if (Array.isArray(x)) {
        ...
        if (c !== "string" && $ && T) {
          ...
          if ($(n, I) || T(n, I)) {
            ...
            let E = u.webnnCreateTemporaryTensor, O = u.webnnUploadTensor;
            if (!E || !O) throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
            let w = await E(n, A, p);
            O(w, new Uint8Array(x.buffer, x.byteOffset, x.byteLength)), y = w;
    ...
    try {
      ...
      let x = u._OrtCreateTensor($t(c), y, b, S, p.length, oo(g));
      x === 0 && me(`Can't create tensor for input/output. session=${n}, index=${i}.`), e.push(x);
    } finally {
      u.stackRestore(_);
    }
  }, Mr = async (t, e, r, n, o, i) => {
    let a = ye(), u = a.PTR_SIZE, d = Ut.get(t);
    if (!d) throw new Error(`cannot run inference. invalid session id: ${t}`);
    let c = d[0], p = d[1], m = d[2], g = d[3], y = d[4], b = d[5], _ = e.length, S = n.length, x = 0, $ = [], T = [], I = [], A = [], E = [], O = a.stackSave(), w = a.stackAlloc(_ * u), U = a.stackAlloc(_ * u), N = a.stackAlloc(S * u), F = a.stackAlloc(S * u);
    try {
      [x, $] = Cs(i), _t("wasm prepareInputOutputTensor");
      for (let L = 0; L < _; L++) await op(r[L], T, A, t, p[e[L]], e[L], y);
      for (let L = 0; L < S; L++) await op(o[L], I, A, t, m[n[L]], _ + n[L], y);
      wt("wasm prepareInputOutputTensor");
      for (let L = 0; L < _; L++) a.setValue(w + L * u, T[L], "*"), a.setValue(U + L * u, p[e[L]], "*");
      for (let L = 0; L < S; L++) a.setValue(N + L * u, I[L], "*"), a.setValue(F + L * u, m[n[L]], "*");
      if (g && !b) {
        ...
        for (let Z = 0; Z < _; Z++) {
          let ne = e[Z];
          await a._OrtBindInput(L, p[ne], T[Z]) !== 0 && me(`Can't bind input[${Z}] for session=${t}.`);
        }
        for (let Z = 0; Z < S; Z++) {
          let ne = n[Z];
          o[Z]?.[3] ? (E.push(I[Z]), a._OrtBindOutput(L, m[ne], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : a._OrtBindOutput(L, m[ne], 0, Y[ne]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
        }
        wt("wasm bindInputsOutputs"), Ut.set(t, [c, p, m, g, y, true]);
      }
      a.jsepOnRunStart?.(c), a.webnnOnRunStart?.(c);
      let q;
      g ? q = await a._OrtRunWithBinding(c, g.handle, S, N, x) : q = await a._OrtRun(c, U, w, _, F, S, N, x), q !== 0 && me("failed to call OrtRun().");
      let X = [], B = [];
      _t("wasm ProcessOutputTensor");
      for (let L = 0; L < S; L++) {
        let Q = Number(a.getValue(N + L * u, "*"));
        if (Q === I[L] || E.includes(I[L])) {
          X.push(o[L]), Q !== I[L] && a._OrtReleaseTensor(Q) !== 0 && me("Can't release tensor.");
          continue;
        }
        let Y = a.stackSave(), Z = a.stackAlloc(4 * u), ne = false, ie, ce = 0;
        try {
          a._OrtGetTensorData(Q, Z, Z + u, Z + 2 * u, Z + 3 * u) !== 0 && me(`Can't access output tensor data on index ${L}.`);
          let ve = u === 4 ? "i32" : "i64", M = Number(a.getValue(Z, ve));
          ce = a.getValue(Z + u, "*");
          let G = a.getValue(Z + u * 2, "*"), be = Number(a.getValue(Z + u * 3, ve)), ke = [];
          for (let ge = 0; ge < be; ge++) ke.push(Number(a.getValue(G + ge * u, ve)));
          a._OrtFree(G) !== 0 && me("Can't free memory for tensor dims.");
          let $e = ke.reduce((ge, Te) => ge * Te, 1);
          ie = rt(M);
          let De = g?.outputPreferredLocations[n[L]];
          if (ie === "string") {
            if (De === "gpu-buffer" || De === "ml-tensor") throw new Error("String tensor is not supported on GPU.");
            let ge = [];
            for (let Te = 0; Te < $e; Te++) {
              let qe = a.getValue(ce + Te * u, "*"), Ne = a.getValue(ce + (Te + 1) * u, "*"), xe = Te === $e - 1 ? void 0 : Ne - qe;
              ge.push(a.UTF8ToString(qe, xe));
            }
            X.push([ie, ke, ge, "cpu"]);
          } else if (De === "gpu-buffer" && $e > 0) {
            let ge = a.jsepGetBuffer;
            if (!ge) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
            let Te = ge(ce), qe = xt(M, $e);
            if (qe === void 0 || !Lr(ie)) throw new Error(`Unsupported data type: ${ie}`);
            ne = true, X.push([ie, ke, { gpuBuffer: Te, download: a.jsepCreateDownloader(Te, qe, ie), dispose: () => {
              a._OrtReleaseTensor(Q) !== 0 && me("Can't release tensor.");
            } }, "gpu-buffer"]);
          } else if (De === "ml-tensor" && $e > 0) {
            let ge = a.webnnEnsureTensor, Te = a.webnnIsGraphInputOutputTypeSupported;
            if (!ge || !Te) throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
            if (xt(M, $e) === void 0 || !Wr(ie)) throw new Error(`Unsupported data type: ${ie}`);
            if (!Te(t, ie, false)) throw new Error(`preferredLocation "ml-tensor" for ${ie} output is not supported by current WebNN Context.`);
            let Ne = await ge(t, ce, M, ke, false);
            ne = true, X.push([ie, ke, { mlTensor: Ne, download: a.webnnCreateMLTensorDownloader(ce, ie), dispose: () => {
              a.webnnReleaseTensorId(ce), a._OrtReleaseTensor(Q);
            } }, "ml-tensor"]);
          } else if (De === "ml-tensor-cpu-output" && $e > 0) {
            let ge = a.webnnCreateMLTensorDownloader(ce, ie)(), Te = X.length;
            ne = true, B.push((async () => {
              let qe = [Te, await ge];
              return a.webnnReleaseTensorId(ce), a._OrtReleaseTensor(Q), qe;
            })()), X.push([ie, ke, [], "cpu"]);
          } else {
            let ge = Ht(ie), Te = new ge($e);
            new Uint8Array(Te.buffer, Te.byteOffset, Te.byteLength).set(a.HEAPU8.subarray(ce, ce + Te.byteLength)), X.push([ie, ke, Te, "cpu"]);
          }
        } finally {
          a.stackRestore(Y), ie === "string" && ce && a._free(ce), ne || a._OrtReleaseTensor(Q);
        }
      }
      g && !y && (a._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Ut.set(t, [c, p, m, g, y, false]));
      for (let [L, Q] of await Promise.all(B)) X[L][2] = Q;
      return wt("wasm ProcessOutputTensor"), X;
    } finally {
      a.webnnOnRunEnd?.(c), a.stackRestore(O), T.forEach((q) => a._OrtReleaseTensor(q)), I.forEach((q) => a._OrtReleaseTensor(q)), A.forEach((q) => a._free(q)), x !== 0 && a._OrtReleaseRunOptions(x), $.forEach((q) => a._free(q));
    }
  }, Rr = (t) => {
    let e = ye(), r = Ut.get(t);
...
var Nt, Fe, cr, yn, _n, bn, Vo, Lo, jt, Zt, fy, ip, ap, sp, up, dp, lp, cp, Wo = V(() => {
  "use strict";
  Le();
  Jn();
  vt();
  kr();
  Nt = () => !!_e.wasm.proxy && typeof document < "u", cr = false, yn = false, _n = false, Lo = /* @__PURE__ */ new Map(), jt = (t, e) => {
    let r = Lo.get(t);
    r ? r.push(e) : Lo.set(t, [e]);
  }, Zt = () => {
    if (cr || !yn || _n || !Fe) throw new Error("worker not ready");
  }, fy = (t) => {
    switch (t.data.type) {
      case "init-wasm":
        cr = false, t.data.err ? (_n = true, Vo[1](t.data.err)) : (yn = true, Vo[0]()), bn && (URL.revokeObjectURL(bn), bn = void 0);
        break;
      case "init-ep":
      case "copy-from":
      case "create":
    ...
    if (!yn) {
      if (cr) throw new Error("multiple calls to 'initWasm()' detected.");
      if (_n) throw new Error("previous call to 'initWasm()' failed.");
      if (cr = true, Nt()) return new Promise((t, e) => {
        Fe?.terminate(), Ss().then(([r, n]) => {
          try {
            Fe = n, Fe.onerror = (i) => e(i), Fe.onmessage = fy, Vo = [t, e];
            let o = { type: "init-wasm", in: _e };
            !o.in.wasm.wasmPaths && (r || to) && (o.in.wasm.wasmPaths = { wasm: new URL("" + new URL("ort-wasm-simd-threaded.jsep-MDYUKy93.wasm", import.meta.url).href, import.meta.url).href }), Fe.postMessage(o), bn = r;
          } catch (o) {
            e(o);
          }
        }, e);
      ...
      try {
        await Pr(_e.wasm), await Dr(_e), yn = true;
      } catch (t) {
        throw _n = true, t;
      } finally {
        cr = false;
    ...
    if (Nt()) return Zt(), new Promise((e, r) => {
      jt("init-ep", [e, r]);
      let n = { type: "init-ep", in: { epName: t, env: _e } };
      Fe.postMessage(n);
    });
    await Or(_e, t);
  }, sp = async (t) => Nt() ? (Zt(), new Promise((e, r) => {
    jt("copy-from", [e, r]);
    ...
    if (Nt()) {
      ...
      return Zt(), new Promise((a, u) => {
        jt("run", [a, u]);
        let d = r, c = { type: "run", in: { sessionId: t, inputIndices: e, inputs: d, outputIndices: n, options: i } };
        Fe.postMessage(c, Ur(d));
      });
    } else return Mr(t, e, r, n, o, i);
  }, cp = async (t) => {
    if (Nt()) return Zt(), new Promise((e, r) => {
      jt("end-profiling", [e, r]);
...
var pp, hy, wn, mp = V(() => {
  ...
  pp = (t, e) => {
    ...
    switch (t[3]) {
      ...
      case "gpu-buffer": {
        let e = t[0];
        if (!Lr(e)) throw new Error(`not supported data type: ${e} for deserializing GPU tensor`);
        let { gpuBuffer: r, download: n, dispose: o } = t[2];
        return je.fromGpuBuffer(r, { dataType: e, dims: t[1], download: n, dispose: o });
      }
      case "ml-tensor": {
        let e = t[0];
        if (!Wr(e)) throw new Error(`not supported data type: ${e} for deserializing MLTensor tensor`);
    ...
    async fetchModelAndCopyToWasmMemory(e) {
      return sp(await ir(e));
    }
    async loadModel(e, r) {
      Ve();
      let n;
      typeof e == "string" ? n = await this.fetchModelAndCopyToWasmMemory(e) : n = e, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await up(n, r), Re();
    }
    async dispose() {
      return dp(this.sessionId);
    }
    async run(e, r, n) {
      Ve();
      let o = [], i = [];
      ...
      let d = o.map((g, y) => pp(g, () => `input "${this.inputNames[i[y]]}"`)), c = a.map((g, y) => g ? pp(g, () => `output "${this.outputNames[u[y]]}"`) : null), p = await lp(this.sessionId, i, d, u, c, n), m = {};
      for (let g = 0; g < p.length; g++) m[this.outputNames[u[g]]] = a[g] ?? hy(p[g]);
      return Re(), m;
    }
    startProfiling() {
    }
...
var hp = {};
Wt(hp, { OnnxruntimeWebAssemblyBackend: () => vn, initializeFlags: () => fp, wasmBackend: () => gy });
var fp, vn, gy, gp = V(() => {
  "use strict";
  Le();
  Wo();
  ...
  fp = () => {
    ...
    if (typeof t != "boolean" && t !== void 0 && t !== "fixed" && t !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${t}". Reset it to \`false\` and ignore SIMD feature checking.`), _e.wasm.simd = false), typeof _e.wasm.proxy != "boolean" && (_e.wasm.proxy = false), typeof _e.wasm.trace != "boolean" && (_e.wasm.trace = false), typeof _e.wasm.numThreads != "number" || !Number.isInteger(_e.wasm.numThreads) || _e.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) _e.wasm.numThreads = 1;
      ...
      let e = typeof navigator > "u" ? qn("node:os").cpus().length : navigator.hardwareConcurrency;
      _e.wasm.numThreads = Math.min(4, Math.ceil((e || 1) / 2));
    }
  }, vn = class {
    async init(e) {
      fp(), await ip(), await ap(e);
    }
...
var BT = Xn;
{
  let t = (gp(), er(hp)).wasmBackend;
  Pt("webgpu", t, 5), Pt("webnn", t, 5), Pt("cpu", t, 10), Pt("wasm", t, 10);
}
Object.defineProperty(_e.versions, "web", { value: cs, enumerable: true });
export {
  Bf as InferenceSession,
  Cr as TRACE,
