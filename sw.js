...
const CACHE_NAME = 'cardkeeper-shell-v5.1.6';
const SHELL_FILES = [
  './','./index.html','./css/style.css','./js/db.js','./js/parse.js?v=516',
  './js/vision.js','./js/ocr.js?v=516','./js/vcard.js','./js/camera.js','./js/app.js',
